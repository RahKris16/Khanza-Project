 ...
 * @author Kode
 */
public class DlgCekSKDPKontrolRehab extends javax.swing.JDialog {
     ...
     * @param id
     */
    public DlgCekSKDPKontrolRehab(java.awt.Frame parent, boolean id) {
        super(parent, id);
        initComponents();
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(btnAngka4, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnAngka3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
                    .addComponent(btnAngka2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
                    .addComponent(btnTemplate, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
        ...
        jLabel30.setText("No Surat Kontrol :");
        jLabel30.setFont(new java.awt.Font("Poppins", 0, 32)); // NOI18N
        jLabel30.setPreferredSize(new java.awt.Dimension(300, 75));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel31.setText("Silahkan Input No Surat Kontrol / Scan Surat Kontrol");
        jLabel31.setFont(new java.awt.Font("Poppins", 0, 32)); // NOI18N
        jLabel31.setPreferredSize(new java.awt.Dimension(600, 50));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
...
//                Notifications.getInstance().show(Notifications.Type.WARNING, Notifications.Location.TOP_CENTER, "Data surat kontrol tidak ditemukan!");
    ...
    private void BtnClose2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnClose2ActionPerformed
        if (Sequel.cariInteger("select count(nomorreferensi) from referensi_mobilejkn_bpjs where nomorreferensi='" + NoRMPasien.getText() + "' and tanggalperiksa=current_date") > 0) {
                JOptionPane.showMessageDialog(rootPane, "Pasien telah menggunakan Mobile JKN. Silahkan cek-in menggunakan menu Mobile JKN");
        }else{ 
            if (Sequel.cariInteger("select count(bridging_surat_kontrol_bpjs.no_surat) from bridging_surat_kontrol_bpjs where bridging_surat_kontrol_bpjs.no_surat='" + NoRMPasien.getText() + "'") > 0) {
                String tanggalkontrol = Sequel.cariIsi("select bridging_surat_kontrol_bpjs.tgl_rencana from bridging_surat_kontrol_bpjs where bridging_surat_kontrol_bpjs.no_surat='" + NoRMPasien.getText() + "'");
                String norkmmedis = Sequel.cariIsi("select rp.no_rkm_medis from reg_periksa rp "
                        ...
                        + "where bskb.no_surat='" + NoRMPasien.getText() + "'");
                if (Sequel.cariInteger("select DATEDIFF('" + tanggalkontrol + "',CURRENT_DATE)") > 0) {
                    JOptionPane.showMessageDialog(rootPane, "Jadwal kontrol tidak boleh dimajukan");
                    NoRMPasien.setText("");
//                } else if (Sequel.cariInteger("select count(nomorreferensi) from referensi_mobilejkn_bpjs where nomorreferensi='" + NoRMPasien.getText() + "' and tanggalperiksa=current_date") > 0) {
//                    JOptionPane.showMessageDialog(rootPane, "Pasien telah menggunakan Mobile JKN. Silahkan cek-in menggunakan menu MobileJKN");
                } else if(Sequel.cariInteger("select count(no_rkm_medis) from reg_periksa "
                        + "where tgl_registrasi between CURDATE() and CURDATE() and kd_poli='IGD' and kd_pj='BPJ' and no_rkm_medis='" + norkmmedis + "'")>0){
    ...
    private void btnTemplateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTemplateActionPerformed
        NoRMPasien.setText(NoRMPasien.getText() + "0227R017");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCekSKDPKontrolRehab dialog = new DlgCekSKDPKontrolRehab(new javax.swing.JFrame(), true);
