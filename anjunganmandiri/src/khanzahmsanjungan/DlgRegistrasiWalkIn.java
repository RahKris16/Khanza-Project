...
public class DlgRegistrasiWalkIn extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblNamaPasien.setBounds(420, 50, 460, 40);
        ...
        jLabel30.setBounds(270, 145, 20, 23);
        ...
        jLabel31.setBounds(20, 135, 250, 40);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-01-2026" }));
        ...
        TanggalPeriksa.setBounds(290, 90, 120, 40);
        ...
        jPanel2.add(lblNoRM);
        lblNoRM.setBounds(290, 50, 120, 40);
        ...
        jLabel35.setBounds(270, 235, 20, 23);
        ...
        cmbCaraBayar.setBounds(290, 225, 520, 40);
        ...
        btnSimpan1.setBounds(815, 135, 70, 40);
        ...
        NamaPoli.setBounds(290, 135, 520, 40);
        ...
        jLabel36.setBounds(20, 225, 250, 40);
        ...
        jPanel2.add(TNoRw);
        TNoRw.setBounds(290, 270, 520, 40);
        ...
        btnSimpan2.setBounds(815, 180, 70, 40);
...
//            }
            ...
            if (Sequel.menyimpantf2("reg_periksa", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 21,
                    new String[]{NoReg.getText(), NoRawat.getText(), Valid.SetTgl(TanggalPeriksa.getSelectedItem() + ""), Sequel.cariIsi("select current_time()"),
                        kode_dokter, lblNoRM.getText(), kode_poli, TPngJwb.getText(), TAlmt.getText(), THbngn.getText(), biayareg, "Belum",
                        "Lama", "Ralan", "A09", umur, sttsumur, "Belum Bayar", status,"",""}) == true) {
                Sequel.menyimpan("catatan_pasien","'"+NoRawat.getText()+"','Anjungan Mandiri'");
                MnCetakRegisterActionPerformed(NoRawat.getText());
...
//        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_rawat,6),signed)),0) from reg_periksa where tgl_registrasi='" + Valid.SetTgl(TanggalPeriksa.getSelectedItem().toString()) + "' ",dateformat.format(TanggalPeriksa.getDate())+ "/", 6, NoRawat);
    ...
    private void tampilPenjab() {
        try {
            ...
            iyem = "";
            ps = koneksi.prepareStatement("select * from penjab where status='1' and kd_pj='A09' order by png_jawab ");
...
//                + "and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.no_rawat='" + norawat + "' ", param);
    ...
    private void MnCetakBarcodeRawatJalan(String norawat) {
        ...
        param.put("logo", Sequel.cariGambar("select logo from setting"));
        Valid.MyReportSilentPrint("rptBarcodeRM.jasper", param, "::[ Barcode RM ]::");
        this.setCursor(Cursor.getDefaultCursor());
