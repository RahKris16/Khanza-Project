...
public final class DlgCariPoli extends javax.swing.JDialog {
    ...
    public void tampil(String harikerja) {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT kd_poli,nm_poli FROM poliklinik where "
                    + "kd_poli not in ('IGD','-','U0024','U0025','U0027','U0028','U0029','U0031','U0032',"
                    + "'U0033','U0034','U0037','U0038','U0006') and status='1' order by kd_poli");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
