...
public final class DlgCariDokter2 extends javax.swing.JDialog {
    ...
    public void tampil(String harikerja, String kodepoli) {
        ...
        try {
            if("U0026".equals(kodepoli)){
                ps = koneksi.prepareStatement("SELECT nm_dokter,kd_dokter FROM dokter where kd_sps='S0001' and status='1'");
            }else{
                ps = koneksi.prepareStatement("SELECT dokter.nm_dokter,jadwal.kd_dokter, concat(jadwal.jam_mulai,' - ',jadwal.jam_selesai)\n"
                        + "FROM dokter\n"
            ...
            try {
                ...
                while (rs.next()) {
                    if("U0026".equals(kodepoli)){
                        ...
                        tabMode.addRow(new Object[]{rs.getString(2),rs.getString(1),rs.getString(3)});
                    }
                }
            } catch (Exception e) {
