...
//        initComponents2();
    ...
    private void initComponents() {
        ...
        btnAdmin2.setText("Pendaftaran Pasien Umum (Belum Reservasi)");
        ...
        btnAdmin8.setText("Check-in (Reservasi Melalui Mobile JKN)");
        ...
        btnAdmin7.setText("Check-in Pasien Umum (Sudah Reservasi)");
        ...
        btnAdmin5.setText("Pendaftaran Pasien JKN (Rujukan Baru)");
        ...
        btnAdmin6.setText("Pendaftaran Pasien JKN (Pasien Kontrol)");
        ...
        btnAdmin9.setText("Pendaftaran Pasien JKN (Rehab Medis)");
...
//        JOptionPane.showMessageDialog(rootPane, "Mohon maaf, fitur masih dalam tahap pengembangan");
    ...
    private void btnAdmin9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdmin9ActionPerformed
        DlgCekKunjunganRehab pilih = new DlgCekKunjunganRehab(null, true);
        pilih.setSize(this.getWidth(), this.getHeight());
        pilih.setLocationRelativeTo(this);
        pilih.setVisible(true);
