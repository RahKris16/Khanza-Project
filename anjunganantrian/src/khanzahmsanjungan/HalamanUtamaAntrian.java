...
public class HalamanUtamaAntrian extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel39.setText("LOKET ANTRIAN");
        ...
        btnAdmin2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/offlineadmisi.png"))); // NOI18N
        btnAdmin2.setText("<html><center>ANTRIAN<br>BELUM RESERVASI</center></html>");
        btnAdmin2.setToolTipText("");
        btnAdmin2.setFont(new java.awt.Font("Poppins", 1, 30)); // NOI18N
        btnAdmin2.setIconTextGap(0);
        btnAdmin2.setPreferredSize(new java.awt.Dimension(200, 120));
        ...
        btnAdmin3.setText("<html><center>ANTRIAN<br>LAB / RADIOLOGI</center></html>");
        btnAdmin3.setFont(new java.awt.Font("Poppins", 1, 30)); // NOI18N
        btnAdmin3.setIconTextGap(0);
        btnAdmin3.setPreferredSize(new java.awt.Dimension(200, 120));
        ...
        btnAdmin4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/onlineadmisi.png"))); // NOI18N
        btnAdmin4.setText("<html><center>ANTRIAN<br>SUDAH RESERVASI</center></html>");
        btnAdmin4.setFont(new java.awt.Font("Poppins", 1, 30)); // NOI18N
        ...
        btnAdmin10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/bedpasien.png"))); // NOI18N
        btnAdmin10.setText("ANTRIAN IGD");
        btnAdmin10.setFont(new java.awt.Font("Poppins", 1, 30)); // NOI18N
        ...
        btnAdmin11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/bedpasien.png"))); // NOI18N
        btnAdmin11.setText("<html><center>ANTRIAN<br>RAWAT INAP</center></html>");
    ...
    private void btnAdmin2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdmin2ActionPerformed
        ...
        pilih.setNoAntrian("LOKET", "A", "Loket");
    ...
    private void btnAdmin3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdmin3ActionPerformed
        DlgAmbilAntrean pilih = new DlgAmbilAntrean(null, true);
        pilih.setNoAntrian("PENUNJANG", "B", "Penunjang");
        pilih.setSize(this.getWidth(), this.getHeight());
        pilih.setLocationRelativeTo(this);
        pilih.setVisible(true);
    ...
    private void btnAdmin4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdmin4ActionPerformed
        DlgAmbilAntrean pilih = new DlgAmbilAntrean(null, true);
        pilih.setNoAntrian("RESERVASI", "C", "Reservasi");
        pilih.setSize(this.getWidth(), this.getHeight());
        pilih.setLocationRelativeTo(this);
        pilih.setVisible(true);
    ...
    private void btnAdmin11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdmin11ActionPerformed
        DlgAmbilAntrean pilih = new DlgAmbilAntrean(null, true);
        pilih.setNoAntrian("ADMISSION", "E", "Admission");
        pilih.setSize(this.getWidth(), this.getHeight());
        pilih.setLocationRelativeTo(this);
        pilih.setVisible(true);
