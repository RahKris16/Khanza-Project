...
public class DlgAmbilAntrean extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblNamaAntrian.setFont(new java.awt.Font("Poppins", 1, 40)); // NOI18N
        lblNamaAntrian.setPreferredSize(new java.awt.Dimension(1000, 150));
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(560, 210));
        ...
        lblNoAntrian.setFont(new java.awt.Font("Poppins", 1, 200)); // NOI18N
        lblNoAntrian.setIconTextGap(0);
        lblNoAntrian.setPreferredSize(new java.awt.Dimension(550, 200));
        ...
        BtnClose2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/approvalfp.png"))); // NOI18N
        BtnClose2.setMnemonic('U');
        BtnClose2.setText("Cetak Antrian");
        BtnClose2.setToolTipText("Alt+U");
        BtnClose2.setFont(new java.awt.Font("Poppins", 1, 24)); // NOI18N
        ...
        BtnClose3.setFont(new java.awt.Font("Poppins", 1, 24)); // NOI18N
...
//        String sqlQuery = "type, noantrian, postdate, start_time, end_time, status";
//        String[] values = new String[]{jnsloket, String.valueOf(antriansekarang), Sequel.cariIsi("select current_date()"), Sequel.cariIsi("select current_time()"), "00:00:00","Belum"};
//
...
//        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void autoCetakAntrian() {
//        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
//        String sqlQuery = "type, noantrian, postdate, start_time, end_time, status";
//        String[] values = new String[]{
//            jnsloket,
//            String.valueOf(antriansekarang),
...
//        this.setCursor(Cursor.getDefaultCursor());
        ...
        if (Sequel.menyimpantfautoincrement("antrian_loket", sqlQuery, values.length, values)) {

            // Simpan nilai dulu sebelum dikosongkan
            final String namaLabel = lblNamaAntrian.getText();
            final int noAntrian = antriansekarang;
            final String tgl = Sequel.cariIsi("select current_date()");
            final String jam = Sequel.cariIsi("select current_time()");
            ...
            // Cetak di background thread agar tidak blocking UI
            new Thread(() -> {
                CetakAntrian(namaLabel, noAntrian, tgl, jam);
            }).start();
        }
        this.setCursor(Cursor.getDefaultCursor());
    }
    ...
    private void CetakAntrian(String label, Integer noantrian, String tgl, String jam) {
        ...
        Valid.MyReportqryabdulAntrian("rptAntrianLoket.jasper","report", param);
//        Valid.MyReportqryabdul("rptAntrianLoket.jasper","report","::[ No Antrian Loket ]::", param);
