...
public class koneksiDB {
    ...
    public static String URLBADUNGSEHAT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLBADUNGSEHAT");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String USERBADUNGSEHAT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("USERBADUNGSEHAT");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String PASSBADUNGSEHAT(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("PASSBADUNGSEHAT");
        }catch(Exception e){
            var=""; 
        }
        return var;
