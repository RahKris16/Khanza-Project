...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            grafik_tahunan_hemodialisa=false,penilaian_medis_hemodialisa=false,catatan_observasi_hemodialisa=false,catatan_cairan_hemodialisa=false,
            grafik_bulanan_meninggal=false,laporan_tahunan_irj=false,perbaikan_inventaris=false,surat_cuti_hamil=false,
    ...
    public static void setperiksaradiologifalse(){akses.periksa_radiologi=false;akses.kode="";} 
