...
public final class SatuSehatKirimEncounter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKirim1 = new widget.Button();
        BtnKirim2 = new widget.Button();
        ...
        BtnKirim1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/34.png"))); // NOI18N
        BtnKirim1.setMnemonic('K');
        BtnKirim1.setText("Quest");
        BtnKirim1.setToolTipText("Alt+K");
        BtnKirim1.setName("BtnKirim1"); // NOI18N
        BtnKirim1.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnKirim1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirim1ActionPerformed(evt);
            }
        });
        panelGlass8.add(BtnKirim1);

        BtnKirim2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/34.png"))); // NOI18N
        BtnKirim2.setMnemonic('K');
        BtnKirim2.setText("CarePlan");
        BtnKirim2.setToolTipText("Alt+K");
        BtnKirim2.setName("BtnKirim2"); // NOI18N
        BtnKirim2.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnKirim2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirim2ActionPerformed(evt);
            }
        });
        panelGlass8.add(BtnKirim2);
    ...
    private void BtnKirim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirim1ActionPerformed
       for(i=0;i<tbObat.getRowCount();i++){
            if(tbObat.getValueAt(i,0).toString().equals("true")&&(!tbObat.getValueAt(i,5).toString().equals(""))&&(!tbObat.getValueAt(i,8).toString().equals(""))){
                try {
                    iddokter=cekViaSatuSehat.tampilIDParktisi(tbObat.getValueAt(i,8).toString());
                    idpasien=cekViaSatuSehat.tampilIDPasien(tbObat.getValueAt(i,5).toString());
                    try{
            ...
            "    },\n" +
            "    \"encounter\": {\n" +
            "        \"reference\": \"Encounter/" + tbObat.getValueAt(i, 15).toString() + "\"\n" +
            "    },\n" +
            "    \"authored\": \"2024-10-29T07:40:00+00:00\",\n" +
            "    \"author\": {\n" +
            "        \"reference\": \"Practitioner/" + iddokter + "\"\n" +
            "    },\n" +
            "    \"source\": {\n" +
            ...
            "}";
                        ...
                        response = root.path("id");
                        if(!response.asText().equals("")){
                            Sequel.menyimpan("satu_sehat_quest","?,?","No.Rawat",2,new String[]{
                                tbObat.getValueAt(i,2).toString(),response.asText()
                            });
                        }
                    }catch(Exception e){
        ...
        tampil();
    }//GEN-LAST:event_BtnKirim1ActionPerformed
                ...
                try {
                    ...
                    try{
                        ...
                        json ="{\n" +
                            ...
                            "    \"status\": \"active\",\n" +
                            "    \"intent\": \"plan\",\n" +
                            "    \"description\": \"Rujuk ke RS Mitra Delima\",\n" +
                            "    \"subject\": {\n" +
                            "        \"reference\": \"Patient/" + idpasien + "\",\n" +
                            "        \"display\": \"" + tbObat.getValueAt(i, 4).toString() + "\"\n" +
                            "    },\n" +
    ...
    */
    ...
    private widget.Button BtnKirim1;
    private widget.Button BtnKirim2;
