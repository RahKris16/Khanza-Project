...
public final class AplicareKetersediaanKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Kelas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kelas 1", "Kelas 2", "Kelas 3", "Kelas VIP", "Kelas VVIP", "Kelas NICU", "Kelas PICU", "Kelas ICU", "Kelas HCU", "Kelas Isolasi" }));
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   "select aplicare_ketersediaan_kamar.kode_kelas_aplicare,aplicare_ketersediaan_kamar.kd_bangsal,"+
                   "bangsal.nm_bangsal,aplicare_ketersediaan_kamar.kelas,aplicare_ketersediaan_kamar.kapasitas,"+
                   "if(kamar.status='ISI','0','1') as tersedia,aplicare_ketersediaan_kamar.tersediapria,"+
                   "aplicare_ketersediaan_kamar.tersediawanita,if(kamar.status='ISI','0','1') as tersediapriawanita "+
                   "from aplicare_ketersediaan_kamar inner join bangsal on aplicare_ketersediaan_kamar.kd_bangsal=bangsal.kd_bangsal "+
                   "left join kamar on kamar.kd_bangsal=bangsal.kd_bangsal where "+
