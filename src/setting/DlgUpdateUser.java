...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    private boolean penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,tindakan_ralan=false,kamar_inap=false,
            ...
            grafik_harian_hemodialisa=false,grafik_bulanan_hemodialisa=false,grafik_tahunan_hemodialisa=false,penilaian_medis_hemodialisa=false,catatan_observasi_hemodialisa=false,catatan_cairan_hemodialisa=false,
            grafik_bulanan_meninggal=false,perbaikan_inventaris=false,surat_cuti_hamil=false,
    ...
    private void tampil(String user) {  
        ...
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.grafik_harian_hemodialisa,user.grafik_bulanan_hemodialisa,user.grafik_tahunan_hemodialisa,user.penilaian_medis_hemodialisa,user.catatan_observasi_hemodialisa,user.catatan_cairan_hemodialisa,"+
                "user.grafik_bulanan_meninggal,user.perbaikan_inventaris,"+
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    grafik_tahunan_hemodialisa=rs.getBoolean("grafik_tahunan_hemodialisa");penilaian_medis_hemodialisa=rs.getBoolean("penilaian_medis_hemodialisa");catatan_observasi_hemodialisa=rs.getBoolean("catatan_observasi_hemodialisa");catatan_cairan_hemodialisa=rs.getBoolean("catatan_cairan_hemodialisa");grafik_bulanan_meninggal=rs.getBoolean("grafik_bulanan_meninggal");perbaikan_inventaris=rs.getBoolean("perbaikan_inventaris");surat_cuti_hamil=rs.getBoolean("surat_cuti_hamil");permintaan_stok_obat_pasien=rs.getBoolean("permintaan_stok_obat_pasien");pemeliharaan_inventaris=rs.getBoolean("pemeliharaan_inventaris");klasifikasi_pasien_ranap=rs.getBoolean("klasifikasi_pasien_ranap");bulanan_klasifikasi_pasien_ranap=rs.getBoolean("bulanan_klasifikasi_pasien_ranap");
