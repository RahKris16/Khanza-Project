...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[J]ICD 10","[J]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[M]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                ...
                "[M]Check List Kriteria Masuk HCU","[M]Check List Kriteria Keluar HCU","[M]Penilaian Risiko Dekubitus","[M]Catatan Observasi Hemodialisa","[M]Catatan Cairan Hemodialisa",
        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "catatan_observasi_hemodialisa='"+tbUser.getValueAt(i,954).toString()+"',"+
                    "catatan_cairan_hemodialisa='"+tbUser.getValueAt(i,955).toString()+"',"+
                    "penilaian_medis_hemodialisa='"+tbUser.getValueAt(i,956).toString()+"'")==true){
                    emptTeks();
                }
            }         
        }
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "catatan_observasi_hemodialisa='"+tbUser.getValueAt(barisdicopy,954).toString()+"',"+
                                        "catatan_cairan_hemodialisa='"+tbUser.getValueAt(barisdicopy,955).toString()+"',"+
                                        "penilaian_medis_hemodialisa='"+tbUser.getValueAt(barisdicopy,956).toString()+"'");
                                }
                                userdicopy="";
                                copyhakakses="";
                                barisdicopy=-1;
    ...
    private void tampil() {        
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.penilaian_medis_hemodialisa,user.catatan_observasi_hemodialisa,user.catatan_cairan_hemodialisa,"+
