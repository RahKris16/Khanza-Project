...
public final class RMDataCatatanObservasiIGD extends javax.swing.JDialog {
    ...
    public RMDataCatatanObservasiIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "TD(mmHg)","HR(x/menit)","RR(x/menit)","Suhu(°C)","SpO2(%)","NIP","Nama Petugas","Intake","Ouput","Implementasi","Evaluasi"
        }){
        ...
        intake.setDocument(new batasInput((int)500).getKata(intake));
        output.setDocument(new batasInput((int)500).getKata(output));
        implementasi.setDocument(new batasInput((int)500).getKata(implementasi));
    ...
    private void initComponents() {
        ...
        intake = new widget.TextArea();
        jLabel9 = new widget.Label();
        jLabel10 = new widget.Label();
        scrollPane2 = new widget.ScrollPane();
        output = new widget.TextArea();
        ...
        intake.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        intake.setColumns(20);
        intake.setRows(5);
        ...
        scrollPane1.setViewportView(intake);

        FormInput.add(scrollPane1);
        scrollPane1.setBounds(85, 100, 220, 50);

        jLabel9.setText("Intake :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(20, 100, 60, 23);

        jLabel10.setText("Output :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(20, 160, 60, 23);
        ...
        scrollPane2.setBounds(85, 160, 220, 50);

        jLabel11.setText("Implementasi :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(465, 100, 90, 23);
        ...
        scrollPane3.setViewportView(implementasi);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(560, 100, 220, 50);
        ...
        scrollPane4.setBounds(560, 160, 220, 50);

        jLabel13.setText("Evaluasi :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(465, 160, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("catatan_observasi_igd","?,?,?,?,?,?,?,?,?,?","Data",10,new String[]{
                ...
                Sequel.menyimpantf("catatan_observasi_igd_tambahan","?,?,?,?,?,?,?","Data",7,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                intake.getText(),output.getText(),implementasi.getText(),evaluasi.getText()
                });
                tampil();
                emptTeks();
            }   
    ...
    */
    ...
    private widget.TextArea intake;
    ...
    private widget.TextArea output;
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_igd.tgl_perawatan,catatan_observasi_igd.jam_rawat,catatan_observasi_igd.gcs,"+
                    "catatan_observasi_igd.td,catatan_observasi_igd.hr,catatan_observasi_igd.rr,catatan_observasi_igd.suhu,catatan_observasi_igd.spo2,"+
                    "catatan_observasi_igd_tambahan.intake,catatan_observasi_igd_tambahan.output,catatan_observasi_igd_tambahan.implementasi,catatan_observasi_igd_tambahan.evaluasi,"+
                    "catatan_observasi_igd.nip,petugas.nama from catatan_observasi_igd inner join reg_periksa on catatan_observasi_igd.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_observasi_igd.nip=petugas.nip "+
                    "inner join catatan_observasi_igd_tambahan on catatan_observasi_igd.no_rawat=catatan_observasi_igd_tambahan.no_rawat and catatan_observasi_igd.tgl_perawatan=catatan_observasi_igd_tambahan.tgl_perawatan and catatan_observasi_igd.jam_rawat=catatan_observasi_igd_tambahan.jam_rawat "+
                    "group by catatan_observasi_igd.no_rawat, catatan_observasi_igd.tgl_perawatan, catatan_observasi_igd.jam_rawat "+
                    "where catatan_observasi_igd.tgl_perawatan between ? and ? order by catatan_observasi_igd.tgl_perawatan, catatan_observasi_igd.jam_rawat");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_igd.tgl_perawatan,catatan_observasi_igd.jam_rawat,catatan_observasi_igd.gcs,"+
                    ...
                    "inner join petugas on catatan_observasi_igd.nip=petugas.nip "+
                    "inner join catatan_observasi_igd_tambahan on catatan_observasi_igd.no_rawat=catatan_observasi_igd_tambahan.no_rawat and catatan_observasi_igd.tgl_perawatan=catatan_observasi_igd_tambahan.tgl_perawatan and catatan_observasi_igd.jam_rawat=catatan_observasi_igd_tambahan.jam_rawat "+
                    "where catatan_observasi_igd.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or catatan_observasi_igd.nip like ? or petugas.nama like ?) "+
                    "group by catatan_observasi_igd.no_rawat, catatan_observasi_igd.tgl_perawatan, catatan_observasi_igd.jam_rawat "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nama"),rs.getString("intake"),rs.getString("output"),rs.getString("implementasi"),rs.getString("evaluasi")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            intake.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());            
            output.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());            
            implementasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());            
    ...
    private void ganti() {
        ...
        Sequel.mengedit("catatan_observasi_igd_tambahan","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,intake=?,output=?,implementasi=?,evaluasi=?",10,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            intake.getText(),output.getText(),implementasi.getText(),evaluasi.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),
            tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        });
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from catatan_observasi_igd where tgl_perawatan=? and jam_rawat=? and no_rawat=?",3,new String[]{
            ...
            Sequel.queryu2tf("delete from catatan_observasi_igd_tambahan where tgl_perawatan=? and jam_rawat=? and no_rawat=?",3,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            });
