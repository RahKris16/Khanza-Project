 ...
 * @author dosen
 */
public final class RMCariHasilLaborat2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariHasilLaborat2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Hasil Pemeriksaan"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariHasilLaborat2 dialog = new RMCariHasilLaborat2(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "SELECT DATE_FORMAT(detail_periksa_lab.tgl_periksa,'%d-%m-%Y') as tanggal,CONCAT(jns_perawatan_lab.nm_perawatan,' (',DATE_FORMAT(detail_periksa_lab.tgl_periksa,'%d-%m-%Y'),') ') as pemeriksaan,GROUP_CONCAT(CONCAT(template_laboratorium.Pemeriksaan,' ',detail_periksa_lab.nilai) \n" +
