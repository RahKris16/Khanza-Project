...
public final class RMPemantauanPEWSD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-06-2025" }));
        ...
        cmbSkor1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "< 8", "9 - 11", "12 - 20", "21 - 24", "> 25" }));
        ...
        cmbSkor2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "< 91%", "92% - 93%", "94% - 95%", "> 96%" }));
        ...
        cmbSkor4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "< 90", "90 - 100", "101 - 110", "110 - 120", "> 220" }));
        ...
        cmbSkor5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "< 40", "41 - 50", "51 - 90", "91 - 110", "111 - 130", "> 130" }));
        ...
        cmbSkor6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sadar Penuh", "Tidak Ada Respon" }));
        ...
        cmbSkor7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "< 35", "35.1 - 36", "36.1 - 37.5", "38.1 - 39", "> 39.1" }));
        ...
        ParameterSkor.setPreferredSize(new java.awt.Dimension(164, 74));
        ParameterSkor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ParameterSkorKeyPressed(evt);
            }
        });
        scrollPane2.setViewportView(ParameterSkor);

        FormInput.add(scrollPane2);
        scrollPane2.setBounds(129, 210, 660, 70);
    ...
    private void ParameterSkorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ParameterSkorKeyPressed

    }//GEN-LAST:event_ParameterSkorKeyPressed
    ...
    */
    ...
    private void isCombo1(){
        if(cmbSkor1.getSelectedItem().equals("< 8")){
            ...
            Skor1.setForeground(Color.BLACK);
            Skor1.setText("2");
        }else if(cmbSkor1.getSelectedItem().equals("> 25")){
            Skor1.setBackground(Color.RED);
            Skor1.setForeground(Color.WHITE);
            Skor1.setText("3");
        }
    ...
    private void isCombo2(){
        if(cmbSkor2.getSelectedItem().equals("< 91%")){
            ...
            Skor2.setForeground(Color.BLACK); 
            Skor2.setText("1");
        }else if(cmbSkor2.getSelectedItem().equals("> 96%")){
    ...
    private void isCombo4(){
        if(cmbSkor4.getSelectedItem().equals("< 90")){
            Skor4.setBackground(Color.RED);
            Skor4.setForeground(Color.WHITE);
            Skor4.setText("3");
        }else if(cmbSkor4.getSelectedItem().equals("90 - 100")){
            ...
            Skor4.setForeground(Color.BLACK);
            Skor4.setText("1");
        }else if(cmbSkor4.getSelectedItem().equals("110 - 120")){
            Skor4.setBackground(Color.WHITE);
            Skor4.setForeground(new Color(50,50,50));
            Skor4.setText("0");
        }else if(cmbSkor4.getSelectedItem().equals("> 220")){
            Skor4.setBackground(Color.RED);
            Skor4.setForeground(Color.WHITE);
            Skor4.setText("3");
        }
    ...
    private void isCombo5(){
        if(cmbSkor5.getSelectedItem().equals("< 40")){
    ...
    private void isCombo6(){
        if(cmbSkor6.getSelectedItem().equals("Sadar Penuh")){
            Skor6.setBackground(Color.WHITE);
            Skor6.setForeground(new Color(50,50,50));
            Skor6.setText("0");
        }else if(cmbSkor6.getSelectedItem().equals("Tidak Ada Respon")){
    ...
    private void isCombo7(){
        if(cmbSkor7.getSelectedItem().equals("< 35")){
            ...
            Skor7.setText("1");
        }else if(cmbSkor7.getSelectedItem().equals("36.1 - 37.5")){
            ...
            Skor7.setForeground(Color.BLACK);
            Skor7.setText("1");
        }else if(cmbSkor7.getSelectedItem().equals("> 39.1")){
    ...
    private void isHitung(){
        i=0;
        if(cmbSkor1.getSelectedItem().equals("< 8")||cmbSkor1.getSelectedItem().equals("> 25")){
            i++;
        }
        if(cmbSkor4.getSelectedItem().equals("< 90")){
            i++;
        }
        if(cmbSkor5.getSelectedItem().equals("< 40")||cmbSkor5.getSelectedItem().equals("> 130")){
            i++;
        }
        if(cmbSkor6.getSelectedItem().equals("Tidak Ada Respon")){
            i++;
        }
        
        if(Integer.parseInt(TotalSkor.getText())>7){
            ParameterSkor.setText("1. Ketua tim (perawat) melaporkan kepada tim Blue Code.\n" +
            "2. Stabilisasi oleh Tim Code Blue dan pasien dirujuk ke intermediate Care (HCU/ICU)\n" +
            "3. Untuk pasien di IGD (Prioritas 3, 4 dan 5), perawat penanggung jawab melaksanakan penanganan Batuan hidup lanjut (BHL).");
        }else if(Integer.parseInt(TotalSkor.getText())>=5 && Integer.parseInt(TotalSkor.getText())<=6){
            ParameterSkor.setText("1. Ketua Tim (perawat) memberikan informasi tentang kondisi pasien pada dokter jaga atau DPJP dan melakukan asesmen dan menentukan kondisi pasien apakah dalam penyakit akut.\n" +
            "2. Siapkan fasilitas monitoring yang lebih canggih (ICU/HCU).");
        }else if(Integer.parseInt(TotalSkor.getText())>=1 && Integer.parseInt(TotalSkor.getText())<=4){
            ParameterSkor.setText("Perawat pelaksana melapor Meningkatkan frekuensi observasi/ monitoring dan Perbaikan asuhan yang dibutuhkan oleh pasien.");
        }else if(Integer.parseInt(TotalSkor.getText())==0){
            ParameterSkor.setText("Lanjutkan observasi/monitoring secara rutin");
        }
    }
