    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "SELECT resep_obat.tgl_perawatan,resep_obat.jam,GROUP_CONCAT(' ',databarang.nama_brng,' ',resep_dokter.aturan_pakai SEPARATOR ';') as resume FROM resep_dokter "+
                    ...
                    "WHERE resep_obat.no_rawat=? AND resep_dokter.aturan_pakai<>'' GROUP BY resep_dokter.no_resep order by resep_obat.tgl_perawatan,resep_obat.jam");
