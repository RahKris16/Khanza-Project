 ...
 * @author dosen
 */
public final class RMCariMOI extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariMOI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","MOI"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariMOI dialog = new RMCariMOI(new javax.swing.JFrame(), true);
