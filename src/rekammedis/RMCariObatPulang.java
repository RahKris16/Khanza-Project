    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "SELECT permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,GROUP_CONCAT(' ',databarang.nama_brng,' ',detail_permintaan_resep_pulang.dosis SEPARATOR ';') as barang "+
                    ...
                    "INNER JOIN databarang ON detail_permintaan_resep_pulang.kode_brng=databarang.kode_brng WHERE no_rawat=? order by permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam");
                    
                    //"SELECT resep_pulang.tanggal,resep_pulang.jam,GROUP_CONCAT(' ',databarang.nama_brng,' ',resep_pulang.dosis SEPARATOR ';') as resume "+
                    //"FROM `resep_pulang` INNER JOIN databarang on databarang.kode_brng=resep_pulang.kode_brng "+
                    //"WHERE resep_pulang.no_rawat=? and (resep_pulang.tanggal like ? or databarang.nama_brng like ?) order by resep_pulang.tanggal,resep_pulang.jam");
