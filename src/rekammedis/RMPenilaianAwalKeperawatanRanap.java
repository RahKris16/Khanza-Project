...
public final class RMPenilaianAwalKeperawatanRanap extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanRanap(java.awt.Frame parent, boolean modal) {
        ...
        RPK.setDocument(new batasInput((int)300).getKata(RPK));
        RPO.setDocument(new batasInput((int)300).getKata(RPO));
    ...
    */
    ...
    public void setNoRm(String norwt, Date tgl2,String carabayar,String norm) {
        ...
        RPO.setText(Sequel.cariIsi("select transfer_pasien_antar_ruang.obat_yang_telah_diberikan from transfer_pasien_antar_ruang where transfer_pasien_antar_ruang.no_rawat='"+norwt+"'"));
        isRawat(); 
    }
