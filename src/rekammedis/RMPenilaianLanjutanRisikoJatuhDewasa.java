...
public final class RMPenilaianLanjutanRisikoJatuhDewasa extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        scrollPane2.setBounds(840, 30, 755, 270);
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            if(internalFrame1.getHeight()>638){
                ...
                PanelInput.setPreferredSize(new Dimension(WIDTH,566));
        ...
        try {
            ...
            if(Integer.parseInt(NilaiResikoTotal.getText())<25){
                ...
                Saran.setText("1. Orientasikan pasien pada lingkungan kamar/bangsal\n"
                        ...
                        + "5. Singkirkan barang yang berbahaya terutama pada malam hari (kursi tambahan dan lain-lain)\n"
                        + "6. Minta persetujuan pasien agar lampu malam tetap menyala karena lingkungan masih asing\n"
                        ...
                        + "10. Tempatkan meja pasien sesuai dengan tinggi badan\n"
                ...
                Saran.setText("1. Orientasikan pasien pada lingkungan kamar/bangsal\n"
                        ...
                        + "10. Tempatkan meja pasien sesuai dengan tinggi badan\n"
                        + "11. Tempatkan pasien sesuai dengan tinggi badannya\n"
                        + "12. Pasang gelang warna kuning/pin warna kuning/penanda resiko jatuh diluar kamar/tempat tidur pasien\n"
                        + "13. Minta agar pasien segera memencet bel bila perlu bantuan\n"
                        + "14. Awasi atau bantu sebagian ADL pasien\n"
                        + "15. Cepat menganggapi bel\n"
                        + "16. Review kembali obat-obatan yang beresiko\n"
                        + "17. Beritahu pasien agar mobilisasi secara bertahap : duduk perlahan lahan sebelum berdiri\n");
            }else if(Integer.parseInt(NilaiResikoTotal.getText())>=45){
                ...
                Saran.setText("1. Orientasikan pasien pada lingkungan kamar/bangsal\n"
                        ...
                        + "20. Bila memungkinkan pindahkan pasien dekat tempat tidur\n"
                        + "21. Orientasikan ulang bila perlu\n"
                        + "22. Observasi lebih ketat pada pasien yang mendapatkan obat laxantia/diuretika\n"
