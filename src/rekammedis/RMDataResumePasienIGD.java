...
public final class RMDataResumePasienIGD extends javax.swing.JDialog {
    ...
    private RMCariKeluhanIGD carikeluhan1=new RMCariKeluhanIGD(null,false);
//    private RMCariKeluhanIGD1 carikeluhan2=new RMCariKeluhanIGD1(null,false);
    private RMCariPemeriksaanIGD caripemeriksaan=new RMCariPemeriksaanIGD(null,false);
//    private RMCariPemeriksaanIGD2 caripemeriksaan2=new RMCariPemeriksaanIGD2(null,false);
    ...
    private RMCariJumlahObatIGD cariobat=new RMCariJumlahObatIGD(null,false);
    private RMCariJumlahObatIGD cariobat1=new RMCariJumlahObatIGD(null,false);
    ...
    public RMDataResumePasienIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2","ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3","Obat-obatan waktu pulang/nasihat","Prognosa","Tindak Lanjut",
            "Obat IGD"
        }){
...
//        KodeProsedurSekunder3.setDocument(new batasInput((int)8).getKata(KodeProsedurSekunder3));
        ...
        carikeluhan1.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(carikeluhan1.getTable().getSelectedRow()!= -1){
                    Keluhan.append(carikeluhan1.getTable().getValueAt(carikeluhan1.getTable().getSelectedRow(),2).toString()+", ");
...
//        carikeluhan2.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(carikeluhan2.getTable().getSelectedRow()!= -1){
//                    Keluhan.append(carikeluhan2.getTable().getValueAt(carikeluhan2.getTable().getSelectedRow(),2).toString()+", ");
//                    Keluhan.requestFocus();
//                }
//            }
//            @Override
        ...
        caripemeriksaan3.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan3.getTable().getSelectedRow()!= -1){
                    JalannyaPenyakit.append(caripemeriksaan3.getTable().getValueAt(caripemeriksaan3.getTable().getSelectedRow(),2).toString()+", ");
                    JalannyaPenyakit.requestFocus();
                }
            }
            @Override
...
//        caripemeriksaan2.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(caripemeriksaan2.getTable().getSelectedRow()!= -1){
//                    JalannyaPenyakit.append(caripemeriksaan2.getTable().getValueAt(caripemeriksaan2.getTable().getSelectedRow(),2).toString()+", ");
//                    JalannyaPenyakit.requestFocus();
//                }
//            }
//            @Override
...
//        });
        ...
        cariobat1.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariobat1.getTable().getSelectedRow()!= -1){
                    Obat2an1.append(cariobat1.getTable().getValueAt(cariobat1.getTable().getSelectedRow(),2).toString()+"; ");
                    Obat2an1.requestFocus();
                }
            }
            @Override
            public void windowIconified(WindowEvent e) {}
    ...
    private void initComponents() {
        ...
        Obat2an1 = new widget.TextArea();
        jLabel11 = new widget.Label();
        scrollPane6 = new widget.ScrollPane();
        Obat2an = new widget.TextArea();
        jLabel13 = new widget.Label();
        scrollPane7 = new widget.ScrollPane();
        Prognosa = new widget.TextArea();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 825));
        ...
        jLabel15.setText("Obat-obatan di IGD :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(0, 590, 240, 23);

        scrollPane9.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane9.setName("scrollPane9"); // NOI18N

        Obat2an1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Obat2an1.setColumns(20);
        Obat2an1.setRows(5);
        Obat2an1.setName("Obat2an1"); // NOI18N
        Obat2an1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Obat2an1KeyPressed(evt);
            }
        });
        scrollPane9.setViewportView(Obat2an1);

        FormInput.add(scrollPane9);
        scrollPane9.setBounds(250, 590, 541, 50);

        jLabel11.setText("Obat-obatan Waktu Pulang/Nasihat :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(0, 650, 240, 23);
        ...
        scrollPane6.setBounds(250, 650, 541, 50);

        jLabel13.setText("Prognosa :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(0, 710, 240, 23);

        scrollPane7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane7.setName("scrollPane7"); // NOI18N

        Prognosa.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Prognosa.setColumns(20);
        Prognosa.setRows(5);
        Prognosa.setName("Prognosa"); // NOI18N
        Prognosa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PrognosaKeyPressed(evt);
            }
        });
        scrollPane7.setViewportView(Prognosa);

        FormInput.add(scrollPane7);
        scrollPane7.setBounds(250, 710, 541, 50);

        jLabel14.setText("Tindak Lanjut :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 770, 240, 23);
        ...
        scrollPane8.setBounds(250, 770, 541, 50);
        ...
        Kondisi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Hidup", "Meninggal", "Sembuh", "Perbaikan", "Rujuk", "APS" }));
        ...
        BtnDokter1.setBounds(210, 96, 28, 23);
        ...
        BtnDokter8.setBounds(220, 610, 28, 23);
        ...
        BtnDokter4.setBounds(220, 670, 28, 23);
        ...
        BtnDokter7.setBounds(210, 150, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",29,new String[]{
                    ...
                    DiagnosaUtama.getText(),"",DiagnosaSekunder1.getText(),"",DiagnosaSekunder2.getText(), 
                    ...
                    "",ProsedurSekunder3.getText(),"",Kondisi.getSelectedItem().toString(),Obat2an.getText(),
                    Prognosa.getText(),TindakLanjut.getText(),Obat2an1.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
...
//            }
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        dokter.dispose();
        carikeluhan1.dispose();
//        carikeluhan2.dispose();
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptDataResumePasien.jasper","report","::[ Data Resume Pasien ]::",
                        ...
                        "resume_pasien_igd.kd_dokter,dokter.nm_dokter,resume_pasien_igd.kondisi_pulang,resume_pasien_igd.keluhan_utama,resume_pasien_igd.jalannya_penyakit, "+
                        "resume_pasien_igd.pemeriksaan_penunjang,resume_pasien_igd.hasil_laborat,resume_pasien_igd.diagnosa_utama,resume_pasien_igd.kd_diagnosa_utama, "+
                        "resume_pasien_igd.diagnosa_sekunder,resume_pasien_igd.kd_diagnosa_sekunder,resume_pasien_igd.diagnosa_sekunder2,resume_pasien_igd.kd_diagnosa_sekunder2, "+
                        "resume_pasien_igd.diagnosa_sekunder3,resume_pasien_igd.kd_diagnosa_sekunder3,resume_pasien_igd.diagnosa_sekunder4,resume_pasien_igd.kd_diagnosa_sekunder4, "+
                        "resume_pasien_igd.prosedur_utama,resume_pasien_igd.kd_prosedur_utama,resume_pasien_igd.prosedur_sekunder,resume_pasien_igd.kd_prosedur_sekunder, "+
                        "resume_pasien_igd.prosedur_sekunder2,resume_pasien_igd.kd_prosedur_sekunder2,resume_pasien_igd.prosedur_sekunder3,resume_pasien_igd.kd_prosedur_sekunder3, "+
                        "resume_pasien_igd.obat_pulang from resume_pasien_igd inner join reg_periksa on resume_pasien_igd.no_rawat=reg_periksa.no_rawat  "+
                        "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on resume_pasien_igd.kd_dokter=dokter.kd_dokter "+
                    ...
                    Valid.MyReportqry("rptDataResumePasien.jasper","report","::[ Data Resume Pasien ]::",
                        ...
                        "resume_pasien_igd.kd_dokter like '%"+TCari.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari.getText().trim()+"%' or "+
                        "resume_pasien_igd.kondisi_pulang like '%"+TCari.getText().trim()+"%' or resume_pasien_igd.kd_diagnosa_utama like '%"+TCari.getText().trim()+"%' or "+
                        "resume_pasien_igd.diagnosa_utama like '%"+TCari.getText().trim()+"%' or resume_pasien_igd.prosedur_utama like '%"+TCari.getText().trim()+"%' or "+
                        "reg_periksa.no_rawat like '%"+TCari.getText().trim()+"%' or resume_pasien_igd.kd_prosedur_utama like '%"+TCari.getText().trim()+"%') "+
                        "order by reg_periksa.tgl_registrasi",param);
                }
...
//        Valid.pindah(evt,KodeProsedurSekunder2,KodeProsedurSekunder3);
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            if(Sequel.cariIsi("select reg_periksa.status_lanjut from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()).equals("Ralan")){
                ...
                if(Sequel.cariInteger("SELECT COUNT(no_rawat) FROM rujukan_internal_poli WHERE no_rawat='"+TNoRw.getText()+"' AND kd_dokter='"+KodeDokter.getText()+"'")>0){
                    param.put("ruang",Sequel.cariIsi("select poliklinik.nm_poli from poliklinik inner join rujukan_internal_poli on rujukan_internal_poli.kd_poli=poliklinik.kd_poli where rujukan_internal_poli.no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()));
                    tanggal=Sequel.cariIsi("select DATE_FORMAT(tgl_registrasi, '%d-%m-%Y') from reg_periksa where no_rawat=?",tbObat.getValueAt(tbObat.getSelectedRow(),1).toString());
                    param.put("tanggalkeluar",tanggal);
                }
            }else{
            ...
            Valid.MyReport("rptLaporanResumeIGD.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    ...
    private void BtnDokter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter1ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            carikeluhan1.setNoRawat(TNoRw.getText());
            carikeluhan1.tampil();
            carikeluhan1.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            carikeluhan1.setLocationRelativeTo(internalFrame1);
            carikeluhan1.setVisible(true);
        }
        ...
        if(TPasien.getText().trim().equals("")){
            ...
            try {
                ps=koneksi.prepareStatement(
                    "select resume_pasien_igd.keluhan_utama,resume_pasien_igd.diagnosa_utama,resume_pasien_igd.kd_diagnosa_utama,resume_pasien_igd.diagnosa_sekunder,resume_pasien_igd.kd_diagnosa_sekunder,"+
                    "resume_pasien_igd.diagnosa_sekunder2,resume_pasien_igd.kd_diagnosa_sekunder2,resume_pasien_igd.diagnosa_sekunder3,resume_pasien_igd.kd_diagnosa_sekunder3,resume_pasien_igd.diagnosa_sekunder4,"+
                    "resume_pasien_igd.kd_diagnosa_sekunder4,resume_pasien_igd.prosedur_utama,resume_pasien_igd.kd_prosedur_utama,resume_pasien_igd.prosedur_sekunder,resume_pasien_igd.kd_prosedur_sekunder "+
                    "from resume_pasien_igd where resume_pasien_igd.no_rawat=?");
                try {
    ...
    private void PrognosaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrognosaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PrognosaKeyPressed
    ...
    private void Obat2an1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Obat2an1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Obat2an1KeyPressed
    ...
    */
    ...
    private widget.TextArea Obat2an1;
    private javax.swing.JPanel PanelInput;
    private widget.TextArea PemeriksaanPenunjang;
    private widget.TextArea Prognosa;
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "resume_pasien_igd.prosedur_utama,resume_pasien_igd.kd_prosedur_utama,resume_pasien_igd.prosedur_sekunder,resume_pasien_igd.kd_prosedur_sekunder, "+
                    "resume_pasien_igd.prosedur_sekunder2,resume_pasien_igd.kd_prosedur_sekunder2,resume_pasien_igd.prosedur_sekunder3,resume_pasien_igd.kd_prosedur_sekunder3, "+
                    "resume_pasien_igd.obat_pulang,resume_pasien_igd.prognosa,resume_pasien_igd.tindak_lanjut,resume_pasien_igd.obat_igd from resume_pasien_igd inner join reg_periksa on resume_pasien_igd.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on resume_pasien_igd.kd_dokter=dokter.kd_dokter "+
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "(reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or resume_pasien_igd.kd_dokter like ? or "+
                    "dokter.nm_dokter like ? or resume_pasien_igd.kondisi_pulang like ? or resume_pasien_igd.kd_diagnosa_utama like ? or "+
                    "resume_pasien_igd.diagnosa_utama like ? or resume_pasien_igd.prosedur_utama like ? or reg_periksa.no_rawat like ? or "+
                    "resume_pasien_igd.kd_prosedur_utama like ?) order by reg_periksa.tgl_registrasi");
            }
            try {
                if(TCari.getText().equals("")){
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_prosedur_sekunder3"),rs.getString("obat_pulang"),rs.getString("prognosa"),rs.getString("tindak_lanjut"),
                        rs.getString("obat_igd")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
...
//            KodeProsedurSekunder3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());  
            ...
            Prognosa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());     
            TindakLanjut.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());     
            Obat2an1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());     
        }
    }
...
//        try {
//            ps=koneksi.prepareStatement(
//                    "select SUBSTRING_INDEX(penilaian, '\\n', 1) AS baris1,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 2), '\\n', -1)=SUBSTRING_INDEX(penilaian, '\\n', 1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 2), '\\n', -1)) AS baris2,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 3), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 2), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 3), '\\n', -1)) AS baris3,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 4), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 3), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 4), '\\n', -1)) AS baris4,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 5), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 4), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(penilaian, '\\n', 5), '\\n', -1)) AS baris5 from pemeriksaan_ralan WHERE no_rawat=? ORDER BY tgl_perawatan DESC, jam_rawat DESC limit 1;; ");
//            try {
//                ps.setString(1,norwt);
//                rs=ps.executeQuery();
//                while(rs.next()){
...
//        }
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select CASE WHEN INSTR(diagnosis, '+') = 0 THEN SUBSTRING_INDEX(diagnosis, '\\n', 1) ELSE SUBSTRING_INDEX(diagnosis, '+', 1) END AS hasil1,CASE WHEN INSTR(diagnosis, '+') = 0 THEN IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 2), '\\n', -1)=SUBSTRING_INDEX(diagnosis, '\\n', 1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 2), '\\n', -1)) ELSE IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 2), '+', -1)=SUBSTRING_INDEX(diagnosis, '+', 1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 2), '+', -1)) END AS hasil2,CASE WHEN INSTR(diagnosis, '+') = 0 THEN IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 3), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 2), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 3), '\\n', -1)) ELSE IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 3), '+', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 2), '+', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 3), '+', -1)) END AS hasil3,CASE WHEN INSTR(diagnosis, '+') = 0 THEN IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 4), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 3), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 4), '\\n', -1)) ELSE IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 4), '+', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 3), '+', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 4), '+', -1)) END AS hasil4,CASE WHEN INSTR(diagnosis, '+') = 0 THEN IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 5), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 4), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '\\n', 5), '\\n', -1)) ELSE IF(SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 5), '+', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 4), '+', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(diagnosis, '+', 5), '+', -1)) END AS hasil5 from penilaian_medis_igd WHERE no_rawat=? ORDER BY tanggal DESC limit 1 ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    DiagnosaUtama.setText(rs.getString("hasil1"));
                    DiagnosaSekunder1.setText(rs.getString("hasil2"));
                    DiagnosaSekunder2.setText(rs.getString("hasil3"));
                    DiagnosaSekunder3.setText(rs.getString("hasil4"));
                    DiagnosaSekunder4.setText(rs.getString("hasil5"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select keluhan_utama,rps from penilaian_medis_igd where no_rawat=? ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    Keluhan.setText(rs.getString("keluhan_utama")+", "+rs.getString("rps"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select pmg.ket_fisik,CONCAT(IF(pmg.keadaan='','',CONCAT('Keadaan: ',pmg.keadaan,', '))," +
                    "IF(pmg.kesadaran='','',CONCAT('Kesadaran: ',pmg.kesadaran,', '))," +
                    "IF(pmg.gcs='','',CONCAT('GCS: ',pmg.gcs,', '))," +
                    "IF(pmg.td='','',CONCAT('TD: ',pmg.td,' mmHg, '))," +
                    "IF(pmg.nadi='','',CONCAT('Nadi: ',pmg.nadi,' x/menit, '))," +
                    "IF(pmg.rr='','',CONCAT('RR: ',pmg.rr,' x/menit, '))," +
                    "IF(pmg.suhu='','',CONCAT('Suhu: ',pmg.suhu,' °C, '))," +
                    "IF(pmg.spo='','',CONCAT('Spo: ',pmg.spo,' %, '))," +
                    "IF(pmg.bb='','',CONCAT('BB: ',pmg.bb,' Kg, '))," +
                    "IF(pmg.tb='','',CONCAT('TB: ',pmg.tb,' cm'))) as penyakit " +
                    "from penilaian_medis_igd pmg where pmg.no_rawat=? ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien_igd","no_rawat=?","no_rawat=?,kd_dokter=?,keluhan_utama=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,hasil_laborat=?,diagnosa_utama=?,kd_diagnosa_utama=?,diagnosa_sekunder=?,kd_diagnosa_sekunder=?,diagnosa_sekunder2=?,kd_diagnosa_sekunder2=?,diagnosa_sekunder3=?,kd_diagnosa_sekunder3=?,diagnosa_sekunder4=?,kd_diagnosa_sekunder4=?,prosedur_utama=?,kd_prosedur_utama=?,prosedur_sekunder=?,kd_prosedur_sekunder=?,prosedur_sekunder2=?,kd_prosedur_sekunder2=?,prosedur_sekunder3=?,kd_prosedur_sekunder3=?,kondisi_pulang=?,obat_pulang=?,prognosa=?,tindak_lanjut=?,obat_igd=?",30,new String[]{
                TNoRw.getText(),KodeDokter.getText(),Keluhan.getText(),JalannyaPenyakit.getText(),PemeriksaanPenunjang.getText(),HasilLaborat.getText(), 
                DiagnosaUtama.getText(),"",DiagnosaSekunder1.getText(),"",DiagnosaSekunder2.getText(), 
                "",DiagnosaSekunder3.getText(),"",DiagnosaSekunder4.getText(),"", 
                ProsedurUtama.getText(),"",ProsedurSekunder1.getText(),"",ProsedurSekunder2.getText(), 
                "",ProsedurSekunder3.getText(),"",Kondisi.getSelectedItem().toString(),Obat2an.getText(),
                Prognosa.getText(),TindakLanjut.getText(),Obat2an1.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()
            })==true){
               tampil();
               emptTeks();
        }
...
//        }
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from resume_pasien_igd where no_rawat=?",1,new String[]{
