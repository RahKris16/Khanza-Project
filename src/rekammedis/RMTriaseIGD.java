                ...
                if(LoadHTML.getText().contains("#AA0000")){
                            ...
                            if(rs.next()){
                                ...
                                try {
                                    ...
                                    while(rs2.next()){
                                        ...
                                        Sequel.menyimpan2("temporary","'"+i+"','"+rs2.getString("nama_pemeriksaan")+"','"+datatriase+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Transaksi");
                                        i++;
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : "+e);
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 1":
                              Valid.MyReportqry("rptLembarTriaseSkala1.jasper","report","::[ Triase Skala 1 ]::","select * from temporary order by temporary.no",param);
                              break;
                        case "PDF Triase Skala 1":
                              Valid.MyReportqrypdf("rptLembarTriaseSkala1.jasper","report","::[ Triase Skala 1 ]::","select * from temporary order by temporary.no",param);
                              break;
                    } 
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 2":
                              Valid.MyReportqry("rptLembarTriaseSkala2.jasper","report","::[ Triase Skala 2 ]::","select * from temporary order by temporary.no",param);
                              break;
                        case "PDF Triase Skala 2":
                              Valid.MyReportqrypdf("rptLembarTriaseSkala2.jasper","report","::[ Triase Skala 2 ]::","select * from temporary order by temporary.no",param);
                              break;
                    } 
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 3":
                              Valid.MyReportqry("rptLembarTriaseSkala3.jasper","report","::[ Triase Skala 3 ]::","select * from temporary order by temporary.no",param);
                              break;
                        case "PDF Triase Skala 3":
                              Valid.MyReportqrypdf("rptLembarTriaseSkala3.jasper","report","::[ Triase Skala 3 ]::","select * from temporary order by temporary.no",param);
                              break;
                    }
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 4":
                              Valid.MyReportqry("rptLembarTriaseSkala4.jasper","report","::[ Triase Skala 4 ]::","select * from temporary order by temporary.no",param);
                              break;
                        case "PDF Triase Skala 4":
                              Valid.MyReportqrypdf("rptLembarTriaseSkala4.jasper","report","::[ Triase Skala 4 ]::","select * from temporary order by temporary.no",param);
                              break;
                    }
                    ...
                    switch (pilihan) {
                        case "Lembar Triase Skala 5":
                              Valid.MyReportqry("rptLembarTriaseSkala5.jasper","report","::[ Triase Skala 5 ]::","select * from temporary order by temporary.no",param);
                              break;
