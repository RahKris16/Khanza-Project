...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private RMCariPemeriksaanRanap caripemeriksaan4=new RMCariPemeriksaanRanap(null,false);
    private RMCariPemeriksaanRanap1 caripemeriksaan5=new RMCariPemeriksaanRanap1(null,false);
    ...
    private RMCariJumlahObat cariobat1=new RMCariJumlahObat(null,false);
    private RMCariJumlahObatIGD cariobat2=new RMCariJumlahObatIGD(null,false);
    private RMCariJumlahObatRanap cariobat3=new RMCariJumlahObatRanap(null,false);
...
//    private RMCariDiagnosa caridiagnosa=new RMCariDiagnosa(null,false);
//    private RMCariDiagnosa caridiagnosa2=new RMCariDiagnosa(null,false);
//    private RMCariDiagnosa caridiagnosa3=new RMCariDiagnosa(null,false);
//    private RMCariDiagnosa caridiagnosa4=new RMCariDiagnosa(null,false);
//    private RMCariDiagnosa caridiagnosa5=new RMCariDiagnosa(null,false);
//    private RMCariProsedur cariprosedur=new RMCariProsedur(null,false);
//    private RMCariProsedur cariprosedur2=new RMCariProsedur(null,false);
//    private RMCariProsedur cariprosedur3=new RMCariProsedur(null,false);
//    private RMCariProsedur cariprosedur4=new RMCariProsedur(null,false);
    ...
    public RMDataResumePasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Keluhan Utama Riwayat Penyakit","Pemeriksaan Fisik","Kondisi Awal Masuk Rawat Inap","Perubahan Kondisi Selama Perawatan","Pemeriksaan Penunjang Rad Terpenting",
...
//        KodeProsedurSekunder3.setDocument(new batasInput((int)8).getKata(KodeProsedurSekunder3));
        ...
        KetDilanjutkan.setDocument(new batasInput((int)150).getKata(KetDilanjutkan));
        ...
        caripemeriksaan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan.getTable().getSelectedRow()!= -1){
                    KeluhanUtama.append(caripemeriksaan.getTable().getValueAt(caripemeriksaan.getTable().getSelectedRow(),2).toString()+", ");
                    KeluhanUtama.requestFocus();
                }
            }
            @Override
        ...
        cariobat1.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(cariobat1.getTable().getSelectedRow()!= -1){
                    ObatPulang.append(cariobat1.getTable().getValueAt(cariobat1.getTable().getSelectedRow(),2).toString()+", ");
        ...
        caridiet.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(caridiet.getTable().getSelectedRow()!= -1){
                    Diet.append(caridiet.getTable().getValueAt(caridiet.getTable().getSelectedRow(),0).toString()+", ");
                    Diet.requestFocus();
                }
            }
            @Override
        ...
        caripemeriksaan4.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan4.getTable().getSelectedRow()!= -1){
                    PemeriksaanFisik.append(caripemeriksaan4.getTable().getValueAt(caripemeriksaan4.getTable().getSelectedRow(),2).toString()+", ");
        ...
        caripemeriksaan5.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan5.getTable().getSelectedRow()!= -1){
                    PemeriksaanFisik.append(caripemeriksaan5.getTable().getValueAt(caripemeriksaan5.getTable().getSelectedRow(),2).toString()+", ");
                    PemeriksaanFisik.requestFocus();
                }
            }
            @Override
        ...
        caripemeriksaan3.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan3.getTable().getSelectedRow()!= -1){
                    PemeriksaanFisik.append(caripemeriksaan3.getTable().getValueAt(caripemeriksaan3.getTable().getSelectedRow(),2).toString()+", ");
                    PemeriksaanFisik.requestFocus();
                }
            }
            @Override
        ...
        cariobat3.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(cariobat3.getTable().getSelectedRow()!= -1){
                    ObatSelamaDiRS.append(cariobat3.getTable().getValueAt(cariobat3.getTable().getSelectedRow(),1).toString()+"; ");
                    ObatSelamaDiRS.requestFocus();
                }
            }
            @Override
...
//                    DiagnosaUtama.setText(caridiagnosa.getTable().getValueAt(caridiagnosa.getTable().getSelectedRow(),0).toString());
//                    KodeDiagnosaUtama.setText(caridiagnosa.getTable().getValueAt(caridiagnosa.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        caridiagnosa2.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(caridiagnosa2.getTable().getSelectedRow()!= -1){
//                    DiagnosaSekunder1.setText(caridiagnosa2.getTable().getValueAt(caridiagnosa2.getTable().getSelectedRow(),0).toString());
//                    KodeDiagnosaSekunder1.setText(caridiagnosa2.getTable().getValueAt(caridiagnosa2.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        caridiagnosa3.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(caridiagnosa3.getTable().getSelectedRow()!= -1){
//                    DiagnosaSekunder2.setText(caridiagnosa3.getTable().getValueAt(caridiagnosa3.getTable().getSelectedRow(),0).toString());
//                    KodeDiagnosaSekunder2.setText(caridiagnosa3.getTable().getValueAt(caridiagnosa3.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        caridiagnosa4.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(caridiagnosa4.getTable().getSelectedRow()!= -1){
//                    DiagnosaSekunder3.setText(caridiagnosa4.getTable().getValueAt(caridiagnosa4.getTable().getSelectedRow(),0).toString());
//                    KodeDiagnosaSekunder3.setText(caridiagnosa4.getTable().getValueAt(caridiagnosa4.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        caridiagnosa5.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(caridiagnosa5.getTable().getSelectedRow()!= -1){
//                    DiagnosaSekunder4.setText(caridiagnosa5.getTable().getValueAt(caridiagnosa5.getTable().getSelectedRow(),0).toString());
//                    KodeDiagnosaSekunder4.setText(caridiagnosa5.getTable().getValueAt(caridiagnosa5.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        cariprosedur.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(cariprosedur.getTable().getSelectedRow()!= -1){
//                    ProsedurUtama.setText(cariprosedur.getTable().getValueAt(cariprosedur.getTable().getSelectedRow(),0).toString());
//                    KodeProsedurUtama.setText(cariprosedur.getTable().getValueAt(cariprosedur.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        cariprosedur2.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(cariprosedur2.getTable().getSelectedRow()!= -1){
//                    ProsedurSekunder1.setText(cariprosedur2.getTable().getValueAt(cariprosedur2.getTable().getSelectedRow(),0).toString());
//                    KodeProsedurSekunder1.setText(cariprosedur2.getTable().getValueAt(cariprosedur2.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        cariprosedur3.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(cariprosedur3.getTable().getSelectedRow()!= -1){
//                    ProsedurSekunder2.setText(cariprosedur3.getTable().getValueAt(cariprosedur3.getTable().getSelectedRow(),0).toString());
//                    KodeProsedurSekunder2.setText(cariprosedur3.getTable().getValueAt(cariprosedur3.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
//        
//        cariprosedur4.addWindowListener(new WindowListener() {
//            @Override
//            public void windowOpened(WindowEvent e) {}
//            @Override
//            public void windowClosing(WindowEvent e) {}
//            @Override
//            public void windowClosed(WindowEvent e) {
//                if(cariprosedur4.getTable().getSelectedRow()!= -1){
//                    ProsedurSekunder3.setText(cariprosedur4.getTable().getValueAt(cariprosedur4.getTable().getSelectedRow(),0).toString());
//                    KodeProsedurSekunder3.setText(cariprosedur4.getTable().getValueAt(cariprosedur4.getTable().getSelectedRow(),1).toString());
//                }
//            }
//            @Override
//            public void windowIconified(WindowEvent e) {}
...
//        });
    ...
    private void initComponents() {
        ...
        PerubahanKondisi = new widget.TextArea();
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 1231));

        FormInput.setBackground(new java.awt.Color(250, 255, 245));
        FormInput.setBorder(null);
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(100, 1229));
        ...
        jLabel25.setBounds(0, 697, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(150, 697, 520, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(0, 727, 145, 23);
        ...
        DiagnosaUtama.setBounds(150, 637, 520, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 637, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(150, 727, 520, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(0, 757, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(150, 757, 520, 23);
        ...
        jLabel9.setBounds(0, 388, 220, 23);
        ...
        scrollPane4.setBounds(224, 388, 561, 50);

        jLabel10.setText("Pemeriksaan Penunjang Lab Terpenting :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(0, 445, 220, 23);
        ...
        scrollPane5.setBounds(224, 445, 561, 50);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(0, 617, 100, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 667, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(150, 667, 520, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 787, 145, 23);
        ...
        ProsedurUtama.setBounds(150, 787, 520, 23);
        ...
        ProsedurSekunder1.setBounds(150, 817, 520, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(0, 817, 145, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(0, 847, 145, 23);
        ...
        ProsedurSekunder2.setBounds(150, 847, 520, 23);
        ...
        ProsedurSekunder3.setBounds(150, 877, 520, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(0, 877, 145, 23);
        ...
        BtnDokter2.setBounds(192, 414, 28, 23);
        ...
        BtnDokter3.setBounds(192, 471, 28, 23);

        jLabel37.setText("Cara Keluar :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(379, 1108, 70, 23);
        ...
        CaraKeluar.setBounds(453, 1108, 205, 23);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(14, 1108, 100, 23);
        ...
        Keadaan.setBounds(118, 1108, 130, 23);
        ...
        jLabel12.setBounds(0, 502, 220, 23);
        ...
        BtnDokter16.setBounds(192, 528, 28, 23);
        ...
        scrollPane7.setBounds(224, 502, 561, 50);

        jLabel38.setText("Alergi Obat :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(0, 907, 100, 23);
        ...
        Alergi.setBounds(104, 907, 681, 23);

        jLabel39.setText("Diet :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(0, 937, 100, 23);
        ...
        KetKeluar.setBounds(660, 1108, 125, 23);

        jLabel40.setText("Hasil Lab Yang Belum Selesai (Pending) :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 994, 230, 23);
        ...
        BtnDokter17.setBounds(202, 1020, 28, 23);
        ...
        scrollPane8.setBounds(104, 937, 681, 50);

        jLabel41.setText("Instruksi/Anjuran Dan Edukasi (Follow Up) :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 1051, 230, 23);
        ...
        scrollPane9.setBounds(234, 1051, 551, 50);
        ...
        KetKeadaanPulang.setBounds(250, 1108, 130, 23);

        jLabel42.setText("Kontrol Selanjutnya :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(4, 1138, 110, 23);

        DIlanjutkan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Faskes Tingkat Pertama", "Poli Bedah", "Poli Saraf", "Poli Psikiatri", "Poli Orthopedi", "Poli Anak", "Poli Penyakit Dalam", "Poli Rehabilitasi Medik", "Poli Paru", "Poli Jantung & Pembuluh Darah", "Poli Obgyn", "Poli Mata", "Poli THT - KL", "Poli Kulit & Kelamin", "Poli Urologi", "Poli Bedah Saraf", "Lainnya" }));
        ...
        DIlanjutkan.setBounds(118, 1138, 130, 23);
        ...
        KetDilanjutkan.setBounds(320, 1138, 200, 23);

        Kontrol.setForeground(new java.awt.Color(50, 70, 50));
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-02-2025 15:46:45" }));
        ...
        BtnDokter18.setBounds(72, 963, 28, 23);
        ...
        scrollPane10.setBounds(234, 994, 551, 50);

        jLabel11.setText("Jalannya Penyakit Selama Perawatan");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(3, 274, 210, 23);
        ...
        scrollPane6.setBounds(224, 294, 561, 40);
        ...
        scrollPane11.setBounds(120, 1168, 665, 50);
        ...
        BtnDokter19.setBounds(86, 1194, 28, 23);
        ...
        BtnDokter20.setBounds(192, 585, 28, 23);
        ...
        scrollPane12.setBounds(224, 559, 561, 50);

        jLabel13.setText("Obat-obatan Selama Perawatan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(0, 559, 220, 23);
        ...
        BtnDokter6.setBounds(192, 240, 28, 23);
        ...
        BtnDokter7.setBounds(160, 240, 28, 23);

        jLabel43.setText("Indikasi :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(214, 1138, 100, 23);

        scrollPane13.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane13.setName("scrollPane13"); // NOI18N

        PerubahanKondisi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        PerubahanKondisi.setColumns(20);
        PerubahanKondisi.setRows(5);
        PerubahanKondisi.setName("PerubahanKondisi"); // NOI18N
        PerubahanKondisi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PerubahanKondisiKeyPressed(evt);
            }
        });
        scrollPane13.setViewportView(PerubahanKondisi);

        FormInput.add(scrollPane13);
        scrollPane13.setBounds(224, 341, 561, 40);

        jLabel14.setText("Kondisi Awal Masuk Rawat Inap :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 294, 220, 23);

        jLabel31.setText("Perubahan Kondisi Selama Perawatan :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(0, 339, 220, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            Valid.textKosong(JalannyaPenyakit,"Kondisi awal masuk rawat inap");
        }else if(PerubahanKondisi.getText().equals("")){
            Valid.textKosong(PerubahanKondisi,"Perubahan kondisi selama perawatan");
        ...
        }else if(KetDilanjutkan.getText().equals("")){
            Valid.textKosong(KetDilanjutkan,"Indikasi");
        }else{
            if(Sequel.menyimpantf("resume_pasien_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",41,new String[]{
                    ...
                    PemeriksaanRad.getText(),HasilLaborat.getText(),TindakanSelamaDiRS.getText(),ObatSelamaDiRS.getText(),DiagnosaUtama.getText(),"",
                    DiagnosaSekunder1.getText(),"",DiagnosaSekunder2.getText(),"",DiagnosaSekunder3.getText(),
                    "",DiagnosaSekunder4.getText(),"",ProsedurUtama.getText(),"",
                    ProsedurSekunder1.getText(),"",ProsedurSekunder2.getText(),"",ProsedurSekunder3.getText(), 
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        ObatSelamaDiRS.getText(),DiagnosaUtama.getText(),"",DiagnosaSekunder1.getText(),"",DiagnosaSekunder2.getText(),
                        "",DiagnosaSekunder3.getText(),"",DiagnosaSekunder4.getText(),"",
                        ProsedurUtama.getText(),"",ProsedurSekunder1.getText(),"",ProsedurSekunder2.getText(),"",
                        ProsedurSekunder3.getText(),"",Alergi.getText(),Diet.getText(),LabBelum.getText(),Edukasi.getText(),Keadaan.getSelectedItem().toString(),
                    ...
                    Sequel.menyimpan("resume_pasien_ranap_tambahan","'"+TNoRw.getText()+"','"+PerubahanKondisi.getText()+"'");
                    emptTeks();
...
//            }
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        ...
        caripemeriksaan2.dispose();
        caripemeriksaan3.dispose();
        caripemeriksaan4.dispose();
...
//        caridiagnosa.dispose();
//        caridiagnosa2.dispose();
//        caridiagnosa3.dispose();
//        caridiagnosa4.dispose();
//        caridiagnosa5.dispose();
//        cariprosedur.dispose();
//        cariprosedur2.dispose();
//        cariprosedur3.dispose();
//        cariprosedur4.dispose();
        cariobat3.dispose();
        dispose();
...
//        Valid.pindah(evt,KodeProsedurSekunder2,KodeProsedurSekunder3);
    ...
    private void BtnDokter19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter19ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            cariobat1.setNoRawat(TNoRw.getText());
            cariobat1.tampil();
            cariobat1.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariobat1.setLocationRelativeTo(internalFrame1);
            cariobat1.setVisible(true);
        }
...
//        Valid.pindah(evt,KodeProsedurSekunder3,Diet);
    ...
    private void BtnDokter20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter20ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            cariobat3.setNoRawat(TNoRw.getText());
            cariobat3.tampil();
            cariobat3.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            cariobat3.setLocationRelativeTo(internalFrame1);
            cariobat3.setVisible(true);
        }
    ...
    private void BtnDokter6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter6ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            caripemeriksaan4.setNoRawat(TNoRw.getText());
            caripemeriksaan4.tampil();
            caripemeriksaan4.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            caripemeriksaan4.setLocationRelativeTo(internalFrame1);
            caripemeriksaan4.setVisible(true);
        }
    ...
    private void BtnDokter7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter7ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            caripemeriksaan5.setNoRawat(TNoRw.getText());
            caripemeriksaan5.tampil();
            caripemeriksaan5.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            caripemeriksaan5.setLocationRelativeTo(internalFrame1);
            caripemeriksaan5.setVisible(true);
        }
    }//GEN-LAST:event_BtnDokter7ActionPerformed

    private void PerubahanKondisiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PerubahanKondisiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PerubahanKondisiKeyPressed
    ...
    */
    ...
    private widget.TextArea PerubahanKondisi;
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "resume_pasien_ranap.prosedur_sekunder2,resume_pasien_ranap.kd_prosedur_sekunder2,resume_pasien_ranap.prosedur_sekunder3,resume_pasien_ranap.kd_prosedur_sekunder3,resume_pasien_ranap.alergi,"+
                    "resume_pasien_ranap.diet,resume_pasien_ranap.lab_belum,resume_pasien_ranap.edukasi,resume_pasien_ranap.cara_keluar,resume_pasien_ranap.ket_keluar,resume_pasien_ranap.keadaan,"+
                    "resume_pasien_ranap.ket_keadaan,resume_pasien_ranap.dilanjutkan,resume_pasien_ranap.ket_dilanjutkan,resume_pasien_ranap.kontrol,resume_pasien_ranap.obat_pulang,reg_periksa.kd_pj,penjab.png_jawab,IFNULL(resume_pasien_ranap_tambahan.perubahan_kondisi, \"\") as perubahan_kondisi "+
                    "from resume_pasien_ranap inner join reg_periksa on resume_pasien_ranap.no_rawat=reg_periksa.no_rawat inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on resume_pasien_ranap.kd_dokter=dokter.kd_dokter inner join dokter as pengirim on reg_periksa.kd_dokter=pengirim.kd_dokter "+
                    "inner join penjab on penjab.kd_pj=reg_periksa.kd_pj left join resume_pasien_ranap_tambahan on resume_pasien_ranap_tambahan.no_rawat=resume_pasien_ranap.no_rawat where reg_periksa.tgl_registrasi between ? and ? "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                        ...
                        "where kamar_inap.no_rawat=? order by tgl_keluar desc,jam_keluar desc limit 1");
                    try {
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("jalannya_penyakit"),rs.getString("perubahan_kondisi"),rs.getString("pemeriksaan_penunjang"),rs.getString("hasil_laborat"),rs.getString("tindakan_dan_operasi"),
...
//        KodeProsedurSekunder3.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            PerubahanKondisi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
...
//                    DiagnosaAwal.setText(rs.getString("diagnosa_awal"));
    ...
    public void setNoRm(String norwt, Date tgl2) {
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select penilaian_medis_ranap.keluhan_utama,penilaian_medis_ranap.ket_fisik from penilaian_medis_ranap where no_rawat=? ");
            try {
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 1) AS baris1,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 2), '\\n', -1)=SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 2), '\\n', -1)) AS baris2,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 3), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 2), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 3), '\\n', -1)) AS baris3,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 4), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 3), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 4), '\\n', -1)) AS baris4,IF(SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 5), '\\n', -1)=SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 4), '\\n', -1),\"\",SUBSTRING_INDEX(SUBSTRING_INDEX(pemeriksaan_ranap.penilaian, '\\n', 5), '\\n', -1)) AS baris5 from pemeriksaan_ranap inner join dokter on dokter.kd_dokter=pemeriksaan_ranap.nip WHERE no_rawat=? AND (dokter.nm_dokter LIKE '%dr.%' or dokter.nm_dokter LIKE '%drg.%') ORDER BY tgl_perawatan DESC, jam_rawat DESC limit 1; ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    DiagnosaUtama.setText(rs.getString("baris1"));
                    DiagnosaSekunder1.setText(rs.getString("baris2"));
                    DiagnosaSekunder2.setText(rs.getString("baris3"));
                    DiagnosaSekunder3.setText(rs.getString("baris4"));
                    DiagnosaSekunder4.setText(rs.getString("baris5"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select penilaian_medis_igd.diagnosis from penilaian_medis_igd where penilaian_medis_igd.no_rawat=? ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    DiagnosaAwal.setText(rs.getString("diagnosis"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select hasil from hasil_radiologi where no_rawat=? order by hasil_radiologi.tgl_periksa,hasil_radiologi.jam desc limit 1 ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select tindakan from checklist_pre_operasi where no_rawat=? ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    TindakanSelamaDiRS.setText(rs.getString("tindakan"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select diet.nama_diet "+
                    "from detail_beri_diet INNER JOIN diet ON detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.no_rawat=? "+
                    "order by detail_beri_diet.tanggal,detail_beri_diet.waktu desc limit 1");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    Diet.setText(rs.getString("nama_diet"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
        ...
        try {
            ps=koneksi.prepareStatement(
                    "SELECT GROUP_CONCAT(' ',databarang.nama_brng,' ',detail_permintaan_resep_pulang.dosis SEPARATOR ';') as barang "+
                    "FROM permintaan_resep_pulang INNER JOIN detail_permintaan_resep_pulang ON permintaan_resep_pulang.no_permintaan=detail_permintaan_resep_pulang.no_permintaan "+
                    "INNER JOIN databarang ON detail_permintaan_resep_pulang.kode_brng=databarang.kode_brng WHERE no_rawat=? ");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    ObatPulang.setText(rs.getString("barang"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
        ...
        try {
            ps=koneksi.prepareStatement(
                    "SELECT resep_obat.tgl_perawatan, GROUP_CONCAT(' ',databarang.nama_brng,' ',resep_dokter.aturan_pakai SEPARATOR ';') as resume FROM resep_dokter "+
                    "INNER JOIN resep_obat ON resep_obat.no_resep=resep_dokter.no_resep INNER JOIN databarang on databarang.kode_brng=resep_dokter.kode_brng "+
                    "INNER JOIN jenis ON jenis.kdjns=databarang.kdjns WHERE resep_obat.no_rawat=? and (jenis.kdjns='J005' or jenis.kdjns='J006' or jenis.kdjns='J007' or jenis.kdjns='J011' or jenis.kdjns='J016' or jenis.kdjns='JVA' or jenis.kdjns='JVAD' or jenis.kdjns='JVAK' or jenis.kdjns='JVAR')");
            try {
                ps.setString(1,norwt);
                rs=ps.executeQuery();
                while(rs.next()){
                    ObatSelamaDiRS.setText(rs.getString("resume"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
...
//                })==true){
                   ...
                   tbObat.setValueAt(PerubahanKondisi.getText(),tbObat.getSelectedRow(),18);
                   tbObat.setValueAt(PemeriksaanRad.getText(),tbObat.getSelectedRow(),19);
                   tbObat.setValueAt(HasilLaborat.getText(),tbObat.getSelectedRow(),20);
                   tbObat.setValueAt(TindakanSelamaDiRS.getText(),tbObat.getSelectedRow(),21);
                   tbObat.setValueAt(ObatSelamaDiRS.getText(),tbObat.getSelectedRow(),22);
                   tbObat.setValueAt(DiagnosaUtama.getText(),tbObat.getSelectedRow(),23);
//                   tbObat.setValueAt(KodeDiagnosaUtama.getText(),tbObat.getSelectedRow(),23);
                   tbObat.setValueAt(DiagnosaSekunder1.getText(),tbObat.getSelectedRow(),25);
//                   tbObat.setValueAt(KodeDiagnosaSekunder1.getText(),tbObat.getSelectedRow(),25);
                   tbObat.setValueAt(DiagnosaSekunder2.getText(),tbObat.getSelectedRow(),27);
//                   tbObat.setValueAt(KodeDiagnosaSekunder2.getText(),tbObat.getSelectedRow(),27);
                   tbObat.setValueAt(DiagnosaSekunder3.getText(),tbObat.getSelectedRow(),29);
//                   tbObat.setValueAt(KodeDiagnosaSekunder3.getText(),tbObat.getSelectedRow(),29);
                   tbObat.setValueAt(DiagnosaSekunder4.getText(),tbObat.getSelectedRow(),31);
...
//                   tbObat.setValueAt(KodeProsedurSekunder3.getText(),tbObat.getSelectedRow(),39);
                   tbObat.setValueAt(Alergi.getText(),tbObat.getSelectedRow(),41);
                   tbObat.setValueAt(Diet.getText(),tbObat.getSelectedRow(),42);
                   tbObat.setValueAt(LabBelum.getText(),tbObat.getSelectedRow(),43);
                   tbObat.setValueAt(Edukasi.getText(),tbObat.getSelectedRow(),44);
                   ...
                   if(Sequel.cariInteger("select count(resume_pasien_ranap_tambahan.no_rawat) from resume_pasien_ranap_tambahan where resume_pasien_ranap_tambahan.no_rawat=?",TNoRw.getText())>0){
                       Sequel.mengedit("resume_pasien_ranap_tambahan","no_rawat=?","perubahan_kondisi='"+PerubahanKondisi.getText()+"'",1,new String[]{TNoRw.getText()});
                   }else{
                       Sequel.menyimpan("resume_pasien_ranap_tambahan","'"+TNoRw.getText()+"','"+PerubahanKondisi.getText()+"'");
                   }
                   emptTeks();
    ...
    private void hapus() {
        ...
        {
            if(Sequel.queryu2tf("delete from resume_pasien_ranap_tambahan where no_rawat=?",1,new String[]{
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true)
            {
