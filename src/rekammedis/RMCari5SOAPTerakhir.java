...
public final class RMCari5SOAPTerakhir extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat SOAPIE ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
        ...
        if(Status.getSelectedIndex()==0){
            try{
                ps=koneksi.prepareStatement(
                        ...
                        "pemeriksaan_ralan.penilaian,pemeriksaan_ralan.rtl,pemeriksaan_ralan.instruksi,pemeriksaan_ralan.evaluasi,dokter.nm_dokter "+
                        "from pemeriksaan_ralan inner join reg_periksa on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat "+
                        "inner join dokter on dokter.kd_dokter =pemeriksaan_ralan.nip where "+
            ...
            try{
                ps=koneksi.prepareStatement(
                        ...
                        "inner join dokter on dokter.kd_dokter =pemeriksaan_ranap.nip where "+
                        "reg_periksa.no_rkm_medis=? and "+
    ...
    for (int row = 0; row < table.getRowCount(); row++) {
        int maxHeight = table.getRowHeight(); // tinggi minimum default
        for (int col = 0; col < table.getColumnCount(); col++) {
            TableCellRenderer renderer = table.getCellRenderer(row, col);
            java.awt.Component comp = table.prepareRenderer(renderer, row, col);
            comp.setSize(table.getColumnModel().getColumn(col).getWidth(), Short.MAX_VALUE);
