 ...
 * @author dosen
 */
public final class RMCariPemeriksaan2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariPemeriksaan2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariPemeriksaan2 dialog = new RMCariPemeriksaan2(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.suhu_tubuh,pemeriksaan_ralan.tensi,pemeriksaan_ralan.nadi,pemeriksaan_ralan.respirasi,pemeriksaan_ralan.gcs "+
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.suhu_tubuh,pemeriksaan_ranap.tensi,pemeriksaan_ranap.nadi,pemeriksaan_ranap.respirasi,pemeriksaan_ranap.gcs "+
