    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select jns_perawatan_lab.nm_perawatan,detail_periksa_lab.tgl_periksa,detail_periksa_lab.jam,template_laboratorium.Pemeriksaan, detail_periksa_lab.nilai "+
                    "from detail_periksa_lab inner join template_laboratorium on detail_periksa_lab.id_template=template_laboratorium.id_template inner join jns_perawatan_lab on detail_periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw where "+
