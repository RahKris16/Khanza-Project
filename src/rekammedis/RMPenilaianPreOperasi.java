...
public final class RMPenilaianPreOperasi extends javax.swing.JDialog {
    ...
    private RMCariMOI moi=new RMCariMOI(null,false);
    ...
    public RMPenilaianPreOperasi(java.awt.Frame parent, boolean modal) {
        ...
        moi.addWindowListener(new WindowListener() {
            @Override
            ...
            public void windowClosed(WindowEvent e) {
                if(moi.getTable().getSelectedRow()!= -1){
                    RingkasanKlinik.append(moi.getTable().getValueAt(moi.getTable().getSelectedRow(),2).toString()+", ");
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-05-2024 19:52:51" }));
        ...
        BtnDokter1.setBounds(740, 105, 28, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-05-2024" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-05-2024" }));
    ...
    private void BtnDokter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter1ActionPerformed
        if(TNoRw.getText().equals("")&&TNoRM.getText().equals("")){
            ...
            moi.setNoRawat(TNoRw.getText());
            moi.tampil();
            moi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            moi.setLocationRelativeTo(internalFrame1);
            moi.setVisible(true);
        }
    ...
    */
    ...
    private void isRawat() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select CONCAT('Suhu: ',suhu,' °C, TD: ',td,', Nadi: ',nadi,' x/menit, RR: ',rr,' x/menit, GCS: ',gcs,', Status Lokalis: ',ket_lokalis) as nilai "
                    + "from penilaian_medis_igd where no_rawat=?");
            try{
                ps.setString(1,TNoRw.getText());
                rs=ps.executeQuery();
                if(rs.next()){
                        PemeriksaanFisik.setText(rs.getString("nilai"));
                }
            }catch(Exception ex){
    ...
    public void setNoRm(String norwt,Date tgl2) {
        ...
        try {
            ...
            try {
                ...
                rs=ps.executeQuery();
                while(rs.next()){
                    DiagnosaPreOperasi.setText(rs.getString("diagnosis"));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
