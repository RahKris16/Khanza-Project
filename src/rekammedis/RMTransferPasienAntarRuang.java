...
public final class RMTransferPasienAntarRuang extends javax.swing.JDialog {
    ...
    public RMTransferPasienAntarRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Petugas Yang Menyerahkan","NIP Menerima","Petugas Yang Menerima","Rencana Terapi","Rencana Tindakan","MPP","Alasan","Dischare Planning","Alasan"
        }){
        ...
        RencanaTerapi.setDocument(new batasInput((int)800).getKata(RencanaTerapi));
        RencanaTindakan.setDocument(new batasInput((int)800).getKata(RencanaTindakan));
    ...
    private void initComponents() {
        ...
        RencanaTerapi = new widget.TextArea();
        ...
        MPP = new widget.ComboBox();
        label18 = new widget.Label();
        DP = new widget.ComboBox();
        label19 = new widget.Label();
        AlasanMPP = new widget.ComboBox();
        label20 = new widget.Label();
        AlasanDP = new widget.ComboBox();
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 577));
        ...
        MenyetujuiPemindahan.setBounds(775, 480, 80, 23);
        ...
        TanggalMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2025 08:55:14" }));
        ...
        TanggalPindah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2025 08:55:17" }));
        ...
        KeteranganPeralatan.setBounds(288, 480, 160, 23);
        ...
        PeralatanMenyertai.setBounds(150, 480, 135, 23);
        ...
        jLabel30.setBounds(15, 200, 170, 23);
        ...
        scrollPane1.setBounds(15, 220, 410, 43);

        jLabel31.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel31.setText("Prosedur Yang Sudah Dilakukan :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(445, 200, 170, 23);
        ...
        scrollPane2.setBounds(445, 220, 410, 43);
        ...
        jLabel32.setBounds(15, 270, 170, 23);

        jLabel33.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel33.setText("Pemeriksaan Penunjang Yang Sudah Dilakukan :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(445, 270, 370, 23);

        jLabel53.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel53.setText("Rencana Terapi Selanjutnya :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(15, 370, 170, 23);

        jLabel54.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel54.setText("Rencana Tindakan/Penunjang Selanjutnya :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(445, 370, 250, 23);
        ...
        scrollPane8.setViewportView(RencanaTindakan);

        FormInput.add(scrollPane8);
        scrollPane8.setBounds(445, 390, 410, 73);

        scrollPane7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane7.setName("scrollPane7"); // NOI18N

        RencanaTerapi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        RencanaTerapi.setColumns(20);
        RencanaTerapi.setRows(5);
        RencanaTerapi.setName("RencanaTerapi"); // NOI18N
        RencanaTerapi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                RencanaTerapiKeyPressed(evt);
            }
        });
        scrollPane7.setViewportView(RencanaTerapi);

        FormInput.add(scrollPane7);
        scrollPane7.setBounds(15, 390, 410, 73);
        ...
        scrollPane3.setBounds(15, 290, 410, 73);
        ...
        scrollPane4.setBounds(445, 290, 410, 73);
        ...
        jLabel35.setBounds(131, 480, 15, 23);
        ...
        jLabel36.setBounds(15, 480, 130, 23);

        jLabel37.setText(":");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(370, 510, 20, 23);
        ...
        NamaMenyetujui.setBounds(398, 510, 230, 23);

        jLabel38.setText("Hubungan :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(621, 510, 80, 23);
        ...
        scrollPane5.setBounds(445, 590, 410, 63);

        jLabel42.setText("Keadaan Umum :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(46, 570, 90, 23);
        ...
        KeadaanUmumSebelumTransfer.setBounds(140, 570, 130, 23);
        ...
        TDSebelumTransfer.setBounds(317, 570, 60, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(380, 570, 50, 23);

        jLabel17.setText("Nadi :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(46, 600, 90, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("x/menit");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(203, 600, 50, 23);
        ...
        NadiSebelumTransfer.setBounds(140, 600, 60, 23);

        jLabel26.setText("RR :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(283, 600, 30, 23);
        ...
        RRSebelumTransfer.setBounds(317, 600, 60, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(380, 600, 50, 23);

        jLabel24.setText("Suhu :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(46, 630, 90, 23);
        ...
        SuhuSebelumTransfer.setBounds(140, 630, 60, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("°C");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(203, 630, 30, 23);

        jLabel28.setText("TD :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(283, 570, 30, 23);
        ...
        KeadaanUmumSetelahTransfer.setBounds(140, 680, 130, 23);

        jLabel29.setText("TD :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(283, 680, 30, 23);
        ...
        TDSetelahTransfer.setBounds(317, 680, 60, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("mmHg");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(380, 680, 50, 23);

        jLabel46.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel46.setText("Keluhan Utama :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(445, 680, 170, 23);
        ...
        scrollPane6.setBounds(445, 700, 410, 63);

        jLabel47.setText("Nadi :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(46, 710, 90, 23);
        ...
        NadiSetelahTransfer.setBounds(140, 710, 60, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("x/menit");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(203, 710, 50, 23);

        jLabel49.setText("RR :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(283, 710, 30, 23);
        ...
        RRSetelahTransfer.setBounds(317, 710, 60, 23);

        jLabel50.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel50.setText("x/menit");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(380, 710, 50, 23);

        jLabel51.setText("Suhu :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(46, 740, 90, 23);
        ...
        SuhuSetelahTransfer.setBounds(140, 740, 60, 23);

        jLabel52.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel52.setText("°C");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(203, 740, 30, 23);
        ...
        jSeparator7.setBounds(0, 770, 880, 1);
        ...
        label14.setBounds(15, 830, 130, 23);
        ...
        KdPetugasMenyerahkan.setBounds(140, 850, 100, 23);
        ...
        NmPetugasMenyerahkan.setBounds(242, 850, 180, 23);
        ...
        BtnDokter.setBounds(424, 850, 28, 23);

        label15.setText("Menerima :");
        label15.setName("label15"); // NOI18N
        label15.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label15);
        label15.setBounds(469, 850, 70, 23);
        ...
        KdPetugasMenerima.setBounds(543, 850, 100, 23);
        ...
        NmPetugasMenerima.setBounds(645, 850, 180, 23);
        ...
        BtnMenerima.setBounds(827, 850, 28, 23);

        label16.setText("Menyerahkan :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label16);
        label16.setBounds(46, 850, 90, 23);
        ...
        scrollPane9.setViewportView(DiagnosaUtama);

        FormInput.add(scrollPane9);
        scrollPane9.setBounds(15, 140, 840, 50);

        label17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label17.setText("Pasien memerlukan pengkajian MPP :");
        label17.setName("label17"); // NOI18N
        label17.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label17);
        label17.setBounds(15, 775, 190, 23);

        MPP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        MPP.setName("MPP"); // NOI18N
        MPP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                MPPKeyPressed(evt);
            }
        });
        FormInput.add(MPP);
        MPP.setBounds(195, 775, 60, 23);

        label18.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label18.setText("Pasien memerlukan Discharge Planning :");
        label18.setName("label18"); // NOI18N
        label18.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label18);
        label18.setBounds(445, 775, 200, 23);

        DP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        FormInput.add(DP);
        DP.setBounds(640, 775, 60, 23);

        label19.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label19.setText("Alasan :");
        label19.setName("label19"); // NOI18N
        label19.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label19);
        label19.setBounds(15, 800, 50, 23);

        AlasanMPP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Bayi", "Lansia", "Riwayat Gangguan Mental", "Pasien Readmisi", "Masalah Sosial", "Lain-Lain" }));
        AlasanMPP.setName("AlasanMPP"); // NOI18N
        AlasanMPP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AlasanMPPKeyPressed(evt);
            }
        });
        FormInput.add(AlasanMPP);
        AlasanMPP.setBounds(60, 800, 195, 23);

        label20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label20.setText("Alasan :");
        label20.setName("label20"); // NOI18N
        label20.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label20);
        label20.setBounds(445, 800, 50, 23);

        AlasanDP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Bayi", "Usia > 60 thn", "Percobaan bunuh diri", "Trauma Multipel", "Pasien menggunakan alat medis", "DM", "Hipertensi", "Jantung", "Asma", "PPOK", "Epilepsy", "Skyzofrenia", "Stroke" }));
        AlasanDP.setName("AlasanDP"); // NOI18N
        AlasanDP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AlasanDPKeyPressed(evt);
            }
        });
        FormInput.add(AlasanDP);
        AlasanDP.setBounds(490, 800, 210, 23);
        ...
        jSeparator8.setBounds(0, 830, 880, 1);
    ...
    private void RencanaTerapiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RencanaTerapiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_RencanaTerapiKeyPressed
    ...
    private void MPPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MPPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_MPPKeyPressed

    private void DPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_DPKeyPressed

    private void AlasanMPPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AlasanMPPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_AlasanMPPKeyPressed

    private void AlasanDPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AlasanDPKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_AlasanDPKeyPressed
    ...
    */
    ...
    private widget.ComboBox AlasanDP;
    private widget.ComboBox AlasanMPP;
    ...
    private widget.TextArea RencanaTerapi;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "transfer_pasien_antar_ruang.nadi_sesudah_transfer,transfer_pasien_antar_ruang.rr_sesudah_transfer,transfer_pasien_antar_ruang.suhu_sesudah_transfer,"+
                        "transfer_pasien_antar_ruang.nip_menyerahkan,petugasmenyerahkan.nama as petugasmenyerahkan,transfer_pasien_antar_ruang.nip_menerima,"+
                        "petugasmenerima.nama as petugasmenerima,transfer_pasien_antar_ruang2.rencanaterapi,transfer_pasien_antar_ruang2.rencanatindakan, "+
                        "discharge_planning.mpp,discharge_planning.alasan_mpp,discharge_planning.discharge_planning,discharge_planning.alasan_dp "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join transfer_pasien_antar_ruang on reg_periksa.no_rawat=transfer_pasien_antar_ruang.no_rawat "+
                        "inner join petugas as petugasmenyerahkan on transfer_pasien_antar_ruang.nip_menyerahkan=petugasmenyerahkan.nip "+
                        "inner join petugas as petugasmenerima on transfer_pasien_antar_ruang.nip_menerima=petugasmenerima.nip "+
                        "left join transfer_pasien_antar_ruang2 on transfer_pasien_antar_ruang2.no_rawat=transfer_pasien_antar_ruang.no_rawat and transfer_pasien_antar_ruang2.tanggal_masuk=transfer_pasien_antar_ruang.tanggal_masuk "+
                        "left join discharge_planning on discharge_planning.no_rawat=transfer_pasien_antar_ruang.no_rawat and discharge_planning.tanggal_masuk=transfer_pasien_antar_ruang.tanggal_masuk where "+
                        "transfer_pasien_antar_ruang.tanggal_pindah between ? and ? order by transfer_pasien_antar_ruang.tanggal_pindah");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,"+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nip_menyerahkan"),rs.getString("petugasmenyerahkan"),rs.getString("nip_menerima"),rs.getString("petugasmenerima"),rs.getString("rencanaterapi"),rs.getString("rencanatindakan"),
                        rs.getString("mpp"),rs.getString("alasan_mpp"),rs.getString("discharge_planning"),rs.getString("alasan_dp")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            RencanaTerapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString()); 
            RencanaTindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());
            MPP.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());
            AlasanMPP.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
            DP.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());
            AlasanDP.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from transfer_pasien_antar_ruang where no_rawat=? and tanggal_masuk=?",2,new String[]{
            ...
            Sequel.queryu2tf("delete from transfer_pasien_antar_ruang2 where no_rawat=? and tanggal_masuk=?",2,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()});
            Sequel.queryu2tf("delete from discharge_planning where no_rawat=? and tanggal_masuk=?",2,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()});
    ...
    private void ganti() {
        if(Sequel.mengedittf("transfer_pasien_antar_ruang","no_rawat=? and tanggal_masuk=?","no_rawat=?,tanggal_masuk=?,tanggal_pindah=?,asal_ruang=?,ruang_selanjutnya=?,diagnosa_utama=?,"+
            ...
            Sequel.mengedittf("transfer_pasien_antar_ruang2","no_rawat=? and tanggal_masuk=?","no_rawat=?,tanggal_masuk=?,rencanaterapi=?,rencanatindakan=?",6,new String[]{
                TNoRw.getText(),Valid.SetTgl(TanggalMasuk.getSelectedItem()+"")+" "+TanggalMasuk.getSelectedItem().toString().substring(11,19),RencanaTerapi.getText(),
                RencanaTindakan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()
                });
            Sequel.mengedittf("discharge_planning","no_rawat=? and tanggal_masuk=?","no_rawat=?,tanggal_masuk=?,mpp=?,alasan_mpp=?,discharge_planning=?,alasan_dp=?",8,new String[]{
                TNoRw.getText(),Valid.SetTgl(TanggalMasuk.getSelectedItem()+"")+" "+TanggalMasuk.getSelectedItem().toString().substring(11,19),MPP.getSelectedItem().toString(),
                AlasanMPP.getSelectedItem().toString(),DP.getSelectedItem().toString(),AlasanDP.getSelectedItem().toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()
                });
                ...
                tbObat.setValueAt(RencanaTerapi.getText(),tbObat.getSelectedRow(),38);
                tbObat.setValueAt(RencanaTindakan.getText(),tbObat.getSelectedRow(),39);
                tbObat.setValueAt(MPP.getSelectedItem().toString(),tbObat.getSelectedRow(),40);
                tbObat.setValueAt(AlasanMPP.getSelectedItem().toString(),tbObat.getSelectedRow(),41);
                tbObat.setValueAt(DP.getSelectedItem().toString(),tbObat.getSelectedRow(),42);
                tbObat.setValueAt(AlasanDP.getSelectedItem().toString(),tbObat.getSelectedRow(),43);
                emptTeks();
                TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("transfer_pasien_antar_ruang","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat & Tanggal Masuk",32,new String[]{
                ...
                Sequel.menyimpantf("transfer_pasien_antar_ruang2","?,?,?,?","No.Rawat",4,new String[]{
                TNoRw.getText(),Valid.SetTgl(TanggalMasuk.getSelectedItem()+"")+" "+TanggalMasuk.getSelectedItem().toString().substring(11,19),
                RencanaTerapi.getText(),RencanaTindakan.getText()});
                Sequel.menyimpantf("discharge_planning","?,?,?,?,?,?","No.Rawat",6,new String[]{
                TNoRw.getText(),Valid.SetTgl(TanggalMasuk.getSelectedItem()+"")+" "+TanggalMasuk.getSelectedItem().toString().substring(11,19),
                MPP.getSelectedItem().toString(),AlasanMPP.getSelectedItem().toString(),DP.getSelectedItem().toString(),AlasanDP.getSelectedItem().toString()});
                emptTeks();
        }
    }
