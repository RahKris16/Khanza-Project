...
public final class RMPenilaianLanjutanRisikoJatuhAnak extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 502));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-04-2024" }));
        ...
        jLabel31.setBounds(820, 10, 80, 23);
        ...
        scrollPane2.setBounds(840, 30, 755, 300);
    ...
    private void isTotalResikoJatuh(){
        try {
            ...
            if(Integer.parseInt(NilaiResikoTotal.getText())>=12){
                TingkatResiko.setText("Tingkat Resiko : Risiko Tinggi (>=12), Tindakan : Intervensi risiko jatuh tinggi(pasang gelang warna kuning)");
                Saran.setText("1. Orientasikan pasien pada lingkungan kamar/bangsal\n"
                        + "2. Edukasi pasien dan keluarga tentang strategi pencegahan resiko\n"
                        ...
                        + "6. Singkirkan barang yang berbahaya terutama pada malam hari (kursi tambahan dan lain-lain)\n"
                        + "7. Minta persetujuan pasien agar lampu malam tetap menyala karena lingkungan masih asing\n"
                        ...
                        + "11. Tempatkan meja pasien sesuai dengan tinggi badan\n"
                        + "12. Tempatkan pasien sesuai dengan tinggi badannya\n"
                        + "13. Pastikan penanda lantai basah akibat muntahan atau percikan air\n"
                        + "14. Pasang pin kuning pada pasien/penanda risiko jatuh di luar kamar/di brankar/di atas tempat tidur\n"
                        + "15. Minta agar keluarga pasien segera memencet bel bila perlu bantuan atau segera menghubungi petugas\n"
                        + "16. Awasi atau bantu sebagian ADL pasien\n"
                        + "17. Cepat menganggapi bel atau keluhan pasien\n"
                        + "18. Review kembali obat-obatan yang beresiko\n"
                        + "19. Beritahu pasien agar mobilisasi secara bertahap : duduk perlahan lahan sebelum berdiri\n");
