...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisIGD(java.awt.Frame parent, boolean modal) {
        ...
        MOI.setDocument(new batasInput((int)3000).getKata(TCari));
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgKamarInap")){
                    if(diagnosa1.getTable().getSelectedRow()!= -1){                   
                        Diagnosis.setText(diagnosa1.getTable().getValueAt(diagnosa1.getTable().getSelectedRow(),1).toString());                                        
                    }  
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1475));
        ...
        jLabel12.setBounds(760, 330, 30, 23);
        ...
        jLabel15.setBounds(640, 330, 30, 23);
        ...
        jLabel17.setBounds(280, 360, 40, 23);
        ...
        jLabel20.setBounds(705, 360, 30, 23);
        ...
        jLabel25.setBounds(535, 360, 50, 23);
        ...
        jLabel28.setBounds(490, 330, 70, 23);
        ...
        Kesadaran.setBounds(345, 330, 130, 23);

        jLabel41.setText("Keadaan Umum :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 330, 127, 23);

        jLabel29.setText("SpO2 :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(750, 360, 40, 23);
        ...
        jLabel45.setBounds(0, 480, 127, 23);
        ...
        jLabel46.setBounds(270, 390, 95, 23);
        ...
        jLabel49.setBounds(270, 420, 95, 23);
        ...
        jLabel50.setBounds(270, 450, 95, 23);
        ...
        jLabel51.setBounds(270, 480, 95, 23);
        ...
        jSeparator13.setBounds(0, 510, 880, 1);
        ...
        PanelWall.setBounds(50, 530, 809, 300);
        ...
        scrollPane8.setBounds(50, 850, 810, 83);

        jLabel79.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel79.setText("Keterangan :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(50, 830, 100, 23);
        ...
        jSeparator14.setBounds(0, 940, 880, 1);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("III. STATUS LOKALIS");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(10, 510, 180, 23);
        ...
        scrollPane9.setBounds(50, 980, 260, 63);
        ...
        jSeparator15.setBounds(0, 1050, 880, 1);

        jLabel101.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel101.setText("IV. PEMERIKSAAN PENUNJANG");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(10, 940, 190, 23);
        ...
        scrollPane12.setBounds(50, 1070, 810, 43);
        ...
        jSeparator16.setBounds(0, 1120, 880, 1);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("V. DIAGNOSIS/ASESMEN");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(10, 1050, 190, 23);
        ...
        scrollPane13.setBounds(50, 1140, 810, 303);

        jLabel103.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel103.setText("VI. TATALAKSANA");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(10, 1120, 190, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-05-2024 22:01:58" }));
        ...
        jLabel42.setBounds(0, 420, 127, 23);
        ...
        jLabel80.setBounds(50, 960, 150, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Radiologi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(320, 960, 150, 23);
        ...
        scrollPane10.setBounds(320, 980, 260, 63);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText("Laborat :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(600, 960, 150, 23);
        ...
        scrollPane11.setBounds(600, 980, 260, 63);
        ...
        btnDiagnosa1.setBounds(870, 1080, 28, 23);

        jLabel14.setText("Mechanism of Injury :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 240, 180, 23);

        scrollPane6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane6.setName("scrollPane6"); // NOI18N

        MOI.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        MOI.setColumns(20);
        MOI.setRows(5);
        MOI.setName("MOI"); // NOI18N
        MOI.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                MOIKeyPressed(evt);
            }
        });
        scrollPane6.setViewportView(MOI);

        FormInput.add(scrollPane6);
        scrollPane6.setBounds(184, 240, 670, 60);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",36,new String[]{
                ...
                if(MOI.getText().trim().equals("")){
                    Sequel.menyimpan("moi","?,?,?","No.Rawat",3,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),"-"});
                    emptTeks();
                }else{
                    if(Sequel.menyimpantf("moi","?,?,?","No.Rawat",3,new String[]{
                        TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),MOI.getText()
                    })==true){
                            emptTeks();
                    }
    ...
    private void btnDiagnosa1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDiagnosa1ActionPerformed
        ...
        diagnosa1.setAlwaysOnTop(false);
    ...
    private void MOIKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MOIKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_MOIKeyPressed
    ...
    */
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "penilaian_medis_igd.keadaan,penilaian_medis_igd.gcs,penilaian_medis_igd.kesadaran,penilaian_medis_igd.td,penilaian_medis_igd.nadi,penilaian_medis_igd.rr,penilaian_medis_igd.suhu,penilaian_medis_igd.spo,penilaian_medis_igd.bb,penilaian_medis_igd.tb,"+
                        "penilaian_medis_igd.kepala,penilaian_medis_igd.mata,penilaian_medis_igd.gigi,penilaian_medis_igd.leher,penilaian_medis_igd.thoraks,penilaian_medis_igd.abdomen,penilaian_medis_igd.ekstremitas,penilaian_medis_igd.genital,penilaian_medis_igd.ket_fisik,"+
                        "penilaian_medis_igd.ket_lokalis,penilaian_medis_igd.ekg,penilaian_medis_igd.rad,penilaian_medis_igd.lab,penilaian_medis_igd.diagnosis,penilaian_medis_igd.tata,dokter.nm_dokter,moi.moi "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_igd on reg_periksa.no_rawat=penilaian_medis_igd.no_rawat "+
                        "inner join dokter on penilaian_medis_igd.kd_dokter=dokter.kd_dokter "+
                        "LEFT JOIN moi on moi.no_rawat=reg_periksa.no_rawat where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("ekstremitas"),rs.getString("ket_fisik"),rs.getString("ket_lokalis"),rs.getString("ekg"),rs.getString("rad"),rs.getString("lab"),rs.getString("diagnosis"),rs.getString("tata"),rs.getString("moi")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            MOI.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_igd where no_rawat=?",1,new String[]{
            ...
            if(Sequel.queryu2tf("delete from moi where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_igd","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpk=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,mata=?,gigi=?,leher=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,ket_fisik=?,ket_lokalis=?,ekg=?,rad=?,lab=?,diagnosis=?,tata=?",37,new String[]{
            ...
            if(Sequel.mengedittf("moi","no_rawat=?","no_rawat=?,tanggal=?,moi=?",4,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),MOI.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    tampil();
                    emptTeks();
                    TabRawat.setSelectedIndex(1);
