...
public class IPSRSPermintaan extends javax.swing.JDialog {
        ...
        caribangsal.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(caribangsal.getTable().getSelectedRow()!= -1){   
                    if(i==1){
                        Ruangan.setText(caribangsal.getTable().getValueAt(caribangsal.getTable().getSelectedRow(),1).toString());
    ...
    private void initComponents() {
        ...
        Ruangan.setBounds(95, 40, 240, 23);
        ...
        btnSuplier1.setBounds(340, 40, 28, 23);
