...
public class IPSRSCariPengeluaran extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,ps2,ps3,psdetailpengeluaran;
    ...
    private void initComponents() {
        ...
        ppCetak.setText("Cetak Stok Keluar");
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                    "SELECT ipsrsbarang.nama_brng,kodesatuan.satuan,ipsrsdetailpengeluaran.jumlah,ipsrsdetailpengeluaran.harga,ipsrsdetailpengeluaran.total "
                    + "FROM ipsrsdetailpengeluaran INNER JOIN kodesatuan ON ipsrsdetailpengeluaran.kode_sat=kodesatuan.kode_sat INNER JOIN ipsrsbarang ON ipsrsdetailpengeluaran.kode_brng=ipsrsbarang.kode_brng "
                    + "WHERE no_keluar=?");
                try {
                    ...
                    while(rs.next()){
                        ...
                        ""+i,rs.getString("nama_brng"),rs.getString("satuan"),rs.getString("jumlah"),rs.getString("harga"),rs.getString("total"),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                        });
                        i++;
                    }
                } catch (Exception e) {
    ...
    */
    ...
    private void getData() {
        if(tbDokter.getSelectedRow()!= -1){
            NoKeluar.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString());
        }
    }
