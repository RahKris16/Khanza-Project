...
public class IPSRSCariSuratPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppDipesan = new javax.swing.JMenuItem();
        ...
        ppDipesan.setBackground(new java.awt.Color(255, 255, 254));
        ppDipesan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppDipesan.setForeground(new java.awt.Color(50, 50, 50));
        ppDipesan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppDipesan.setText("Dipesan");
        ppDipesan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppDipesan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppDipesan.setName("ppDipesan"); // NOI18N
        ppDipesan.setPreferredSize(new java.awt.Dimension(200, 25));
        ppDipesan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppDipesanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppDipesan);
        ...
        Status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Proses Pesan", "Dipesan", "Sudah Datang" }));
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
  if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
    ...
    private void ppDipesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDipesanActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            Valid.textKosong(TCari,"pilihan data");
        }else{
            Sequel.queryu("update surat_pemesanan_non_medis set status='Dipesan' where no_pemesanan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
            tampil();
        }
    }//GEN-LAST:event_ppDipesanActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem ppDipesan;
       ...
       Valid.tabelKosong(tabMode);
        try{   
            ps=koneksi.prepareStatement(
                    ...
                    " and surat_pemesanan_non_medis.kode_suplier=ipsrssuplier.kode_suplier "+
                    " and surat_pemesanan_non_medis.nip=pegawai.nik and ipsrsbarang.jenis=ipsrsjenisbarang.kd_jenis"+
                    " where surat_pemesanan_non_medis.tanggal between ? and ? and surat_pemesanan_non_medis.no_pemesanan like ? and ipsrssuplier.nama_suplier like ? and pegawai.nama like ? and ipsrsjenisbarang.nm_jenis like ? and ipsrsbarang.nama_brng like ? and surat_pemesanan_non_medis.no_pemesanan like ? and surat_pemesanan_non_medis.status like ? and "+
                    " (surat_pemesanan_non_medis.kode_suplier like ? or ipsrssuplier.nama_suplier like ? or surat_pemesanan_non_medis.nip like ? or pegawai.nama like ? or detail_surat_pemesanan_non_medis.kode_brng like ? or ipsrsbarang.nama_brng like ? or detail_surat_pemesanan_non_medis.kode_sat like ? or "+
                    " ipsrsjenisbarang.nm_jenis like ? or surat_pemesanan_non_medis.status like ?) "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{"Tgl.Pemesanan",": "+rs.getString("tanggal"),"","","","","Total",":",Valid.SetAngka(rs.getDouble("total"))});
