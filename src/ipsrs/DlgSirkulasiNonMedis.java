...
public class DlgSirkulasiNonMedis extends javax.swing.JDialog {
    ...
    private double ttltotalbeli=0,totalbeli=0,stok=0,aset=0,ttlaset=0,jumlahbeli=0,jumlahutd=0,totalutd=0,ttltotalutd=0,ttltotalpesan=0,totalpesan=0,jumlahpesan=0,
                    jumlahkeluar=0,totalkeluar=0,ttltotalkeluar=0,jumlahhibah=0,totalhibah=0,ttltotalhibah=0,keluar=0,selisih=0;
    ...
    public DlgSirkulasiNonMedis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "Kode Barang","Nama Barang","Satuan","Stok","Keluar","Selisih","Stok(Rp)","Pengadaan","Pengadaan(Rp)",
    ...
    private void initComponents() {
        ...
        ChkJln1.setPreferredSize(new java.awt.Dimension(40, 17));
    ...
    private void prosesCari() {
       ...
       try{   
            ps=koneksi.prepareStatement("select ipsrsbarang.kode_brng,ipsrsbarang.nama_brng, "+
                        ...
                        "ipsrsbarang.nama_brng like ? and kodesatuan.satuan like ? and ipsrsbarang.status<>'0' "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    keluar=jumlahkeluar+jumlahhibah;
                    selisih=stok-keluar;
                    if(ChkJln1.isSelected()==false){
                        if((stok>-1)&&(aset>-1)){
                        tabMode.addRow(new Object[]{rs.getString(1),rs.getString(2),
                           rs.getString(3),Valid.SetAngka(stok),Valid.SetAngka(keluar),
                           Valid.SetAngka(selisih),Valid.SetAngka(aset),
