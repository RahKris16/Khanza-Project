...
public class DlgIndustriFarmasi1_Interna5 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgIndustriFarmasi1_Interna5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Valid.hapusTable(tabMode,Kd,"obatint5","id");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"obatint5","id","?","id=?,kode_brng=?,jumlah=?,aturan=?",5,new String[]{
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Sequel.menyimpan("obatint5","?,?,?,?","Kode Obat",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgIndustriFarmasi1_Interna5 dialog = new DlgIndustriFarmasi1_Interna5(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select obatint5.id,obatint5.kode_brng,databarang.nama_brng,obatint5.jumlah,obatint5.aturan "+
                    "  from obatint5 inner join databarang on databarang.kode_brng=obatint5.kode_brng "+
                    " where obatint5.kode_brng like ? or "+
                    " databarang.nama_brng like ? order by obatint5.id");
