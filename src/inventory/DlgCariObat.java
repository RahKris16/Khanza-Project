...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private String signa1="1",signa2="1",nokunjungan="",kdObatSK="",requestJson="",URL="",otorisasi,sql="",aktifpcare="no",no_batchcari="", tgl_kadaluarsacari="", no_fakturcari="", aktifkanbatch="no",kodedokter="",namadokter="",noresep="",bangsal="",bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),tampilkan_ppnobat_ralan="",
                   Suspen_Piutang_Obat_Ralan="",Obat_Ralan="",HPP_Obat_Rawat_Jalan="",Persediaan_Obat_Rawat_Jalan="",hppfarmasi="",VALIDASIULANGBERIOBAT="",DEPOAKTIFOBAT="",utc="",kategoriobat="";
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-12-2025" }));
...
//            JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih kategori obet yang mau diberikan terlebih dahulu ...!!!");
        }else{ 
...
//                        Sequel.menyimpan("kategori_obat","no_resep='"+noresep+"'","tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"',jam='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"'","kategori='"+kategoriobat+"'");
                    }
    ...
    */
    ...
    public void isCek(){   
        if(!DEPOAKTIFOBAT.equals("")){
            ...
            if(!bangsal.equals("")) {
                // ✅ Hasil dari set_depo_ralan langsung dipakai
                kdgudang.setText(bangsal);
            } else {
                // Fallback: cek dari resep_obat_tambahan
                String statusTambahan = Sequel.cariIsi(
                    "select resep_obat_tambahan.status from resep_obat_tambahan where resep_obat_tambahan.no_resep=?",
                    noresep
                );
                if(!statusTambahan.equals("")){
                    if(statusTambahan.equals("DEPO")){
                        kdgudang.setText("DPOK");
                    } else if(statusTambahan.equals("IFRS")){
                        kdgudang.setText("BFAR");
                    }
                }else{
    ...
    public void setNoresep(String no) {
        this.noresep = no;
    }
