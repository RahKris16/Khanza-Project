 ...
 * @author dosen
 */
public final class DlgPeresepanDokterBPJS extends javax.swing.JDialog {
    ...
    private String noracik="",aktifkanbatch="no",STOKKOSONGRESEP="no",qrystokkosong="",tampilkan_ppnobat_ralan="",status="",bangsal="",resep="",DEPOAKTIFOBAT="",
            kamar="",norawatibu="",kelas,bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),RESEPRAJALKEPLAN="no",lokasi="";
    /** Creates new form DlgPenyakit
     * @param parent
     * @param modal */
    public DlgPeresepanDokterBPJS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnProtokol.setMnemonic('3');
        BtnProtokol.setToolTipText("Alt+3");
        BtnProtokol.setName("BtnProtokol"); // NOI18N
        BtnProtokol.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnProtokol.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnProtokolActionPerformed(evt);
            }
        });
        panelisi3.add(BtnProtokol);
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-06-2025" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPeresepanDokterBPJS dialog = new DlgPeresepanDokterBPJS(new javax.swing.JFrame(), true);
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        ...
                        " inner join databarang_tambahan dt on dt.kode_brng =databarang.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and dt.status ='BPJS' and gudangbarang.kd_bangsal=? and "+
