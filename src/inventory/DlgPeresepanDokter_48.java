 ...
 * @author dosen
 */
public final class DlgPeresepanDokter_48 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPeresepanDokter_48(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-11-2023" }));
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    public void tampilobat() {    
        ...
        try {
            if(kenaikan>0){
                psresepasuransi=koneksi.prepareStatement("select obatptreranap.jumlah, obatptreranap.kode_brng,obatptreranap.aturan, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                    " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok "+
                    " from obatptreranap inner join databarang inner join jenis inner join industrifarmasi inner join gudangbarang "+
                    " on obatptreranap.kode_brng=databarang.kode_brng and databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                ...
                psresep=koneksi.prepareStatement(
                   "select obatptreranap.jumlah, obatptreranap.kode_brng,obatptreranap.aturan, databarang.nama_brng,jenis.nama, databarang.kode_sat,"+
