...
public class DlgIndustriFarmasi1_15 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgIndustriFarmasi1_15(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Paket Obat Soft Tissue Tumor Ranap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Valid.hapusTable(tabMode,Kd,"obatsttranap","id");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"obatsttranap","id","?","id=?,kode_brng=?,jumlah=?,aturan=?",5,new String[]{
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            Sequel.menyimpan("obatsttranap","?,?,?,?","Kode Obat",4,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgIndustriFarmasi1_15 dialog = new DlgIndustriFarmasi1_15(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select obatsttranap.id,obatsttranap.kode_brng,databarang.nama_brng,obatsttranap.jumlah,obatsttranap.aturan "+
                    "  from obatsttranap inner join databarang on databarang.kode_brng=obatsttranap.kode_brng "+
                    " where obatsttranap.kode_brng like ? or "+
                    " databarang.nama_brng like ? order by obatsttranap.id");
