...
public class DlgCariSuratPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppPesan = new javax.swing.JMenuItem();
        ...
        ppPesan.setBackground(new java.awt.Color(255, 255, 254));
        ppPesan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppPesan.setForeground(new java.awt.Color(50, 50, 50));
        ppPesan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppPesan.setText("Dipesan");
        ppPesan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppPesan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppPesan.setName("ppPesan"); // NOI18N
        ppPesan.setPreferredSize(new java.awt.Dimension(200, 25));
        ppPesan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppPesanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppPesan);
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
  if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
    ...
    private void ppPesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppPesanActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            Valid.textKosong(TCari,"pilihan data");
        }else{
            Sequel.queryu("update surat_pemesanan_medis set status='Dipesan' where no_pemesanan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
            tampil();
        }
    }//GEN-LAST:event_ppPesanActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem ppPesan;
