 ...
 * @author dosen
 */
public final class DlgPeresepanDokter_Tonsilektomy3 extends javax.swing.JDialog {
    ...
    private String[] no,kodebarang,namabarang,kodesatuan,kandungan,letakbarang,namajenis,aturan,industri,aturanp,aturans,aturanm;
     ...
     * @param parent
     * @param modal */
    public DlgPeresepanDokter_Tonsilektomy3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabModeResep=new DefaultTableModel(null,new Object[]{
                ...
                "Harga(Rp)","Jenis Obat","Aturan Pakai","I.F.","H.Beli","Stok","Kandungan"
            }){
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-12-2023" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPeresepanDokter_6 dialog = new DlgPeresepanDokter_6(new javax.swing.JFrame(), true);
    ...
    public void tampilobat() {        
        ...
        for(i=0;i<z;i++){
            tabModeResep.addRow(new Object[] {
                pilih[i],jumlah[i],kodebarang[i],namabarang[i],kodesatuan[i],letakbarang[i],harga[i],namajenis[i],aturan[i],industri[i],beli[i],stok[i],kandungan[i]
            });
        }
        
        try {
            if(kenaikan>0){
                psresepasuransi=koneksi.prepareStatement("select obattonranap.jumlah, obattonranap.kode_brng,obattonranap.aturan, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                    " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok "+
                    " from obattonranap inner join databarang inner join jenis inner join industrifarmasi inner join gudangbarang "+
                    " on obattonranap.kode_brng=databarang.kode_brng and databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                ...
                try{
                    ...
                    while(rsobat.next()){
                        tabModeResep.addRow(new Object[] {false,rsobat.getString("jumlah"),rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                           rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                           rsobat.getString("nama"),rsobat.getString("aturan"),rsobat.getString("nama_industri"),
                           rsobat.getDouble("h_beli"),rsobat.getDouble("stok"),rsobat.getString("letak_barang")
                        });          
                    }  
                }catch(Exception e){
                ...
                psresep=koneksi.prepareStatement(
                   "select obattonranap.jumlah, obattonranap.kode_brng,obattonranap.aturan, databarang.nama_brng,jenis.nama, databarang.kode_sat,"+
                                ...
                                if(rs2.getDouble("jml")>rs2.getDouble("stok")){
                                    ...
                                    if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                        tabModeDetailResepRacikan.addRow(new Object[] {
                                            ...
                                            rs2.getDouble("h_beli"),rs2.getString("nama"),rs2.getDouble("stok"),
                                            rs2.getDouble("kapasitas"),rs2.getDouble("p1"),"/",rs2.getDouble("p2"),
                                            rs2.getString("kandungan"),0,rs2.getString("nama_industri"),rsobat.getString("letak_barang")
                                        }); 
                                    }else if(Jeniskelas.getSelectedItem().equals("Rawat Jalan")){
                                        tabModeDetailResepRacikan.addRow(new Object[] {
                                            rsobat.getString("no_racik"),rs2.getString("kode_brng"),rs2.getString("nama_brng"),
                                    ...
                                    if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                        tabModeDetailResepRacikan.addRow(new Object[] {
                                            ...
                                            rs2.getDouble("h_beli"),rs2.getString("nama"),rs2.getDouble("stok"),
                                            rs2.getDouble("kapasitas"),rs2.getDouble("p1"),"/",rs2.getDouble("p2"),
                                            rs2.getString("kandungan"),rs2.getDouble("jml"),rs2.getString("nama_industri"),rsobat.getString("letak_barang")
                                        }); 
                                    }else if(Jeniskelas.getSelectedItem().equals("Rawat Jalan")){
                                        tabModeDetailResepRacikan.addRow(new Object[] {
                                            rsobat.getString("no_racik"),rs2.getString("kode_brng"),rs2.getString("nama_brng"),
