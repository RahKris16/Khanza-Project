...
public class DlgPermintaanResepPulang_1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPermintaanResepPulang_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-06-2025" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPermintaanResepPulang_1 dialog = new DlgPermintaanResepPulang_1(new javax.swing.JFrame(), true);
