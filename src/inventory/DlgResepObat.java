...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private String now=dateFormat.format(date),lembarobat="",status="",rincianobat="",finger="",norawat="";
...
//        }  
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-01-2024 09:19:44" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-01-2024 09:19:47" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptResep.jasper","report","::[ Daftar Pemberian Obat Resep ]::","select * from temporary_resep order by temporary_resep.no",param);
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                try {
                    ...
                    while(rs.next()){
                        Sequel.menyimpan("temporary_resep","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            ""+i,rs.getString("nama_brng"),rs.getString("aturan"),rs.getString("jml"),rs.getString("satuan"),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                        });
                        i++;
                    }
                } catch (Exception e) {
                ...
                try {
                    ...
                    while(rsracikan.next()){
                        ...
                        Sequel.menyimpan("temporary_resep","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            ""+i,rsracikan.getString("nama_racik")+" ("+rincianobat+")",rsracikan.getString("aturan_pakai"),rsracikan.getString("jml_dr"),rsracikan.getString("nm_racik"),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                        });
                        i++;
                    }
                } catch (Exception e) {
            ...
            Valid.MyReportqry("rptLembarObat2.jasper","report","::[ Lembar Pemberian Obat ]::","select * from temporary_resep order by temporary_resep.no",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {
                ...
                try {
                    ...
                    while(rs.next()){
                        Sequel.menyimpan("temporary_resep","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            ""+i,rs.getString("nama_brng"),Sequel.cariIsi("select aturan from aturan_pakai where tgl_perawatan='"+rs.getString("tgl_perawatan")+"' and jam='"+rs.getString("jam")+"' and no_rawat='"+rs.getString("no_rawat")+"' and kode_brng='"+rs.getString("kode_brng")+"'"),rs.getString("jml"),Valid.SetAngka(rs.getDouble("total")),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                        });
                        i++;
                    }
                } catch (Exception e) {
            ...
            Valid.MyReportqry("rptLabelDaftarObat.jasper","report","::[ Label Daftar Obat ]::","select * from temporary_resep order by temporary_resep.no",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void ppLembarObat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObat2ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            try {
                i=0;
                ps=koneksi.prepareStatement(
                    "SELECT databarang.nama_brng,kodesatuan.satuan,aturan_pakai.aturan,detail_pemberian_obat.jml FROM resep_obat "
                    ...
                    + "LEFT JOIN aturan_pakai ON aturan_pakai.no_rawat=resep_obat.no_rawat AND aturan_pakai.kode_brng=detail_pemberian_obat.kode_brng "
                    + "AND resep_obat.tgl_perawatan=aturan_pakai.tgl_perawatan AND resep_obat.jam=aturan_pakai.jam  WHERE no_resep=? "
            ...
            Valid.MyReportqry("rptLembarObat3.jasper","report","::[ Lembar Pemberian Obat ]::","select * from temporary_resep order by temporary_resep.no",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
