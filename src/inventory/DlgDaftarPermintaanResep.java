...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    private String bangsal="",aktifkanparsial="no",kamar="",alarm="",
            ...
            finger="",kddokter="",sip="",DEPOAKTIFOBAT="";
    private DlgCariDokter dokter=new DlgCariDokter(null,false);
    private DlgCariPoli poli=new DlgCariPoli(null,false);
    private DlgCariBangsal ruang=new DlgCariBangsal(null,false);
    private int jmlparsial=0,nilai_detik,resepbaru=0,i=0,pageRalan=1,pageSizeRalan=50,totalRowsRalan=0,
            totalPagesRalan=1;
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Resep","Tgl.Peresepan","Jam Peresepan","Asal Barang","No.Rawat","No.RM","Pasien","Dokter Peresep",
        ...
        tabMode7=new DefaultTableModel(null,new Object[]{
                "No.Permintaan","Tanggal","Jam","Asal Barang","No.Rawat","No.RM","Pasien","Dokter Yang Meminta",
                "Status","Kode Dokter","Ruang/Kamar","Kode Bangsal","Jenis Bayar"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        BtnPenyerahan1 = new widget.Button();
        ...
        Popup2.setPreferredSize(new java.awt.Dimension(227, 33));
        ...
        ppLembarObat2.setText("Lembar Pemberian Obat");
        ...
        ppLembarObat3.setText("Lembar Pemberian Obat");
        ...
        cmbStatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Belum Terlayani", "Sudah Terlayani", "Semua" }));
        ...
        BtnPenyerahan.setText("Penyerahan 1");
        BtnPenyerahan.setToolTipText("Alt+H");
        BtnPenyerahan.setName("BtnPenyerahan"); // NOI18N
        BtnPenyerahan.setPreferredSize(new java.awt.Dimension(150, 30));
        ...
        BtnPenyerahan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Agenda-1-16x16.png"))); // NOI18N
        BtnPenyerahan1.setMnemonic('H');
        BtnPenyerahan1.setText("Penyerahan 2");
        BtnPenyerahan1.setToolTipText("Alt+H");
        BtnPenyerahan1.setName("BtnPenyerahan1"); // NOI18N
        BtnPenyerahan1.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnPenyerahan1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenyerahan1ActionPerformed(evt);
            }
        });
        BtnPenyerahan1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnPenyerahan1KeyPressed(evt);
            }
        });
        panelisi1.add(BtnPenyerahan1);
        ...
        scrollPane1.setComponentPopupMenu(Popup2);
        ...
        scrollPane3.setComponentPopupMenu(Popup3);
        ...
        tbResepRanap.setComponentPopupMenu(Popup3);
        ...
        scrollPane7.setComponentPopupMenu(Popup4);
        ...
        tbPermintaanResepPulang.setComponentPopupMenu(Popup4);
            ...
            if(TabRawatJalan.getSelectedIndex()==0){
                if(tabMode.getRowCount()==0){            
                   ...
                   // BtnBatal.requestFocus();
                    ...
                    Sequel.queryu("delete from temporary_resep2");
                    ...
                    Valid.MyReportqry("rptDaftarPermintaanResep.jasper","report","::[ Laporan Daftar Permintaan Resep ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                ...
                if(tabMode2.getRowCount()==0){
                    ...
                    Map<String, Object> param = new HashMap<>();  
                        ...
                        param.put("emailrs",akses.getemailrs());   
                        param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                    Valid.MyReportqry("rptDaftarResep.jasper","report","::[ Daftar Resep Obat ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }
            }
        }else if(TabPilihRawat.getSelectedIndex()==1){
            if(TabRawatInap.getSelectedIndex()==0){
                if(tabMode3.getRowCount()==0){            
                   ...
                   // BtnBatal.requestFocus();
                    ...
                    param.put("emailrs",akses.getemailrs());   
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                    Valid.MyReportqry("rptDaftarPermintaanResep2.jasper","report","::[ Laporan Daftar Permintaan Resep ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }   
                ...
                if(tabMode4.getRowCount()==0){
                    ...
                    param.put("emailrs",akses.getemailrs());   
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                    Valid.MyReportqry("rptDaftarResep2.jasper","report","::[ Daftar Resep Obat ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }
                ...
                if(tabMode5.getRowCount()==0){            
                   ...
                   // BtnBatal.requestFocus();
                    ...
                    param.put("emailrs",akses.getemailrs());   
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                    Valid.MyReportqry("rptDaftarPermintaanResep3.jasper","report","::[ Laporan Daftar Permintaan Stok Pasien ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }   
                ...
                if(tabMode6.getRowCount()==0){
                    ...
                    for(int i=0;i<tabMode6.getRowCount();i++){  
                        Sequel.menyimpan("temporary_resep2","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            ...
                            tabMode6.getValueAt(i,3).toString(),tabMode6.getValueAt(i,4).toString(),tabMode6.getValueAt(i,5).toString().replaceAll("✓","v").replaceAll("✕","x"),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""
                        });
                    }
                    ...
                    param.put("emailrs",akses.getemailrs());   
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                    Valid.MyReportqry("rptDaftarResep3.jasper","report","::[ Daftar Permintaan Stok Obat Pasien ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }
                ...
                if(tabMode7.getRowCount()==0){            
                   ...
                   // BtnBatal.requestFocus();
                    ...
                    param.put("emailrs",akses.getemailrs());   
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                    Valid.MyReportqry("rptDaftarPermintaanResepPulang.jasper","report","::[ Laporan Daftar Permintaan Resep Pulang ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }   
                ...
                if(tabMode8.getRowCount()==0){
                    ...
                    param.put("emailrs",akses.getemailrs());   
                    param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                    Valid.MyReportqry("rptDaftarResepPulang.jasper","report","::[ Daftar Permintaan Resep Pulang ]::","select * from temporary_resep2 order by temporary_resep2.no",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }
            }
        }        
                ...
                if(akses.getpermintaan_resep_pulang()==true){
                    if(tabMode7.getRowCount()==0){
                        ...
                        if(Status.equals("Sudah Terlayani")){
                            ...
                            Sequel.meghapus("detail_permintaan_resep_pulang","no_permintaan",NoResep); 
                            TeksKosong();
                            tampil7();
                        }                    
                    }
            ...
            if(TabRawatJalan.getSelectedIndex()==0){
               if(akses.getberi_obat()==true){
                    if(tabMode.getRowCount()==0){
                      ...
                      JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilih data resep dokter yang mau diserahkan..!!");
                   }else if(Sequel.cariInteger("select count(no_resep) from resep_obat where tgl_perawatan='0000-00-00' and no_resep=? ",NoResep)>0){
                        JOptionPane.showMessageDialog(null,"Maaf, Resep belum tervalidasi..!!");
                   }else{
                        DlgCariObat4 dlgobt=new DlgCariObat4(null,false);
                        dlgobt.setNoRm4(NoRM,NoRawat,Pasien,NoResep);
                        dlgobt.setSize(650,150);
                        dlgobt.setLocationRelativeTo(internalFrame1);
                        dlgobt.setVisible(true);
                 }
                }else{
                   JOptionPane.showMessageDialog(null,"Maaf, Anda tidak punya hak akses untuk menyerahkan...!!!!");
                    TCari.requestFocus();
                }
            }
        }
    ...
    private void ppLembarObat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObat1ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbResepRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Sequel.queryu("delete from temporary_resep2 where temp37='"+akses.getalamatip()+"'");
                try {
                ...
                param.put("umur",Sequel.cariIsi("select concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur from reg_periksa where reg_periksa.no_rawat=?",NoRawat));
                param.put("alamat",Sequel.cariIsi("select pasien.alamat from pasien where pasien.no_rkm_medis=?",Sequel.cariIsi("select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat=?",NoRawat)));
                param.put("bb",Sequel.cariIsi("select concat(pemeriksaan_ralan.berat,' kg') as berat from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=?",NoRawat));
                param.put("alergi",Sequel.cariIsi("select alergi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=?",NoRawat));
                param.put("tb",Sequel.cariIsi("select concat(pemeriksaan_ralan.tinggi,' cm') as tinggi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=?",NoRawat));
                param.put("bayar",Sequel.cariIsi("SELECT penjab.png_jawab FROM resep_obat INNER JOIN reg_periksa ON resep_obat.no_rawat=reg_periksa.no_rawat INNER JOIN penjab ON reg_periksa.kd_pj=penjab.kd_pj WHERE resep_obat.no_resep=?",NoResep));
                param.put("propinsirs",akses.getpropinsirs());
                param.put("tanggal",Sequel.cariIsi("select DATE_FORMAT(resep_obat.tgl_peresepan,'%d-%m-%Y') as tanggal from resep_obat where resep_obat.no_resep=?",NoResep));
                ...
                kddokter=Sequel.cariIsi("SELECT kd_dokter FROM dokter WHERE nm_dokter=?",DokterPeresep);
                sip=Sequel.cariIsi("SELECT no_ijn_praktek FROM dokter WHERE kd_dokter=?",kddokter);
...
//                    Sequel.queryu("delete from temporary_resep2 where temp37='"+akses.getalamatip()+"'");
//
//                    // Ambil data resep dan simpan ke temporary
//                    String sql = "SELECT databarang.nama_brng, "
//                            + "IFNULL(resep_dokter.aturan_pakai, '') AS aturan, "
//                            + "resep_dokter.jml, kodesatuan.satuan "
//                            + "FROM resep_obat "
...
//                        System.err.println("Error mengambil data resep: " + e.getMessage());
...
//                    }
//
//                    // Ambil data pendukung untuk laporan
...
//                        "SELECT reg_periksa.kd_pj FROM reg_periksa WHERE reg_periksa.no_rawat = ?", NoRawat);
//                    String kddokter = Sequel.cariIsi(
//                        "SELECT kd_dokter FROM dokter WHERE nm_dokter = ?", DokterPeresep);
//                    String sip = Sequel.cariIsi(
//                        "SELECT no_ijn_praktek FROM dokter WHERE kd_dokter = ?", kddokter);
//                    String finger = Sequel.cariIsi(
//                        "SELECT SHA1(sidikjari.sidikjari) FROM sidikjari "
//                        + "INNER JOIN pegawai ON pegawai.id = sidikjari.id "
//                        + "WHERE pegawai.nik = ?", kddokter);
//
//                    String fingerId = (finger == null || finger.isEmpty()) ? kddokter : finger;
//                    String fingerText = "Dikeluarkan di " + akses.getnamars()
...
//                        "SELECT CONCAT(reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur "
//                        + "FROM reg_periksa WHERE reg_periksa.no_rawat = ?", NoRawat));
//                    param.put("alamat", Sequel.cariIsi(
//                        "SELECT pasien.alamat FROM pasien WHERE pasien.no_rkm_medis = ?", noRekamMedis));
//                    param.put("bb", Sequel.cariIsi(
//                        "SELECT CONCAT(pemeriksaan_ralan.berat, ' kg') AS berat "
//                        + "FROM pemeriksaan_ralan WHERE pemeriksaan_ralan.no_rawat = ?", NoRawat));
//                    param.put("alergi", Sequel.cariIsi(
//                        "SELECT alergi FROM pemeriksaan_ralan WHERE pemeriksaan_ralan.no_rawat = ?", NoRawat));
//                    param.put("tb", Sequel.cariIsi(
//                        "SELECT CONCAT(pemeriksaan_ralan.tinggi, ' cm') AS tinggi "
//                        + "FROM pemeriksaan_ralan WHERE pemeriksaan_ralan.no_rawat = ?", NoRawat));
//                    param.put("bayar", Sequel.cariIsi(
//                        "SELECT penjab.png_jawab FROM resep_obat "
//                        + "INNER JOIN reg_periksa ON resep_obat.no_rawat = reg_periksa.no_rawat "
//                        + "INNER JOIN penjab ON reg_periksa.kd_pj = penjab.kd_pj "
//                        + "WHERE resep_obat.no_resep = ?", NoResep));
//                    param.put("tanggal", Sequel.cariIsi(
//                        "SELECT DATE_FORMAT(resep_obat.tgl_peresepan, '%d-%m-%Y') AS tanggal "
//                        + "FROM resep_obat WHERE resep_obat.no_resep = ?", NoResep));
//                    param.put("norawat",  NoRawat);
//                    param.put("pasien",   Pasien);
//                    param.put("norm",     NoRM);
//                    param.put("peresep",  DokterPeresep);
//                    param.put("noresep",  NoResep);
//                    param.put("ruang",    Ruang);
//                    param.put("finger",   fingerText);
//                    param.put("jam",      JamPeresepan);
//                    param.put("logo",     Sequel.cariGambar("SELECT setting.logo FROM setting"));
//
//                    // Cetak laporan
//                    Valid.MyReportqry(
//                        "rptLembarObat4.jasper", "report",
//                        "::[ Lembar Pemberian Obat ]::",
//                        "SELECT * FROM temporary_resep2 WHERE temporary_resep2.temp37='"+akses.getalamatip()+"' ORDER BY temporary_resep2.no",
//                        param
//                    );
//
//                } catch (Exception e) {
//                    System.err.println("Error cetak lembar obat: " + e.getMessage());
//                    JOptionPane.showMessageDialog(null,
...
//        }
    ...
    private void tbResepRalanKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbResepRalanKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tbResepRalanKeyReleased
            ...
            if(tbPermintaanResepPulang.getSelectedRow()!= -1){
                ...
                try {
                    ...
                    ps=koneksi.prepareStatement(
                        ...
                        + "inner join kodesatuan on kodesatuan.kode_sat=databarang.kode_sat where permintaan_resep_pulang.no_permintaan=?");
                    try {
                        ps.setString(1,NoResep);
                        rs=ps.executeQuery();
                        while(rs.next()){
                ...
                param.put("alergi",Sequel.cariIsi("select alergi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=?",NoRawat));
                param.put("tb",Sequel.cariIsi("select concat(pemeriksaan_ralan.tinggi,' cm') as tinggi from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=?",NoRawat));
                param.put("bayar",Sequel.cariIsi("SELECT penjab.png_jawab FROM permintaan_resep_pulang INNER JOIN reg_periksa ON permintaan_resep_pulang.no_rawat=reg_periksa.no_rawat INNER JOIN penjab ON reg_periksa.kd_pj=penjab.kd_pj WHERE permintaan_resep_pulang.no_permintaan=?",NoResep));
                param.put("propinsirs",akses.getpropinsirs());
                param.put("tanggal",Sequel.cariIsi("select DATE_FORMAT(permintaan_resep_pulang.tgl_permintaan,'%d-%m-%Y') as tanggal from permintaan_resep_pulang where permintaan_resep_pulang.no_permintaan=?",NoResep));
                param.put("norawat",NoRawat);
                param.put("pasien",Pasien);
                param.put("norm",NoRM);
                param.put("peresep",DokterPeresep);
    ...
    private void BtnPenyerahan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenyerahan1ActionPerformed
//        Penyerahan kanan
//        if(TabPilihRawat.getSelectedIndex()==0){
//          if(TabRawatJalan.getSelectedIndex()==0){
//                if(akses.getberi_obat()==true){
...
//                        JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilih data resep dokter yang mau diserahkan..!!");
//                    }else{
//                        Sequel.queryu("delete from antriapotek5");
//                        Sequel.queryu("insert into antriapotek5 values('"+NoResep+"','1','"+NoRawat+"')");
//                        Sequel.queryu("delete from bukti_penyerahan_resep_obat where no_resep='"+NoResep+"'");
//                    }
//                }else{
//                    JOptionPane.showMessageDialog(null,"Maaf, Anda tidak punya hak akses untuk mengvalidasi...!!!!");
...
//        TTK
    ...
    }//GEN-LAST:event_BtnPenyerahan1ActionPerformed

    private void BtnPenyerahan1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPenyerahan1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnPenyerahan1KeyPressed
    ...
    */
    ...
    private widget.Button BtnPenyerahan1;
...
//    }
                    ...
                    try{  
                        ...
                        if(DEPOAKTIFOBAT.equals("")){
                            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                                    ...
                                    " if(resep_obat.jam='00:00:00','',resep_obat.jam) as jam,"+
                                    " if(resep_obat.tgl_penyerahan='0000-00-00','',resep_obat.tgl_penyerahan) as tgl_penyerahan,"+
                                    " if(resep_obat.jam_penyerahan='00:00:00','',resep_obat.jam_penyerahan) as jam_penyerahan,IFNULL(rot.status,'') as status2 "+
                                    " from resep_obat "+
                                    " inner join reg_periksa on resep_obat.no_rawat=reg_periksa.no_rawat "+
                                    " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                                    " inner join dokter on resep_obat.kd_dokter=dokter.kd_dokter "+
                                    " inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+
                                    " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                                    " left join resep_obat_tambahan rot on rot.no_resep=resep_obat.no_resep "+
                                    " where resep_obat.tgl_peresepan<>'0000-00-00' and resep_obat.status='ralan' and resep_obat.tgl_peresepan between ? and ? "+
                                    (semua?"":"and dokter.nm_dokter like ? and poliklinik.nm_poli like ? and "+
                                    "(resep_obat.no_resep like ? or resep_obat.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                                    "penjab.png_jawab like ? or rot.status like ?)")+" order by resep_obat.tgl_peresepan desc,resep_obat.jam_peresepan desc");
                        }else{
                            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                                    " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter,"+
                                    " if(resep_obat.tgl_perawatan='0000-00-00','Belum Terlayani','Sudah Terlayani') as status,poliklinik.nm_poli, "+
                        ...
                        try{
                            ...
                            if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                                while(rs.next()){
                                    i++;
                                    publish(new Object[]{
                                        rs.getString("no_resep"),rs.getString("tgl_peresepan"),rs.getString("jam_peresepan"),rs.getString("status2"),rs.getString("no_rawat"),
                                        rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("nm_dokter"),rs.getString("status"),
                                        rs.getString("kd_dokter"),rs.getString("nm_poli"),rs.getString("kd_poli"),rs.getString("png_jawab"),
                                        rs.getString("tgl_perawatan"),rs.getString("jam"),rs.getString("tgl_penyerahan"),rs.getString("jam_penyerahan")
                                    });
    ...
    private void getData() {
        if(tbResepRalan.getSelectedRow()!= -1){
            ...
            NoRawat=tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),4).toString();
            NoRM=tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),5).toString();
            Pasien=tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),6).toString();
            DokterPeresep=tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),7).toString();
    ...
    private void getData2() {
        if(tbResepRanap.getSelectedRow()!= -1){
            ...
            NoRawat=tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),4).toString();
            NoRM=tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),5).toString();
            Pasien=tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),6).toString();
            DokterPeresep=tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),7).toString();
    ...
    private void getData4() {
        if(tbPermintaanResepPulang.getSelectedRow()!= -1){
            ...
            NoRawat=tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.getSelectedRow(),4).toString();
            NoRM=tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.getSelectedRow(),5).toString();
            Pasien=tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.getSelectedRow(),6).toString();
            DokterPeresep=tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.getSelectedRow(),7).toString();
            ...
            try{
                ...
                if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                    ...
                    while(rs.next()){
                        if(rs.getString("status").equals(cmbStatus.getSelectedItem().toString())){
                            tabMode2.addRow(new String[]{
                                rs.getString("no_resep"),rs.getString("tgl_peresepan")+" "+rs.getString("jam"),
                                rs.getString("nm_poli"),rs.getString("status"),
                                rs.getString("no_rawat")+" "+rs.getString("no_rkm_medis")+" "+rs.getString("nm_pasien")+" ("+rs.getString("png_jawab")+")",
                                rs.getString("nm_dokter")
                            });
    ...
    private void panggilform4() {
        ...
        dlgresepulang.setNoRm(NoRawat,NoRM,Pasien,"-",Sequel.cariIsi("select current_date()"),Sequel.cariIsi("select current_time()"));
        dlgresepulang.isCek();
                    ...
                    try{  
                        ...
                        if(DEPOAKTIFOBAT.equals("")){
                            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                                    ...
                                    " bangsal.nm_bangsal,kamar.kd_bangsal,penjab.png_jawab,"+
                                    " if(resep_obat.tgl_perawatan='0000-00-00','',resep_obat.tgl_perawatan) as tgl_perawatan,"+
                                    " if(resep_obat.jam='00:00:00','',resep_obat.jam) as jam,IFNULL(rot.status,'') as status2 from resep_obat  "+
                                    " inner join reg_periksa on resep_obat.no_rawat=reg_periksa.no_rawat "+
                                    " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                                    " inner join dokter on resep_obat.kd_dokter=dokter.kd_dokter "+
                                    " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
    ...
    public void tampil6() {
        ...
        try{  
            ...
            ps=koneksi.prepareStatement("select permintaan_stok_obat_pasien.no_permintaan,permintaan_stok_obat_pasien.tgl_permintaan,permintaan_stok_obat_pasien.jam,permintaan_stok_obat_pasien.no_rawat,pasien.no_rkm_medis,"+
                    ...
                    " inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
                    " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    " where and permintaan_stok_obat_pasien.tgl_permintaan between ? and ? "+
                    (semua?"":"and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "+
                    "(permintaan_stok_obat_pasien.no_permintaan like ? or permintaan_stok_obat_pasien.no_rawat like ? or "+
                    "pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or dokter.nm_dokter like ? or penjab.png_jawab like ?)")+
                    " group by permintaan_stok_obat_pasien.no_permintaan order by permintaan_stok_obat_pasien.tgl_permintaan desc,permintaan_stok_obat_pasien.jam desc");
...
//                    " inner join kamar on kamar_inap.kd_kamar=kamar.kd_kamar "+
//                    " inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
//                    " where permintaan_resep_pulang.tgl_permintaan between ? and ? and kamar_inap.stts_pulang<>'Pindah Kamar'"+
//                    (semua?"":"and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "+
                    ...
                    try{  
                        ...
                        if(DEPOAKTIFOBAT.equals("")){
                            ps=koneksi.prepareStatement("select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"+
                                    " permintaan_resep_pulang.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,permintaan_resep_pulang.kd_dokter,dokter.nm_dokter, "+
                                    " if(permintaan_resep_pulang.status='Belum','Belum Terlayani','Sudah Terlayani') as status,"+
                                    " bangsal.nm_bangsal,kamar.kd_bangsal,penjab.png_jawab,IFNULL(rot.status,'') as status2 from permintaan_resep_pulang  "+
                                    " inner join reg_periksa on permintaan_resep_pulang.no_rawat=reg_periksa.no_rawat "+
                                    " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                                    " inner join dokter on permintaan_resep_pulang.kd_dokter=dokter.kd_dokter "+
                                    " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                        ...
                        try{
                            ...
                            if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                                while(rs.next()){
                                    i++;
                                    publish(new Object[]{
                                        rs.getString("no_permintaan"),rs.getString("tgl_permintaan"),rs.getString("jam"),rs.getString("status2"),rs.getString("no_rawat"),
                                        rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("nm_dokter"),rs.getString("status"),
                                        rs.getString("kd_dokter"),rs.getString("nm_bangsal"),rs.getString("kd_bangsal"),rs.getString("png_jawab")
                                    });
                                }
...
//                detik = nol_detik + Integer.toString(nilai_detik);
//
//                if (detik.equals("05")||detik.equals("25")||detik.equals("45")) {
//                    resepbaru = 0;
//
//                    // ✅ Query langsung ke DB, tidak bergantung pada isi tabel UI
//                    try {
//                        if (formalarm.contains("ralan")) {
//                            ps3 = koneksi.prepareStatement(
//                                "SELECT COUNT(*) FROM resep_obat ro WHERE ro.tgl_peresepan = CURDATE()\n" +
//                                "AND ro.tgl_perawatan ='0000-00-00' AND ro.status ='ralan'"
//                            );
//                            rs3 = ps3.executeQuery();
//                            if (rs3.next()) {
//                                resepbaru += rs3.getInt(1);
//                            }
//                            rs3.close();
//                            ps3.close();
//                        }
...
//                        if (formalarm.contains("ranap")) {
//                            ps3 = koneksi.prepareStatement(
//                                "SELECT COUNT(*) FROM resep_obat rd WHERE rd.tgl_peresepan = CURDATE()\n" +
//                                "and rd.tgl_perawatan ='0000-00-00' and rd.status ='Ranap'"
//                            );
//                            rs3 = ps3.executeQuery();
//                            if (rs3.next()) {
//                                resepbaru += rs3.getInt(1);
...
//                        }
//                    } catch (Exception ex) {
//                        System.out.println("Alarm DB error: " + ex);
//                    }
//
//                    if (resepbaru > 0) {
//                        try {
