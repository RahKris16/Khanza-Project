 ...
 * @author dosen
 */
public final class DlgPeresepanDokter_13 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPeresepanDokter_13(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    public void tampilobat() {        
        ...
        try {
            if(kenaikan>0){
                psresepasuransi=koneksi.prepareStatement("select obatsttigd.jumlah, obatsttigd.kode_brng,obatsttigd.aturan, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                    " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok "+
                    " from obatsttigd inner join databarang inner join jenis inner join industrifarmasi inner join gudangbarang "+
                    " on obatsttigd.kode_brng=databarang.kode_brng and databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                ...
                psresep=koneksi.prepareStatement(
                   "select obatsttigd.jumlah, obatsttigd.kode_brng,obatsttigd.aturan, databarang.nama_brng,jenis.nama, databarang.kode_sat,"+
