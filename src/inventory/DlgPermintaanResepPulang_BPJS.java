...
public class DlgPermintaanResepPulang_BPJS extends javax.swing.JDialog {
    ...
    private String norawatibu,tampilkan_ppnobat_ranap="",aktifkanbatch="no",kelas="",bangsal="",kamar="",hppfarmasi="",lokasi="";
     ...
     * @param parent
     * @param modal */
    public DlgPermintaanResepPulang_BPJS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-06-2025" }));
        ...
        label13.setBounds(765, 10, 50, 23);
        ...
        Jeniskelas1.setBounds(820, 10, 120, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPermintaanResepPulang_BPJS dialog = new DlgPermintaanResepPulang_BPJS(new javax.swing.JFrame(), true);
            ...
            if(kenaikan>0){
                ...
                if(aktifkanbatch.equals("yes")){
                    pstampil=koneksi.prepareStatement(
                        ...
                        " from databarang inner join jenis inner join gudangbarang inner join databarang_tambahan "+
                        " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng and databarang_tambahan.kode_brng =databarang.kode_brng "+
                        " where  databarang.status='1' and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and databarang_tambahan.status ='BPJS' and gudangbarang.kd_bangsal=? and databarang.kode_brng like ? or "+
                        "  databarang.status='1' and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and databarang_tambahan.status ='BPJS' and gudangbarang.kd_bangsal=? and databarang.nama_brng like ? or "+
                        "  databarang.status='1' and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and databarang_tambahan.status ='BPJS' and gudangbarang.kd_bangsal=? and jenis.nama like ? group by gudangbarang.kode_brng order by databarang.nama_brng");
                }else{
                    pstampil=koneksi.prepareStatement(
                        "select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,"+
                        " databarang.karyawan,databarang."+hppfarmasi+" as dasar,databarang.beliluar,databarang.kelas1," +
                        ...
                        " where  databarang.status='1' and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and databarang_tambahan.status ='BPJS' and gudangbarang.kd_bangsal=? and databarang.kode_brng like ? or "+
                        "  databarang.status='1' and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and databarang_tambahan.status ='BPJS' and gudangbarang.kd_bangsal=? and databarang.nama_brng like ? or "+
                        "  databarang.status='1' and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and databarang_tambahan.status ='BPJS' and gudangbarang.kd_bangsal=? and jenis.nama like ? order by databarang.nama_brng");
                }
