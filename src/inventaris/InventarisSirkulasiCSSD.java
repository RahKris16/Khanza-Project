...
public class InventarisSirkulasiCSSD extends javax.swing.JDialog {
    ...
    private InventarisCariSirkulasiCSSD form=new InventarisCariSirkulasiCSSD(null,false);
    private PreparedStatement ps,ps2;
    private ResultSet rs,rs2;
    private String inventariscari="",tglcari="",status="Normal";
    private double ttlmasuk=0,ttlhilang=0,ttlkeluar=0,ttlrusak=0,stokakhir=0,stoklayak=0;
    ...
    public InventarisSirkulasiCSSD(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No. Inventaris","Nama Barang","Stok Gudang","Linen Terpakai di Pelayanan","Linen Rusak","Linen Hilang","Linen Layak Pakai","Jumlah Minimal Linen Layak Pakai"
        };
...
//        }
    ...
    private void initComponents() {
        ...
        internalFrame2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Transaksi CSSD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Sirkulasi CSSD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(no_inventaris.getText().trim().equals("")||nama_barang.getText().trim().equals("")){
            ...
            if(status.equals("Masuk")){
                Sequel.menyimpan("inventaris_gudang_cssd","'"+no_inventaris.getText()+"',CURRENT_TIMESTAMP,'"+jumlah.getText()+"','0','0','-','0'");
                status="Normal";
                WindowInput.dispose();
            }else if(status.equals("Keluar")){
                Sequel.menyimpan("inventaris_gudang_cssd","'"+no_inventaris.getText()+"',CURRENT_TIMESTAMP,'0','"+jumlah.getText()+"','0','-','0'");
                status="Normal";
                WindowInput.dispose();
            }else if(status.equals("Rusak")){
                Sequel.menyimpan("inventaris_gudang_cssd","'"+no_inventaris.getText()+"',CURRENT_TIMESTAMP,'0','0','"+jumlah.getText()+"','"+sttsrusak.getText()+"','0'");
                status="Normal";
                WindowInput.dispose();
            }else if(status.equals("Hilang")){
                Sequel.menyimpan("inventaris_gudang_cssd","'"+no_inventaris.getText()+"',CURRENT_TIMESTAMP,'0','0','0','-','"+jumlah.getText()+"'");
                status="Normal";
                WindowInput.dispose();
            }
            tampil();
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "SELECT ic.id_jenis,ic.nama_jenis,cb.stok,cb.min_stok FROM inventaris_cssd ic " +
                    "inner join cssd_barang2 cb on cb.no_inventaris=ic.id_jenis "+
                    "ORDER by ic.id_jenis");
            try {
                ttlmasuk=0;ttlhilang=0;ttlkeluar=0;ttlrusak=0;stokakhir=0;stoklayak=0;
                rs=ps.executeQuery();
                while(rs.next()){
                    ps2=koneksi.prepareStatement("select sum(igc.hilang) "+
                        " from inventaris_gudang_cssd igc inner join inventaris_cssd ic "+
                    ...
                    try {
                        ...
                        rs2=ps2.executeQuery();
                        if(rs2.next()){                    
                            ttlkeluar=rs2.getDouble(1)-(rs2.getDouble(2)+rs2.getDouble(3));
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi Detail Sirkulasi : "+e);
                    } finally{
                    ...
                    stokakhir=rs.getDouble(3)+ttlmasuk-(ttlhilang+ttlkeluar+ttlrusak);
                    stoklayak=stokakhir+ttlkeluar;
                    tabMode.addRow(new Object[]{
                        rs.getString(1),rs.getString(2),stokakhir,ttlkeluar,ttlrusak,ttlhilang,stoklayak,rs.getString(4)
                    });
                }
            } catch (Exception e) {
