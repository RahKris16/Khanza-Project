 ...
 * @author dosen
 */
public class InventarisBarangLab extends javax.swing.JDialog {
    ...
    private InventarisLab inventaris=new InventarisLab(null,false);

    /** Creates new form DlgSpesialis
     * @param parent
     * @param modal */
    public InventarisBarangLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Inventaris","Nama Barang","Stok Awal","Minimal Stok","Harga (Rp)"
            }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Barang LAB ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        btnInv.setBounds(420, 10, 25, 23);

        label2.setText("Barang :");
        label2.setName("label2"); // NOI18N
        panelGlass7.add(label2);
        label2.setBounds(0, 10, 65, 23);

        label3.setText("Stok :");
        label3.setName("label3"); // NOI18N
        panelGlass7.add(label3);
        label3.setBounds(450, 10, 65, 23);
        ...
        panelGlass7.add(stok);
        stok.setBounds(520, 10, 85, 23);

        label4.setText("Minimal Stok :");
        label4.setName("label4"); // NOI18N
        panelGlass7.add(label4);
        label4.setBounds(625, 10, 80, 23);

        stok1.setName("stok1"); // NOI18N
        stok1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                stok1KeyPressed(evt);
            }
        });
        panelGlass7.add(stok1);
        stok1.setBounds(710, 10, 85, 23);

        label5.setText("Harga (Rp) :");
        label5.setName("label5"); // NOI18N
        panelGlass7.add(label5);
        label5.setBounds(820, 10, 60, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(no_inventaris.getText().trim().equals("")||nama_barang.getText().trim().equals("")){
            ...
            Sequel.menyimpan("lab_barang","'"+no_inventaris.getText()+"','"+stok.getText()+"','"+stok1.getText()+"','"+harga.getText()+"'","Barang");
//            Sequel.menyimpan("inventaris_gudang_cssd","'"+no_inventaris.getText()+"',CURRENT_DATE(),'"+stok.getText()+"','0','0','-'","Barang");
            tampil();
            emptTeks();
        }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,btnInv,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,no_inventaris,"lab_barang","no_inventaris");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(no_inventaris.getText().trim().equals("")||nama_barang.getText().trim().equals("")){
            ...
            Sequel.mengedit("lab_barang","no_inventaris=?","stok=?,min_stok=?,harga=?",4,new String[]{
                stok.getText(),stok1.getText(),harga.getText(),tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString()
            });
    ...
    private void stok1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_stok1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_stok1KeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisBarangLab dialog = new InventarisBarangLab(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select inventaris_lab.id_jenis,inventaris_lab.nama_jenis, lab_barang.stok,lab_barang.min_stok,lab_barang.harga "+
                    "from inventaris_lab inner join lab_barang on lab_barang.no_inventaris=inventaris_lab.id_jenis where "+
                    "inventaris_lab.id_jenis like ? or inventaris_lab.nama_jenis like ? order by inventaris_lab.id_jenis");
            try {
    ...
    private void getData() {
        if(tbSpesialis.getSelectedRow()!= -1){
            ...
            nama_barang.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),1).toString());
            stok.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),2).toString());
            stok1.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),3).toString());
            harga.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),4).toString());
        }
    }
    ...
    public void isCek(){
        ...
        BtnEdit.setEnabled(akses.getperiksa_lab());
    }
}
