 ...
 * @author dosen
 */
public class InventarisLab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"ID Inventaris","Nama Inventaris"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Jenis LAB ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"ID Inventaris");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Nama Inventaris");
        }else{
            Sequel.menyimpan("inventaris_lab","'"+TKd.getText()+"','"+TNm.getText()+"'","ID Jenis");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,TKd,"inventaris_lab","id_jenis");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("inventaris_lab","id_jenis=?","id_jenis=?,nama_jenis=?",3,new String[]{
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari("select * from inventaris_lab where id_jenis like '%"+TCari.getText().trim()+"%' "+
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        TCari.setText("");
        prosesCari("select * from inventaris_lab order by id_jenis");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisLab dialog = new InventarisLab(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        String sql="select * from inventaris_lab order by id_jenis";
        prosesCari(sql);
        emptTeks();
    }
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"A",2,TKd);
        TKd.requestFocus();
    }
