 ...
 * @author dosen
 */
public class InventarisBarangCSSD2 extends javax.swing.JDialog {
    ...
    private InventarisCSSD inventaris=new InventarisCSSD(null,false);

    /** Creates new form DlgSpesialis
     * @param parent
     * @param modal */
    public InventarisBarangCSSD2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Inventaris","Nama Barang","Stok Awal","Minimal Stok"
            }){
    ...
    private void initComponents() {
        ...
        stok.setBounds(545, 10, 85, 23);

        label4.setText("Minimal Stok :");
        label4.setName("label4"); // NOI18N
        panelGlass7.add(label4);
        label4.setBounds(660, 10, 80, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(no_inventaris.getText().trim().equals("")||nama_barang.getText().trim().equals("")){
            ...
            Sequel.menyimpan("cssd_barang2","'"+no_inventaris.getText()+"','"+stok.getText()+"','"+stok1.getText()+"'","Barang");
//            Sequel.menyimpan("inventaris_gudang_cssd","'"+no_inventaris.getText()+"',CURRENT_DATE(),'"+stok.getText()+"','0','0','-'","Barang");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,no_inventaris,"cssd_barang2","no_inventaris");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(no_inventaris.getText().trim().equals("")||nama_barang.getText().trim().equals("")){
            ...
            Sequel.mengedit("cssd_barang2","no_inventaris=?","stok=?,min_stok=?",3,new String[]{
                stok.getText(),stok1.getText(),tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString()
            });
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisBarangCSSD2 dialog = new InventarisBarangCSSD2(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select inventaris_cssd.id_jenis,inventaris_cssd.nama_jenis, cssd_barang2.stok,cssd_barang2.min_stok "+
                    "from inventaris_cssd inner join cssd_barang2 on cssd_barang2.no_inventaris=inventaris_cssd.id_jenis where "+
                    "inventaris_cssd.id_jenis like ? or inventaris_cssd.nama_jenis like ? order by inventaris_cssd.id_jenis");
            try {
