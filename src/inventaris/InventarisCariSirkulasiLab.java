 ...
 * @author perpustakaan
 */
public class InventarisCariSirkulasiLab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventarisCariSirkulasiLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8,1);
        setSize(628,674);

        Object[] row={"No.","Nama Barang","Tanggal","Barang Lab Masuk ke Gudang","Barang Lab Terpakai di Pelayanan","Barang Lab Rusak","Barang Lab Hilang","Keterangan"
        };
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisCariSirkulasiLab dialog = new InventarisCariSirkulasiLab(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "FROM inventaris_lab ic inner join inventaris_gudang_lab igc on igc.no_inventaris=ic.id_jenis " +
