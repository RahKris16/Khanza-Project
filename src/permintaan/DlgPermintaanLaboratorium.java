        ...
        if(status.equals("Ranap")){
            ...
            if(!norawatibu.equals("")){
                ...
                kelas=Sequel.cariIsi(
                    "select kelas.nm_kelas from kamar inner join kamar_inap "+
                    "on kelas.kd_kelas=kamar_inap.kd_kelas where no_rawat=? "+
                ...
                kelas=Sequel.cariIsi(
                    "select kelas.nm_kelas from kelas inner join kamar_inap "+
                    "on kelas.kd_kelas=kamar_inap.kd_kelas where no_rawat=? "+
        ...
        try{
            ...
            if(cara_bayar_lab.equals("Yes")&&kelas_lab.equals("No")){
                ...
                pstindakan3=koneksi.prepareStatement(
                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,penjab.png_jawab "+
                    "from jns_perawatan_lab inner join penjab on penjab.kd_pj=jns_perawatan_lab.kd_pj where "+
                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_pj=? and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.kd_jenis_prw like ? or "+
                    " jns_perawatan_lab.kategori='PK' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_pj=? and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.nm_perawatan like ? "+
                    "order by jns_perawatan_lab.kd_jenis_prw");
            ...
            try {
                if(cara_bayar_lab.equals("Yes")&&kelas_lab.equals("No")){
                    ...
                    if(kelas.equals("Kelas 1")||kelas.equals("Kelas 2")||kelas.equals("Kelas 3")||kelas.equals("Kelas VIP")||kelas.equals("Kelas VVIP")){
            ...
            try {                    
                ...
                if(jml>0){
                    if(Sequel.menyimpantf2("permintaan_lab","?,?,?,?,?,?,?,?,?,?,?,?","No.Permintaan",12,new String[]{
                        ...
                        Sequel.menyimpan("tracklab","'"+TNoPermintaanPK.getText()+"','"+TNoRw.getText()+"',current_date(),current_time()","Pemeriksaan Lab");
                        for(i=0;i<tbTarifPK.getRowCount();i++){ 
                            if(tbTarifPK.getValueAt(i,0).toString().equals("true")){
        ...
        try{
            ...
            if(cara_bayar_lab.equals("Yes")&&kelas_lab.equals("No")){
                ...
                pstindakan3=koneksi.prepareStatement(
                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,penjab.png_jawab "+
                    "from jns_perawatan_lab inner join penjab on penjab.kd_pj=jns_perawatan_lab.kd_pj where "+
                    " jns_perawatan_lab.kategori='PA' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_pj=?  and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.kd_jenis_prw like ? or "+
                    " jns_perawatan_lab.kategori='PA' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_pj=? and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.nm_perawatan like ? "+
                    "order by jns_perawatan_lab.kd_jenis_prw");
            }else if(cara_bayar_lab.equals("No")&&kelas_lab.equals("Yes")){
                pstindakan4=koneksi.prepareStatement(
                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,penjab.png_jawab "+
        ...
        try{
            ...
            if(cara_bayar_lab.equals("Yes")&&kelas_lab.equals("No")){
                ...
                pstindakan3=koneksi.prepareStatement(
                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,penjab.png_jawab "+
                    "from jns_perawatan_lab inner join penjab on penjab.kd_pj=jns_perawatan_lab.kd_pj where "+
                    " jns_perawatan_lab.kategori='MB' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_pj=? and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.kd_jenis_prw like ? or "+
                    " jns_perawatan_lab.kategori='MB' and jns_perawatan_lab.status='1' and jns_perawatan_lab.kd_pj=? and (jns_perawatan_lab.kelas=? or jns_perawatan_lab.kelas='-') and jns_perawatan_lab.nm_perawatan like ? "+
                    "order by jns_perawatan_lab.kd_jenis_prw");
            }else if(cara_bayar_lab.equals("No")&&kelas_lab.equals("Yes")){
                pstindakan4=koneksi.prepareStatement(
                    "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,penjab.png_jawab "+
