        ...
        try{   
            ...
            if(aktifpcare.equals("yes")){
                sql="select jns_perawatan_inap.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   ...
                   "jns_perawatan_inap.tarif_tindakandr,jns_perawatan_inap.tarif_tindakanpr,kelas.nm_kelas from jns_perawatan_inap inner join kategori_perawatan "+
                   "inner join maping_tindakan_ranap_pcare inner join kelas on jns_perawatan_inap.kd_kategori=kategori_perawatan.kd_kategori and maping_tindakan_ranap_pcare.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw and kelas.kd_kelas=jns_perawatan_inap.kelas ";
            }else{
                sql="select jns_perawatan_inap.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,kategori_perawatan.nm_kategori,"+
                   "jns_perawatan_inap.total_byrdr,jns_perawatan_inap.total_byrpr,jns_perawatan_inap.total_byrdrpr,jns_perawatan_inap.bhp,jns_perawatan_inap.material,jns_perawatan_inap.kso,jns_perawatan_inap.menejemen," +
            ...
            pscari5=koneksi.prepareStatement(sql+
                   "where jns_perawatan_inap.status='1' and jns_perawatan_inap.nm_perawatan like ?  and jns_perawatan_inap.kd_pj=?  and (jns_perawatan_inap.kelas=? or jns_perawatan_inap.kelas='-') order by jns_perawatan_inap.nm_perawatan");
            ...
            try {
                if(ruang_ranap.equals("Yes")&&cara_bayar_ranap.equals("Yes")&&kelas_ranap.equals("No")){
                    ...
                    pscari5.setString(1,"%"+TCari.getText().trim()+"%");
                    ...
                    pscari6.setString(1,"%"+TCari.getText().trim()+"%");
