...
public final class DlgJnsPerawatanOperasi extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        TKd.setDocument(new batasInput((byte)25).getKata(TKd));
    ...
    private void initComponents() {
        ...
        Kelas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Rawat Jalan", "Kelas 1", "Kelas 2", "Kelas 3", "Kelas VIP", "Kelas VVIP" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Kelas.getSelectedItem().toString().equals("Kelas 1")){
                kelass="Kelas 1";
            }else if(Kelas.getSelectedItem().toString().equals("Kelas 2")){
                kelass="Kelas 2";
            }else if(Kelas.getSelectedItem().toString().equals("Kelas 3")){
                kelass="Kelas 3";
            }else if(Kelas.getSelectedItem().toString().equals("Kelas VIP")){
                kelass="Kelas VIP";
            }else if(Kelas.getSelectedItem().toString().equals("Kelas VVIP")){
                kelass="Kelas VVIP";
            }else if(Kelas.getSelectedItem().toString().equals("-")){
                kelass="-";
            }
            Sequel.menyimpan("paket_operasi","'"+TKd.getText()+"', '"+TNm.getText()+"','"+Kategori.getSelectedItem()+"','"+TOperator1.getText()+
                    ...
                    "','"+TdrUmum.getText()+"','"+kdpnj.getText()+"','1','"+kelass+"'","Kode Jenis");
            tampil();
            emptTeks();
        }
        ...
        if(TKd.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()!= -1){
                Sequel.mengedit("paket_operasi","kode_paket='"+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),1) +"'",
                        ...
                        "dokter_umum='"+TdrUmum.getText()+"',kd_pj='"+kdpnj.getText()+"',kelas='"+kelass+"'");
