...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private String biaya="",tambahan="",totals="",norawatbayi="",centangdokterranap="",kd_pj="",
            ...
            sqlpsreseppulang="select resep_pulang.tanggal,databarang.nama_brng,resep_pulang.harga,"+
                    ...
                    "resep_pulang.no_rawat=? order by databarang.nama_brng,resep_pulang.tanggal",
            ...
            sqlpsralandrpr="select CONCAT(DATE_FORMAT(rawat_jl_drpr.tgl_perawatan,'%d-%m-%Y'),' ',jns_perawatan.nm_perawatan) as nm_perawatan,rawat_jl_drpr.biaya_rawat as total_byrdr,count(rawat_jl_drpr.kd_jenis_prw) as jml, "+
                    ...
                    "sum(rawat_jl_drpr.tarif_tindakandr) as totaltarif_tindakandr,jns_perawatan.kd_kategori  "+
                    ...
                    "jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori where "+
                    "rawat_jl_drpr.no_rawat=? and kategori_perawatan.kd_kategori=? group by rawat_jl_drpr.tgl_perawatan,rawat_jl_drpr.kd_jenis_prw",
...
//                    "rawat_jl_drpr.no_rawat=? and kategori_perawatan.kd_kategori=? group by rawat_jl_drpr.kd_jenis_prw",
            ...
            sqlpsranapdrpr="select CONCAT(DATE_FORMAT(rawat_inap_drpr.tgl_perawatan,'%d-%m-%Y'),' ',jns_perawatan_inap.nm_perawatan) as nm_perawatan,rawat_inap_drpr.biaya_rawat as total_byrdr,count(rawat_inap_drpr.kd_jenis_prw) as jml, "+
                    ...
                    "sum(rawat_inap_drpr.tarif_tindakandr) as totaltarif_tindakandr,jns_perawatan_inap.kd_kategori "+
                    ...
                    "jns_perawatan_inap.kd_kategori=kategori_perawatan.kd_kategori where "+
                    "rawat_inap_drpr.no_rawat=? and kategori_perawatan.kd_kategori=? group by rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.kd_jenis_prw",
...
//                    "rawat_inap_drpr.no_rawat=? and kategori_perawatan.kd_kategori=? group by rawat_inap_drpr.kd_jenis_prw",
            ...
            sqlpsoperasi="select CONCAT(DATE_FORMAT(operasi.tgl_operasi, '%d-%m-%Y'),' ',paket_operasi.nm_perawatan) as nm_perawatan,"+
    ...
    public DlgBilingRanap(java.awt.Frame parent, boolean modal) {
        ...
        //ubah lama inap
        Object[] rowUbahLama={"Kode Kamar","Nama Kamar","Tgl.Masuk","Jam Masuk","Tgl.Keluar","Jam Keluar","Lama Inap", "Tarif Kamar"};
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnSimpanUbahLamaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanUbahLamaActionPerformed
        if(norawatubahlama.getText().trim().equals("")||(tbUbahLama.getRowCount()<=0)){
            ...
            for(r=0;r<z;r++){
                if(Valid.SetAngka(tbUbahLama.getValueAt(r,6).toString())>-1||Valid.SetAngka(tbUbahLama.getValueAt(r,7).toString())>-1){                    
                    Sequel.mengedit("kamar_inap","no_rawat='"+norawatubahlama.getText()+"' and kd_kamar='"+tbUbahLama.getValueAt(r,0)+"' and tgl_masuk='"+tbUbahLama.getValueAt(r,2)+"' and jam_masuk='"+tbUbahLama.getValueAt(r,3)+"'",
                           ...
                           "lama='"+tbUbahLama.getValueAt(r,6).toString()+"',trf_kamar='"+tbUbahLama.getValueAt(r,7).toString()+"'");
                    Sequel.mengedit("kamar_inap","no_rawat='"+norawatubahlama.getText()+"' and kd_kamar='"+tbUbahLama.getValueAt(r,0)+"' and tgl_masuk='"+tbUbahLama.getValueAt(r,2)+"' and jam_masuk='"+tbUbahLama.getValueAt(r,3)+"'","ttl_biaya="+tbUbahLama.getValueAt(r,6).toString()+"*trf_kamar");
                }
            }  
            isRawat();
            WindowInput5.dispose();
    ...
    private void prosesCariObat(String norawat) {    
        ...
        try{
            pscariobat=koneksi.prepareStatement(
                    "select DATE_FORMAT(detail_pemberian_obat.tgl_perawatan, '%d-%m-%Y') as tgl_perawatan,databarang.nama_brng,jenis.nama,detail_pemberian_obat.biaya_obat,"+
                    ...
                    "detail_pemberian_obat.no_rawat=? and detail_pemberian_obat.status like ? group by databarang.kode_brng,"+
                    "detail_pemberian_obat.biaya_obat,detail_pemberian_obat.tgl_perawatan order by detail_pemberian_obat.tgl_perawatan");
            try {
                ...
                if(centangobatranap.equals("Yes")){
                    while(rscariobat.next()){
                        tabModeRwJlDr.addRow(new Object[]{true,"",rscariobat.getString("tgl_perawatan")+" "+rscariobat.getString("nama_brng")+" ("+rscariobat.getString("nama")+")",":",
                    ...
                    while(rscariobat.next()){
                        tabModeRwJlDr.addRow(new Object[]{false,"",rscariobat.getString("tgl_perawatan")+" "+rscariobat.getString("nama_brng")+" ("+rscariobat.getString("nama")+")",":",
                                       rscariobat.getDouble("biaya_obat"),rscariobat.getDouble("jml"),rscariobat.getDouble("tambahan"),
                                       (rscariobat.getDouble("total")+rscariobat.getDouble("tambahan")),"Obat"});
                        subttl=subttl+rscariobat.getDouble("total")+rscariobat.getDouble("tambahan");
                    }
        ...
        try{     
            ...
            try {
                ...
                while(rsreseppulang.next()){
                    ...
                    tabModeRwJlDr.addRow(new Object[]{true,"",rsreseppulang.getString("tanggal")+" "+rsreseppulang.getString("nama_brng")+" "+rsreseppulang.getString("dosis"),":",
            ...
            for(int r=0;r<row;r++){     
                ...
                switch (tabModeRwJlDr.getValueAt(r,8).toString()) {
                    ...
                    case "Ranap Dokter Paramedis":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (KEPER)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (TINDA)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (KONSU)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (PENUN)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (REHAB)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (BMHP)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (JPY)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (SEWA)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                        break;
                    case "Ranap Dokter Paramedis (-)":
                        ttlRanap_Dokter=ttlRanap_Dokter+y;
                    ...
                    case "Ralan Dokter Paramedis":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (KEPER)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (TINDA)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (KONSU)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (PENUN)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (REHAB)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (BMHP)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (JPY)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (SEWA)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
                        break;
                    case "Ralan Dokter Paramedis (-)":
                        ttlRalan_Dokter=ttlRalan_Dokter+y;
    ...
    private void prosesCariTindakan(String norawat){
        ...
        try {
            ...
            psperiksalab=koneksi.prepareStatement(
                   "select CONCAT(DATE_FORMAT(periksa_lab.tgl_periksa,'%d-%m-%Y'),' ',jns_perawatan_lab.nm_perawatan) as nm_perawatan, "+
                   "count(periksa_lab.kd_jenis_prw) as jml,periksa_lab.biaya as biaya, \n" +
                   ...
                   " periksa_lab.no_rawat=? and periksa_lab.status like ? group by periksa_lab.kd_jenis_prw,periksa_lab.tgl_periksa ");
            try {
            ...
            psperiksarad=koneksi.prepareStatement(
                   "select CONCAT(DATE_FORMAT(periksa_radiologi.tgl_periksa,'%d-%m-%Y'),' ',jns_perawatan_radiologi.nm_perawatan) as nm_perawatan, "+
                   "count(periksa_radiologi.kd_jenis_prw) as jml,periksa_radiologi.biaya as biaya, "+
                   ...
                   " periksa_radiologi.no_rawat=? and periksa_radiologi.status like ? group by periksa_radiologi.kd_jenis_prw,periksa_radiologi.tgl_periksa  ");            
            try {
            ...
            try {
                ...
                while(rskamarin.next()){
                    tabModeKamIn.addRow(new Object[]{
                        ...
                        rskamarin.getString("lama"),rskamarin.getString("trf_kamar")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);
