...
public class DlgRL4B extends javax.swing.JDialog {
    ...
    private int hr0s7l=0,hr0s7p=0,hr8s28l=0,hr8s28p=0,hr29sbl3l=0,hr29sbl3p=0,bl3sbl6l=0,bl3sbl6p=0,bl6sbl11l=0,bl6sbl11p=0,
                th1s4l=0,th1s4p=0,th5s9l=0,th5s9p=0,th10s14l=0,th10s14p=0,th15s19l=0,th15s19p=0,th20s24l=0,th20s24p=0,
                th25s29l=0,th25s29p=0,th30s34l=0,th30s34p=0,th35s39l=0,th35s39p=0,th40s44l=0,th40s44p=0,th45s49l=0,th45s49p=0,
                th50s54l=0,th50s54p=0,th55s59l=0,th55s59p=0,th60s64l=0,th60s64p=0,th65s69l=0,th65s69p=0,th70s74l=0,th70s74p=0,
                th75s79l=0,th75s79p=0,th80s84l=0,th80s84p=0,lbth85l=0,lbth85p=0,mati=0;
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='55%' colspan='46'>Jumlah Pasien Hidup dan Mati menurut Golongan Umur & Jenis Kelamin</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='10%' colspan='2'>Pasien Keluar (Hidup & Mati) Menurut Jenis Kelamin</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%' rowspan='3'>Jumlah Pasien Keluar Hidup</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%' rowspan='3'>Jumlah Pasien Keluar Mati</td>"+
                "</tr>"+
                "<tr class='isi'>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>1-7hr</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>8-28hr</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>29hr-<3bl</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>3-<6bl</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>6-11bl</td>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>20-24th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>25-29th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>30-34th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>35-39th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>40-44th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>45-49th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>50-54th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>55-59th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>60-64th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>65-69th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>70-74th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>75-79th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>80-84th</td>"+
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>>=85th</td>"+
            ...
            try {
                ...
                i=1;
                while(rs.next()){
                    hr0s7l=0;hr0s7p=0;hr8s28l=0;hr8s28p=0;hr29sbl3l=0;hr29sbl3p=0;bl3sbl6l=0;bl3sbl6p=0;bl6sbl11l=0;bl6sbl11p=0;
                    th1s4l=0;th1s4p=0;th5s9l=0;th5s9p=0;th10s14l=0;th10s14p=0;th15s19l=0;th15s19p=0;th20s24l=0;th20s24p=0;
                    th25s29l=0;th25s29p=0;th30s34l=0;th30s34p=0;th35s39l=0;th35s39p=0;th40s44l=0;th40s44p=0;th45s49l=0;th45s49p=0;
                    th50s54l=0;th50s54p=0;th55s59l=0;th55s59p=0;th60s64l=0;th60s64p=0;th65s69l=0;th65s69p=0;th70s74l=0;th70s74p=0;
                    th75s79l=0;th75s79p=0;th80s84l=0;th80s84p=0;lbth85l=0;lbth85p=0;mati=0;
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            if(rs2.getString("sttsumur").equals("Hr")){
                                ...
                                }else if((rs2.getInt("umurdaftar")>=8)&&(rs2.getInt("umurdaftar")<=28)){
                                    if(rs2.getString("jk").equals("L")){
                                        hr8s28l++;
                                    }else if(rs2.getString("jk").equals("P")){
                                        hr8s28p++;
                                    }
                                }else if(rs2.getInt("umurdaftar")>=29){
                                    if(rs2.getString("jk").equals("L")){
                                        hr29sbl3l++;
                                    }else if(rs2.getString("jk").equals("P")){
                                        hr29sbl3p++;
                                ...
                                if((rs2.getInt("umurdaftar")>=0)&&(rs2.getInt("umurdaftar")<=3)){
                                    if(rs2.getString("jk").equals("L")){
                                        hr29sbl3l++;
                                    }else if(rs2.getString("jk").equals("P")){
                                        hr29sbl3p++;
                    ...
                    htmlContent.append(
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+hr0s7l+"</td>"+
                            "<td valign='middle' align='center'>"+hr0s7p+"</td>"+
                            "<td valign='middle' align='center'>"+hr8s28l+"</td>"+
                            "<td valign='middle' align='center'>"+hr8s28p+"</td>"+
                            "<td valign='middle' align='center'>"+hr29sbl3l+"</td>"+
                            "<td valign='middle' align='center'>"+hr29sbl3p+"</td>"+
                            "<td valign='middle' align='center'>"+bl3sbl6l+"</td>"+
                            "<td valign='middle' align='center'>"+bl3sbl6p+"</td>"+
                            "<td valign='middle' align='center'>"+bl6sbl11l+"</td>"+
                            "<td valign='middle' align='center'>"+bl6sbl11p+"</td>"+
                            "<td valign='middle' align='center'>"+th1s4l+"</td>"+
                            "<td valign='middle' align='center'>"+th1s4p+"</td>"+
                            "<td valign='middle' align='center'>"+th5s9l+"</td>"+
                            "<td valign='middle' align='center'>"+th5s9p+"</td>"+
                            "<td valign='middle' align='center'>"+th10s14l+"</td>"+
                            "<td valign='middle' align='center'>"+th10s14p+"</td>"+
                            "<td valign='middle' align='center'>"+th15s19l+"</td>"+
                            "<td valign='middle' align='center'>"+th15s19p+"</td>"+
                            "<td valign='middle' align='center'>"+th20s24l+"</td>"+
                            "<td valign='middle' align='center'>"+th20s24p+"</td>"+
                            "<td valign='middle' align='center'>"+th25s29l+"</td>"+
                            "<td valign='middle' align='center'>"+th25s29p+"</td>"+
                            "<td valign='middle' align='center'>"+th30s34l+"</td>"+
                            "<td valign='middle' align='center'>"+th30s34p+"</td>"+
                            "<td valign='middle' align='center'>"+th35s39l+"</td>"+
                            ...
                            "<td valign='middle' align='center'>"+lbth85l+"</td>"+
                            "<td valign='middle' align='center'>"+lbth85p+"</td>"+       
                            "<td valign='middle' align='center'>"+(hr0s7l+hr8s28l+hr29sbl3l+bl3sbl6l+bl6sbl11l+th1s4l+th5s9l+th10s14l+th15s19l+th20s24l+th25s29l+th30s34l+th35s39l+th40s44l+th45s49l+th50s54l+th55s59l+th60s64l+th65s69l+th70s74l+th75s79l+th80s84l+lbth85l)+"</td>"+
                            "<td valign='middle' align='center'>"+(hr0s7p+hr8s28p+hr29sbl3p+bl3sbl6p+bl6sbl11p+th1s4p+th5s9p+th10s14p+th15s19p+th20s24p+th25s29p+th30s34p+th35s39p+th40s44p+th45s49p+th50s54p+th55s59p+th60s64p+th65s69p+th70s74p+th75s79p+th80s84p+lbth85p)+"</td>"+
                            "<td valign='middle' align='center'>"+(-mati)+"</td>"+
