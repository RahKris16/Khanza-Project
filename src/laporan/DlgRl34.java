...
public final class DlgRl34 extends javax.swing.JDialog {
    ...
    public DlgRl34(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","Jenis Pengunjung","Jumlah"};
        ...
        try {
            ps=koneksi.prepareStatement(
                    "SELECT \n" +
                    "  SUM(CASE WHEN rp.status_poli = 'Baru' THEN 1 ELSE 0 END) AS jumlah_baru,\n" +
                    "  SUM(CASE WHEN rp.status_poli = 'Lama' THEN 1 ELSE 0 END) AS jumlah_lama\n" +
                    "FROM reg_periksa rp\n" +
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ RL 3.4 Pengunjung ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        try {
            ...
            while(rs.next()){
                tabMode.addRow(new Object[]{
                    "1","Pengunjung Baru",rs.getInt("jumlah_baru")
                });
                tabMode.addRow(new Object[]{
                    "2","Pengunjung Lama",rs.getInt("jumlah_lama")
                });
                total=rs.getInt("jumlah_baru")+rs.getInt("jumlah_lama");
                tabMode.addRow(new Object[]{
                    "","Total",total
                });
            }
