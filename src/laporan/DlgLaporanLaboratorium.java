...
public class DlgLaporanLaboratorium extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgLaporanLaboratorium(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Laboratorium ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLaporanLaboratorium dialog = new DlgLaporanLaboratorium(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        try {
            ...
            ps=koneksi.prepareStatement(
                    "SELECT periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,date_format(periksa_lab.tgl_periksa,'%d-%m-%Y') as tgl_periksa,penjab.png_jawab,jns_perawatan_lab.nm_perawatan,periksa_lab.biaya,dokter.nm_dokter FROM periksa_lab INNER JOIN reg_periksa ON periksa_lab.no_rawat=reg_periksa.no_rawat INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis INNER JOIN jns_perawatan_lab ON periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw INNER JOIN penjab ON reg_periksa.kd_pj=penjab.kd_pj INNER JOIN dokter ON periksa_lab.kd_dokter=dokter.kd_dokter WHERE periksa_lab.tgl_periksa BETWEEN ? and ? AND penjab.png_jawab like ? AND pasien.nm_pasien LIKE ? AND dokter.nm_dokter LIKE ? order by periksa_lab.tgl_periksa asc");
