...
public final class DlgPelayananPoli extends javax.swing.JDialog {
    ...
    public DlgPelayananPoli(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","No.RM","Nama Pasien","Dokter","Poli","Tanggal Berkas Diterima","Jam Berkas Diterima","Tanggal Pelayanan Poli","Jam Pelayanan Poli","Durasi(m)"};
    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                ...
                "    dokter.nm_dokter,\n" +
                "    poliklinik.nm_poli,\n" +
                "    DATE_FORMAT(mutasi_berkas.diterima, '%Y-%m-%d') AS awal, \n" +
                "    DATE_FORMAT(mutasi_berkas.diterima, '%H:%i:%s') AS awal1, \n" +
                //"    -- Subquery to get the latest 'akhir'\n" +
                "     (SELECT pr.tgl_perawatan \n" +
                ...
                "     ORDER BY pr.tgl_perawatan DESC, pr.jam_rawat DESC\n" +
                "     LIMIT 1) AS akhir1,\n" +
                //"    -- Duration calculation based on 'awal' and 'akhir'\n" +
                "    IF(mutasi_berkas.diterima = '0000-00-00 00:00:00', '', \n" +
                "        ROUND((TIME_TO_SEC(\n" +
                "            CONCAT(\n" +
                "                (SELECT pr.tgl_perawatan \n" +
                "                 FROM pemeriksaan_ralan pr\n" +
                ...
                "                )\n" +
                "            )\n" +
                "        ) - TIME_TO_SEC(DATE_FORMAT(mutasi_berkas.diterima, '%Y-%m-%d %H:%i:%s'))) / 60, 2)\n" +
                "    ) AS durasi\n" +
                "FROM \n" +
                "    reg_periksa\n" +
                ...
                "WHERE \n" +
                "    (\n" +
                "        (reg_periksa.tgl_registrasi BETWEEN ? AND ? AND poliklinik.nm_poli LIKE ?) OR  \n" +
