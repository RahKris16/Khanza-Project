...
public class DlgLaporanRadiologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgLaporanRadiologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"Tanggal","No Rawat","No RM","Nama Pasien","Pengirim","Cara Bayar","Pemeriksaan","Tarif","Dokter"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Radiologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        nmdokter.setPreferredSize(new java.awt.Dimension(199, 23));
        ...
        TCari.setPreferredSize(new java.awt.Dimension(90, 23));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLaporanRadiologi dialog = new DlgLaporanRadiologi(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        try {
            ...
            ps=koneksi.prepareStatement(
                    "SELECT periksa_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,date_format(periksa_radiologi.tgl_periksa,'%d-%m-%Y') as tgl_periksa,penjab.png_jawab,jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.biaya,dokter.nm_dokter FROM periksa_radiologi INNER JOIN reg_periksa ON periksa_radiologi.no_rawat=reg_periksa.no_rawat INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis INNER JOIN jns_perawatan_radiologi ON periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw INNER JOIN penjab ON reg_periksa.kd_pj=penjab.kd_pj INNER JOIN dokter ON periksa_radiologi.kd_dokter=dokter.kd_dokter WHERE periksa_radiologi.tgl_periksa BETWEEN ? and ? AND penjab.png_jawab like ? AND pasien.nm_pasien LIKE ? AND dokter.nm_dokter LIKE ? order by periksa_radiologi.tgl_periksa asc");
            ...
            try {
                ...
                ps.setString(5,"%"+nmdokter.getText()+"%");
                ...
                while(rs.next()){
                    ...
                    if(!kamar.equals("")){
                        namakamar=Sequel.cariIsi("select bangsal.nm_bangsal from bangsal inner join kamar on bangsal.kd_bangsal=kamar.kd_bangsal "+
                    ...
                    tabMode.addRow(new Object[]{
                        rs.getString("tgl_periksa"),rs.getString("no_rawat"),rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),namakamar,rs.getString("png_jawab"),rs.getString("nm_perawatan"),rs.getString("biaya"),rs.getString("nm_dokter")
                    });          
                } 
            } catch (Exception e) {
