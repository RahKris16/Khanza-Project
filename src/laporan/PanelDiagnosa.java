    ...
    private void tampilprosedure() {
        try{
            ...
            psprosedur=koneksi.prepareStatement("select * from icd9 where kode like ? or "+
                    " deskripsi_panjang like ? or  deskripsi_pendek like ? order by kode LIMIT 100");
            try{
...
//                                tbProsedur.getValueAt(i,1).toString(),tbProsedur.getValueAt(i,2).toString(),norawat,norawat
//                            });
//                        }else if(status.equals("Ranap")){
