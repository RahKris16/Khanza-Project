...
public class DlgJumlahResepObat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgJumlahResepObat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"No","No Rawat","Nama Pasien","Nama Dokter","Jumlah","Tanggungan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Jumlah Peresepan Obat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJumlahResepObat dialog = new DlgJumlahResepObat(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        try {
            ...
            ps=koneksi.prepareStatement(
                    "SELECT rp.no_rawat,p2.nm_pasien ,d.nm_dokter,COUNT(DISTINCT rd.kode_brng) as jumlah,p.png_jawab  FROM resep_obat ro  \n" +
                    ...
                    "INNER JOIN pasien p2 on p2.no_rkm_medis =rp.no_rkm_medis \n" +
                    "WHERE rp.status_lanjut='Ralan' AND d.nm_dokter like ? and rp.kd_pj like ? AND ro.tgl_peresepan BETWEEN ? AND ? \n" +
                    "GROUP BY d.nm_dokter,p.png_jawab,rp.no_rawat\n" +
                    "ORDER BY jumlah DESC");                                        
            try {
                ps.setString(1,"%"+nmpenjab.getText().trim()+"%");
                ps.setString(2,"%"+tangg+"%");
