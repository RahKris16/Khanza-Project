...
public final class DlgRl38 extends javax.swing.JDialog {
    ...
    private int i=0,a=0,ttl=0,ttl2=0;   
    ...
    public DlgRl38(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","Jenis Kegiatan","Jumlah Laki-Laki","Jumlah Perempuan"};
        ...
        try {            
            pstindakan=koneksi.prepareStatement("SELECT jns_perawatan_lab.nm_perawatan,SUM(CASE WHEN pasien.jk = 'L' THEN 1 ELSE 0 END) AS jumlah_laki,\n" +
                    "SUM(CASE WHEN pasien.jk = 'P' THEN 1 ELSE 0 END) AS jumlah_perempuan,jns_perawatan_lab.kd_jenis_prw FROM periksa_lab\n" +
            ...
            pstindakan2=koneksi.prepareStatement("select template_laboratorium.Pemeriksaan,SUM(CASE WHEN pasien.jk = 'L' THEN 1 ELSE 0 END) AS jumlah_laki,\n" +
                    "SUM(CASE WHEN pasien.jk = 'P' THEN 1 ELSE 0 END) AS jumlah_perempuan from detail_periksa_lab \n" +
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ RL 3.8 Laboratorium ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        try{   
            ...
            while(rstindakan.next()){
                tabMode.addRow(new Object[]{
                    i,rstindakan.getString(1),rstindakan.getInt(2),rstindakan.getInt(3)
                });
                ...
                pstindakan2.setString(4,rstindakan.getString(4));
                rstindakan2=pstindakan2.executeQuery();
                a=1;
                while(rstindakan2.next()){
                    tabMode.addRow(new Object[]{
                        i+"."+a,rstindakan2.getString(1),rstindakan2.getInt(2),rstindakan2.getInt(3)
                    });
                    ttl=ttl+rstindakan2.getInt(2);
                    ttl2=ttl2+rstindakan2.getInt(3);
                    a++;                    
                }
                ttl=ttl+rstindakan.getInt(2);
                ttl2=ttl2+rstindakan.getInt(3);
                i++;                    
            }
