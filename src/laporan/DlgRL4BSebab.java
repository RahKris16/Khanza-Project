...
public class DlgRL4BSebab extends javax.swing.JDialog {
    ...
    private int hr1s7l=0,hr1s7p=0,hr8s28l=0,hr8s28p=0,hr29s3bll=0,hr29s3blp=0,bl3s6bll=0,bl3s6blp=0,bl6s11bll=0,
                bl6s11blp=0,th1s4l=0,th1s4p=0,th5s9l=0,th5s9p=0,th10s14l=0,th10s14p=0,th15s19l=0,th15s19p=0,
                th20s24l=0,th20s24p=0,th25s29l=0,th25s29p=0,th30s34l=0,th30s34p=0,th35s39l=0,th35s39p=0,th40s44l=0,
                th40s44p=0,th45s49l=0,th45s49p=0,th50s54l=0,th50s54p=0,th55s59l=0,th55s59p=0,th60s64l=0,th60s64p=0,
                th65s69l=0,th65s69p=0,th70s74l=0,th70s74p=0,th75s79l=0,th75s79p=0,th80s84l=0,th80s84p=0,lbth85l=0,lbth85p=0,mati=0;
    ...
    private void prosesCari() {
        ...
        try {
            ...
            try {
                ...
                i=1;
                while(rs.next()){
                    hr1s7l=0;hr1s7p=0;hr8s28l=0;hr8s28p=0;hr29s3bll=0;hr29s3blp=0;th1s4l=0;th1s4p=0;th5s9l=0;th5s9p=0;
                    th10s14l=0;th10s14p=0;th15s19l=0;th15s19p=0;th20s24l=0;th20s24p=0;lbth85l=0;lbth85p=0;mati=0;
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            if(rs2.getString("sttsumur").equals("Hr")){
                                if((rs2.getInt("umurdaftar")>=1)&&(rs2.getInt("umurdaftar")<=7)){
                    ...
                    htmlContent.append(
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' align='center'>"+hr1s7l+"</td>"+
                            "<td valign='middle' align='center'>"+hr1s7p+"</td>"+
                            "<td valign='middle' align='center'>"+hr8s28l+"</td>"+
                            "<td valign='middle' align='center'>"+hr8s28p+"</td>"+
                            "<td valign='middle' align='center'>"+hr29s3bll+"</td>"+
                            "<td valign='middle' align='center'>"+hr29s3blp+"</td>"+
                            ...
                            "<td valign='middle' align='center'>"+(hr1s7l+hr8s28l+hr29s3bll+th1s4l+th5s9l+th10s14l+th15s19l+th20s24l+lbth85l)+"</td>"+
                            "<td valign='middle' align='center'>"+(hr1s7p+hr8s28p+hr29s3blp+th1s4p+th5s9p+th10s14p+th15s19p+th20s24p+lbth85p)+"</td>"+
                            "<td valign='middle' align='center'>"+(hr1s7l+hr8s28l+hr29s3bll+th1s4l+th5s9l+th10s14l+th15s19l+th20s24l+lbth85l+hr1s7p+hr8s28p+hr29s3blp+th1s4p+th5s9p+th10s14p+th15s19p+th20s24p+lbth85p-mati)+"</td>"+
