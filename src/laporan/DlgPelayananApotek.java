    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement(
                ...
                "ROUND(TIMESTAMPDIFF(SECOND,CONCAT(resep_obat.tgl_peresepan, ' ', resep_obat.jam_peresepan),CONCAT(resep_obat.tgl_perawatan, ' ', resep_obat.jam)) / 60, 2) AS durasivalidasi," +
                "ROUND(TIMESTAMPDIFF(SECOND,CONCAT(resep_obat.tgl_perawatan, ' ', resep_obat.jam),CONCAT(resep_obat.tgl_penyerahan, ' ', resep_obat.jam_penyerahan)) / 60, 2) AS durasipenyerahan," +
                "ROUND(TIMESTAMPDIFF(SECOND,CONCAT(resep_obat.tgl_peresepan, ' ', resep_obat.jam_peresepan),CONCAT(resep_obat.tgl_penyerahan, ' ', resep_obat.jam_penyerahan)) / 60, 2) AS durasipelayanan " +
