...
public class DlgBerkasRawat extends javax.swing.JDialog {
    ...
    public DlgBerkasRawat(java.awt.Frame parent, boolean modal, Connection koneksi) {
        super(parent, modal);
                            ...
                            try {
                                if(engine.getLocation().replaceAll("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/","").contains("berkasrawat/pages")){
                                    ...
                                    ps=koneksi.prepareStatement("SELECT berkas_digital_perawatan.lokasi_file "+
                                            ...
                                            "where no_rawat=? order by berkas_digital_perawatan.kode asc");
//                                    ps=koneksi.prepareStatement("SELECT berkas_digital_perawatan.kode,berkas_digital_perawatan.lokasi_file from berkas_digital_perawatan "
//                                            + "inner join master_berkas_digital on berkas_digital_perawatan.kode=master_berkas_digital.kode WHERE berkas_digital_perawatan.no_rawat=? AND (berkas_digital_perawatan.kode='001' OR berkas_digital_perawatan.kode='002' OR berkas_digital_perawatan.kode='003' "
//                                            + "OR berkas_digital_perawatan.kode='004' OR berkas_digital_perawatan.kode='021' OR berkas_digital_perawatan.kode='005' OR berkas_digital_perawatan.kode='006' OR berkas_digital_perawatan.kode='013' OR berkas_digital_perawatan.kode='009' "
//                                            + "OR berkas_digital_perawatan.kode='011' OR berkas_digital_perawatan.kode='014' OR berkas_digital_perawatan.kode='015' OR berkas_digital_perawatan.kode='016' OR berkas_digital_perawatan.kode='017' OR berkas_digital_perawatan.kode='020' "
//                                            + "OR berkas_digital_perawatan.kode='019' OR berkas_digital_perawatan.kode='007' OR berkas_digital_perawatan.kode='008' OR berkas_digital_perawatan.kode='023' OR berkas_digital_perawatan.kode='028' OR berkas_digital_perawatan.kode='029' "
//                                            + "OR berkas_digital_perawatan.kode='030' OR berkas_digital_perawatan.kode='031')");
                                    try {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBerkasRawat dialog = new DlgBerkasRawat(new javax.swing.JFrame(), true, koneksiDB.condb());
