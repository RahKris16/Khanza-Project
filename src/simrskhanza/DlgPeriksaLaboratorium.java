...
public final class DlgPeriksaLaboratorium extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-05-2024" }));
        ...
        PanelInput.add(scrollPane4);
        scrollPane4.setBounds(880, 35, 320, 200);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel4.setText("Catatan :");
        jLabel4.setName("jLabel4"); // NOI18N
        PanelInput.add(jLabel4);
        jLabel4.setBounds(880, 12, 92, 23);
            ...
            for(i=0;i<tbTarif.getRowCount();i++){ 
                if(tbTarif.getValueAt(i,0).toString().equals("true")){
                    if(Sequel.menyimpantf2("periksa_lab","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,'PK'","Kode Pemeriksaan",16,new String[]{
                            ...
                            Sequel.menyimpan("catatan_lab","'"+TNoRw.getText()+"','"+tbTarif.getValueAt(i,1).toString()+"','"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"','"+CmbJam.getSelectedItem()+":"+CmbMenit.getSelectedItem()+":"+CmbDetik.getSelectedItem()+"','"+Catatan.getText()+"'");
                            if(!noorder.equals("")){
