...
public final class DlgRujukMasuk extends javax.swing.JDialog {
    ...
    public DlgRujukMasuk(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row3={"Kategori Rujuk"};
        tabMode3=new DefaultTableModel(null,row3){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbPerujuk1.setModel(tabMode3);
        
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbPerujuk1.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbPerujuk1.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 1; i++) {
            TableColumn column = tbPerujuk1.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(200);
            }
        }
        tbPerujuk1.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        WindowKaRujuk = new javax.swing.JDialog();
        internalFrame7 = new widget.InternalFrame();
        scrollPane3 = new widget.ScrollPane();
        tbPerujuk1 = new widget.Table();
        panelisi3 = new widget.panelisi();
        label11 = new widget.Label();
        TCariPerujuk1 = new widget.TextBox();
        ...
        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-01-2026" }));
        DTPReg.setDisplayFormat("dd-MM-yyyy");
        DTPReg.setName("DTPReg"); // NOI18N
        DTPReg.setOpaque(false);

        WindowKaRujuk.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowKaRujuk.setName("WindowKaRujuk"); // NOI18N
        WindowKaRujuk.setUndecorated(true);
        WindowKaRujuk.setResizable(false);

        internalFrame7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kategori Rujuk ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbPerujuk1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbPerujuk1.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbPerujuk1.setName("tbPerujuk1"); // NOI18N
        tbPerujuk1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbPerujuk1MouseClicked(evt);
            }
        });
        tbPerujuk1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbPerujuk1KeyPressed(evt);
            }
        });
        scrollPane3.setViewportView(tbPerujuk1);

        internalFrame7.add(scrollPane3, java.awt.BorderLayout.CENTER);
        ...
        TCariPerujuk1.setName("TCariPerujuk1"); // NOI18N
        TCariPerujuk1.setPreferredSize(new java.awt.Dimension(312, 23));
        TCariPerujuk1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TCariPerujuk1KeyPressed(evt);
            }
        });
        panelisi3.add(TCariPerujuk1);
        ...
        internalFrame7.add(panelisi3, java.awt.BorderLayout.PAGE_END);

        WindowKaRujuk.getContentPane().add(internalFrame7, java.awt.BorderLayout.CENTER);
...
private void TAlamatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAlamatKeyPressed
    ...
    private void tbPerujuk1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPerujuk1MouseClicked
        if(tabMode3.getRowCount()!=0){
            ...
            WindowKaRujuk.dispose();
        }    
    }//GEN-LAST:event_tbPerujuk1MouseClicked

    private void tbPerujuk1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPerujuk1KeyPressed
        if(tabMode3.getRowCount()!=0){
            if((evt.getKeyCode()==KeyEvent.VK_ENTER)||(evt.getKeyCode()==KeyEvent.VK_UP)||(evt.getKeyCode()==KeyEvent.VK_DOWN)){
                try {
                    getData3();
    ...
    }//GEN-LAST:event_tbPerujuk1KeyPressed

    private void TCariPerujuk1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCariPerujuk1KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            BtnCari1ActionPerformed(null);
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
    ...
    }//GEN-LAST:event_TCariPerujuk1KeyPressed
    ...
    */
    ...
    public widget.TextBox TCariPerujuk1;
    private widget.TextBox TNoRM;
    private widget.TextBox TNoRw;
    private widget.TextBox TPasien;
    private widget.TextBox TRujukan;
    public javax.swing.JDialog WindowKaRujuk;
    ...
    public widget.Table tbPerujuk1;
    ...
    public void tampil() {        
        ...
        try{
            pstampil=koneksi.prepareStatement(
                    ...
                    "rujuk_masuk.keterangan like ? or rujuk_masuk.no_balasan like ? or rujuk_masuk.kd_penyakit like ?) and rujuk_masuk.perujuk<>'-' "+
    ...
    public void tampil2() {        
        ...
        try{
            psperujuk=koneksi.prepareStatement("select rujuk_masuk.perujuk,rujuk_masuk.alamat from rujuk_masuk where "+
                    "rujuk_masuk.perujuk like ? or rujuk_masuk.alamat like ? and rujuk_masuk.perujuk<>'-' "+
    ...
    public void tampil3() {        
        ...
        try{
            psperujuk=koneksi.prepareStatement("select rujuk_masuk.keterangan from rujuk_masuk where "+
                    "rujuk_masuk.keterangan like ? and rujuk_masuk.keterangan<>'-' "+
                    "group by rujuk_masuk.keterangan order by rujuk_masuk.keterangan");
            try {
                psperujuk.setString(1,"%"+TCariPerujuk1.getText()+"%");
                rs=psperujuk.executeQuery();
                while(rs.next()){                              
        ...
        LCount2.setText(""+tabMode3.getRowCount());
    }
    ...
    private void getData3() {
        if(tbPerujuk1.getSelectedRow()!= -1){
            Keterangan.setText(tbPerujuk1.getValueAt(tbPerujuk1.getSelectedRow(),0).toString());
        }
    }
