 ...
 * @author dosen
 */
public final class DlgUbahCatatanLab extends javax.swing.JDialog {
//    private final DefaultTableModel tabMode;
     ...
     * @param parent
     * @param modal */
    public DlgUbahCatatanLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        tbPemeriksaan.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ubah Catatan Laboratorium ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-06-2024" }));
        ...
        panelGlass12.setPreferredSize(new java.awt.Dimension(44, 73));
        ...
        scrollPane4.setBounds(75, 15, 320, 200);
...
//        }
        ...
        Sequel.mengedit("catatan_lab","no_rawat=? and tgl_periksa=? and jam=?","catatan=?",4,new String[]{
            Catatan.getText(),TNoRw.getText(),tanggal,jam
        });
        
        JOptionPane.showMessageDialog(null,"Proses update catatan sudah selesai !!!");
        dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgUbahCatatanLab dialog = new DlgUbahCatatanLab(new javax.swing.JFrame(), true);
    ...
    public void setNoRm(String norwt,String tanggal,String jam) {        
        try {
            ...
            CmbDetik.setSelectedItem(jam.substring(6,8));
            Catatan.setText(Sequel.cariIsi("select catatan from catatan_lab where no_rawat='"+TNoRw.getText()+"' AND tgl_periksa ='"+this.tanggal+"' and jam='"+this.jam+"' "));
//           Sequel.cariIsi("select catatan from catatan_lab where no_rawat=? ",Catatan,TNoRw.getText());
