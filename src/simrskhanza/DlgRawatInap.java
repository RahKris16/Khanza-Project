...
import inventory.DlgPermintaanResepPulang_1;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDrPr,
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan=new DefaultTableModel(null,new Object[]{
            ...
            "Instruksi","Evaluasi","NIP","Dokter/Paramedis","Profesi/Jabatan","Konfirmasi","Status","Hand Over","Status"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
...
//                        KdPeg.requestFocus();                    
    ...
    private void initComponents() {
        ...
        Temporary.setBounds(1045, 10, 165, 23);

        jLabel17.setText("Status Konfirmasi :");
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass12.add(jLabel17);
        jLabel17.setBounds(950, 10, 90, 23);
    ...
    private void DTPTglKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DTPTglKeyPressed
       Valid.pindah(evt,TKdPrwDokterPetugas,cmbJam);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
            ...
            if(kd_pj.equals("BPJ")){
                if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                    ...
                    resep.setNoRm(TNoRw.getText(),DTPTgl.getDate(),cmbJam.getSelectedItem().toString(),cmbMnt.getSelectedItem().toString(),
                            cmbDtk.getSelectedItem().toString(),KdDok2.getText(),TDokter2.getText(),"ranap");
                    resep.isCek();
                    resep.tampilobat();
    ...
    private void BtnCopyResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyResepActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            daftar.isCek();
            daftar.setRM(TNoRw.getText(),TNoRM.getText(),KdDok2.getText(),Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()),"ranap");
            daftar.tampil();
    ...
    private void BtnPermintaanResepPulangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPermintaanResepPulangActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                DlgPermintaanResepPulang_1 resep=new DlgPermintaanResepPulang_1(null,false);
                resep.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                resep.setLocationRelativeTo(internalFrame1);
                resep.setVisible(true);
                resep.setNoRm(TNoRw.getText(),DTPTgl.getDate());
    ...
    private void BtnEdit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEdit1ActionPerformed
        if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
            ...
            switch (TabRawat.getSelectedIndex()) {
                case 1:
                    if(tbPemeriksaan.getSelectedRow()>-1){
                        if(Sequel.cariInteger("Select count(no_rawat) from konfirmasi_pemeriksaan_ranap where no_rawat='"+TNoRw.getText()+"' "+
                            ...
                            Sequel.menyimpan("konfirmasi_pemeriksaan_ranap","'"+TNoRw.getText()+"',"+
                            ...
                            Sequel.queryu2("update konfirmasi_pemeriksaan_ranap set tgl_konfirmasi=?,jam_konfirmasi=?,nip=?,status=? where no_rawat=? and "
    ...
    private void TTinggi_uteriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTinggi_uteriKeyPressed
        Valid.pindah(evt,TKdPrwDokterPetugas,cmbJanin);
                ...
                case 1:
                    if(tbPemeriksaan.getSelectedRow()>-1){
                        if(Sequel.cariInteger("Select count(no_rawat) from konfirmasi_pemeriksaan_ranap where no_rawat='"+TNoRw.getText()+"' "+
                            ...
                            Sequel.queryu2("update konfirmasi_pemeriksaan_ranap set tgl_handover=?,jam_handover=?,nip_handover=?,status2=? where no_rawat=? and "
                                + "tgl_perawatan=? and jam_rawat=?",7,
                                new String[]{
...
//                   "and rawat_inap_dr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
//                   "and rawat_inap_dr.kd_dokter=dokter.kd_dokter "+
//                   "where rawat_inap_dr.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and "+
...
//                    ps.setString(4,"%"+TCariPasien.getText()+"%");
...
//                   "and rawat_inap_pr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
//                   "and rawat_inap_pr.nip=petugas.nip where  "+
//                   "rawat_inap_pr.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and "+
...
//                    ps2.setString(4,"%"+TCariPasien.getText()+"%");
...
//    }
        ...
        try{
            if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                ...
                ps3=koneksi.prepareStatement("select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                   ...
                   "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and rawat_inap_drpr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                   "and rawat_inap_drpr.kd_dokter=dokter.kd_dokter and rawat_inap_drpr.nip=petugas.nip "+
                   "where rawat_inap_drpr.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and "+
    ...
    public void setNoRm(String norwt,Date awal,Date akhir) {
        TNoRw.setText(norwt);
        KdDok2.setText(Sequel.cariIsi("select dpjp_ranap.kd_dokter from dpjp_ranap where dpjp_ranap.no_rawat=?",norwt));
        if(KdDok2.getText().equals("")){
    ...
    private void tampilPemeriksaan() {
        ...
        try{  
            ps4=koneksi.prepareStatement("select pemeriksaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                ...
                "IFNULL(konfir.nama, '') AS nama,IFNULL(konfirmasi_pemeriksaan_ranap.status,'') AS status, "+
                "IFNULL(konfir2.nama, '') AS nama2,IFNULL(konfirmasi_pemeriksaan_ranap.status2,'') AS status2 "+
                "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pemeriksaan_ranap on pemeriksaan_ranap.no_rawat=reg_periksa.no_rawat "+
                "inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik "+
                "left join konfirmasi_pemeriksaan_ranap on konfirmasi_pemeriksaan_ranap.no_rawat=pemeriksaan_ranap.no_rawat and konfirmasi_pemeriksaan_ranap.tgl_perawatan=pemeriksaan_ranap.tgl_perawatan and konfirmasi_pemeriksaan_ranap.jam_rawat=pemeriksaan_ranap.jam_rawat "+
                "LEFT JOIN pegawai AS konfir ON konfirmasi_pemeriksaan_ranap.nip = konfir.nik "+
                "LEFT JOIN pegawai AS konfir2 ON konfirmasi_pemeriksaan_ranap.nip_handover = konfir2.nik where "+
                "pemeriksaan_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) "+
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            if(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),26).toString().equals("Konfirmasi")){
                if(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),28).toString().equals("Hand Over")){
                    Temporary.setText("Konfirmasi & Hand Over");
                }else{
                    Temporary.setText("Konfirmasi");    
                }
            }else if(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),28).toString().equals("")){
                Temporary.setText("");
            }else{
                Temporary.setText("Hand Over");
            }
//            Temporary.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),25).toString());
        ...
        try{
            if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                ...
                ps5=koneksi.prepareStatement("select pemeriksaan_obstetri_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    ...
                    "from pasien inner join reg_periksa inner join pemeriksaan_obstetri_ranap "+
                    "on pemeriksaan_obstetri_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis where  "+
                    "pemeriksaan_obstetri_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_obstetri_ranap.no_rawat like ? or "+
                    "pemeriksaan_obstetri_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and reg_periksa.no_rkm_medis like ? or "+
                    "pemeriksaan_obstetri_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pasien.nm_pasien like ? or  "+
                    "pemeriksaan_obstetri_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_obstetri_ranap.tinggi_uteri like ? or "+
                    "pemeriksaan_obstetri_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_obstetri_ranap.janin like ? or "+
                    "pemeriksaan_obstetri_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_obstetri_ranap.letak like ? "+
            ...
            try {
                if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                    ...
                    ps5.setString(8,"%"+TCariPasien.getText()+"%");
                    ps5.setString(9,"%"+TCariPasien.getText()+"%");
                    ...
                    ps5.setString(13,"%"+TCariPasien.getText()+"%");
                    ps5.setString(14,"%"+TCariPasien.getText()+"%");
                    ...
                    ps5.setString(18,"%"+TCariPasien.getText()+"%");
                    ...
                    ps5.setString(24,"%"+TCariPasien.getText()+"%");
                    ps5.setString(25,"%"+TCari.getText().trim()+"%");
                    ps5.setString(26,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
                    ps5.setString(27,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
                    ps5.setString(28,"%"+TCariPasien.getText()+"%");
                    ps5.setString(29,"%"+TCariPasien.getText()+"%");
                    ps5.setString(30,"%"+TCari.getText().trim()+"%");
                }
    ...
    private void tampilPemeriksaanGinekologi() {
        ...
        try{
            ps6=koneksi.prepareStatement("select pemeriksaan_ginekologi_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    ...
                    "from pasien inner join reg_periksa inner join pemeriksaan_ginekologi_ranap "+
                    "on pemeriksaan_ginekologi_ranap.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis where  "+
                    "pemeriksaan_ginekologi_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_ginekologi_ranap.no_rawat like ? or "+
                    "pemeriksaan_ginekologi_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and reg_periksa.no_rkm_medis like ? or "+
                    "pemeriksaan_ginekologi_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pasien.nm_pasien like ? or  "+
                    "pemeriksaan_ginekologi_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_ginekologi_ranap.inspeksi like ? or "+
                    "pemeriksaan_ginekologi_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_ginekologi_ranap.inspeksi_vulva like ? or "+
                    "pemeriksaan_ginekologi_ranap.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ?) and pemeriksaan_ginekologi_ranap.inspekulo_gine like ? "+
            ...
            try {
                ...
                ps6.setString(9,"%"+TCariPasien.getText()+"%");
                ...
                ps6.setString(14,"%"+TCariPasien.getText()+"%");
                ...
                ps6.setString(24,"%"+TCariPasien.getText()+"%");
                ...
                ps6.setString(29,"%"+TCariPasien.getText()+"%");
