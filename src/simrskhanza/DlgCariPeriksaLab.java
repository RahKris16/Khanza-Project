...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    public DlgCariPeriksaLab(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Rawat","Pasien","Petugas","Tgl.Periksa","Jam Periksa","Dokter Perujuk","Penanggung Jawab","Diagnosa"};
    ...
    private void initComponents() {
        ...
        MnUbah2 = new javax.swing.JMenuItem();
        ...
        MnUbah2.setBackground(new java.awt.Color(255, 255, 254));
        MnUbah2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnUbah2.setForeground(new java.awt.Color(50, 50, 50));
        MnUbah2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnUbah2.setText("Ubah Catatan");
        MnUbah2.setName("MnUbah2"); // NOI18N
        MnUbah2.setPreferredSize(new java.awt.Dimension(190, 26));
        MnUbah2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnUbah2ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnUbah2);
            ...
            try {   
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        param.put("catatan",Sequel.cariIsi("select catatan_lab.catatan from catatan_lab where catatan_lab.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"' and catatan_lab.tgl_periksa='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString()+"' and catatan_lab.jam='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString()+"'"));
...
//            }                
    ...
    private void MnUbah2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUbah2ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
            ...
            DlgUbahCatatanLab ubah=new DlgUbahCatatanLab(null,false);
            ubah.isCek();
            ubah.setNoRm(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString(), 
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString());
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnUbah2ActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnUbah2;
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select periksa_lab.no_rawat,rp.no_rkm_medis,pasien.nm_pasien,petugas.nama,periksa_lab.tgl_periksa,periksa_lab.jam,\n" +
                    "periksa_lab.dokter_perujuk,periksa_lab.kd_dokter,dokter.nm_dokter,penjab.png_jawab,CONCAT(dp.kd_penyakit,\" - \",p.nm_penyakit) as diagnosa \n" +
                    "from periksa_lab \n" +
                    "inner join reg_periksa rp on periksa_lab.no_rawat=rp.no_rawat \n" +
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "inner join dokter on periksa_lab.kd_dokter=dokter.kd_dokter \n" +
                    "left join diagnosa_pasien dp on dp.no_rawat=reg_periksa.no_rawat\n" +
                    "left join penyakit p on p.kd_penyakit =dp.kd_penyakit \n" +
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_rawat"),rs.getString("no_rkm_medis")+" "+rs.getString("nm_pasien")+" ("+kamar+" : "+namakamar+")",
                                                ...
                                                Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",rs.getString("dokter_perujuk")),rs.getString("nm_dokter"),rs.getString("diagnosa")});
