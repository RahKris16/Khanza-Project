...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2023" }));
        ...
        keterangan.setBounds(740, 10, 90, 23);

        ketDiet.setHighlighter(null);
        ketDiet.setName("ketDiet"); // NOI18N
        ketDiet.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ketDietActionPerformed(evt);
            }
        });
        FormInput.add(ketDiet);
        ketDiet.setBounds(840, 10, 243, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TabRawat.getSelectedIndex()==0){
            if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
             ...
             Valid.textKosong(ketDiet,"Keterangan");
            }else{
                if(Sequel.menyimpantf("detail_beri_diet","'"+TNoRw.getText()+"','"+Kamar.getText()+"','"+
                        Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"','"+
                        WaktuDiet.getText()+"','"+
                        KdDiet.getText()+"','"+
                        ketDiet.getText()+"'","data")==true){
                    tabMode.addRow(new String[]{
                        TNoRw.getText(),TPasien.getText(),Ruang.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),WaktuDiet.getText(),JamDiet.getText(),NmDiet.getText(),"-",Kamar.getText(),KdDiet.getText(),ketDiet.getText()
                    });
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void MnLabelDiet1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLabelDiet1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptLabelDiet.jasper","report","::[ Label Diet ]::",
                ...
                "detail_beri_diet.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and detail_beri_diet.waktu like '%"+WaktuDiet2.getText().trim()+"%' and bangsal.nm_bangsal like '%"+NmBangsalCari.getText().trim()+"%' and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                "detail_beri_diet.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and detail_beri_diet.waktu like '%"+WaktuDiet2.getText().trim()+"%' and bangsal.nm_bangsal like '%"+NmBangsalCari.getText().trim()+"%' and bangsal.nm_bangsal like '%"+TCari.getText().trim()+"%' "+
    ...
    private void ketDietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ketDietActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ketDietActionPerformed
    ...
    */
    ...
    private widget.TextBox ketDiet;
