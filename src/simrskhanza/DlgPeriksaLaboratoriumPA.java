...
public final class DlgPeriksaLaboratoriumPA extends javax.swing.JDialog {
    ...
    public DlgPeriksaLaboratoriumPA(java.awt.Frame parent, boolean modal) {
        ...
        noPA.setDocument(new batasInput((byte)15).getKata(noPA));
    ...
    private void initComponents() {
        ...
        Pemeriksaan.setBounds(95, 102, 450, 23);
        ...
        BtnCari1.setBounds(550, 100, 28, 23);
        ...
        btnTarif.setBounds(580, 100, 28, 23);
        ...
        jLabel13.setText("No. PA :");
        jLabel13.setName("jLabel13"); // NOI18N
        PanelInput.add(jLabel13);
        jLabel13.setBounds(580, 100, 92, 23);

        noPA.setHighlighter(null);
        noPA.setName("noPA"); // NOI18N
        noPA.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                noPAKeyPressed(evt);
            }
        });
        PanelInput.add(noPA);
        noPA.setBounds(680, 100, 150, 23);
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
   try{
    ...
    private void noPAKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_noPAKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_noPAKeyPressed
                ...
                for(i=0;i<tbPemeriksaan.getRowCount();i++){ 
                    if(!tbPemeriksaan.getValueAt(i,2).toString().equals("")){  
                        if(Sequel.menyimpantf2("detail_periksa_labpa","?,?,?,?,?,?,?,?,?,?","Pemeriksaan Lab",10,new String[]{
                                ...
                                tbPemeriksaan.getValueAt(i,1).toString(),tbPemeriksaan.getValueAt(i,2).toString(),tbPemeriksaan.getValueAt(i,3).toString(),tbPemeriksaan.getValueAt(i,4).toString(),tbPemeriksaan.getValueAt(i,5).toString(),noPA.getText()
                            })==false){
                            sukses=false;
                        }
                    }                        
