...
public class DlgPasien extends javax.swing.JDialog {
    ...
    public  DlgCariPekerjaan pekerjaanortu=new DlgCariPekerjaan(null,false);
    public  DlgCariPekerjaan pekerjaanpx=new DlgCariPekerjaan(null,false);
    ...
    private String kdkel="",kdkec="",kdkab="",kdprop="",pengurutan="",asalform="",bulan="",tahun="",awalantahun="",awalanbulan="",posisitahun="",
            no_ktp="",tmp_lahir="",nm_ibu="",alamat="",pekerjaan="",no_tlp="",kwn="WNI",ceknik="",
    ...
    public DlgPasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
              ...
              "Id Cacat","Cacat Fisik","Kewarganegaraan","kd_pj","alamat","nm_kel","nm_kec","nm_kab","nm_prop","alamatpj","kelurahanpj",
        ...
        for (z = 0; z < 46; z++) {
            ...
            if(z==0){
                ...
                column.setPreferredWidth(120);
            }else if((z==24)||(z==26)||(z==28)||(z==32)||(z==35)||(z==36)||(z==37)||(z==38)||(z==39)||(z==40)||(z==41)||(z==42)||(z==43)||(z==44)||(z==45)){
        ...
        pekerjaanortu.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPasien")){
                    if(pekerjaanortu.getTable().getSelectedRow()!= -1){
                        PekerjaanPj.setText(pekerjaanortu.getTable().getValueAt(pekerjaanortu.getTable().getSelectedRow(),1).toString());
                    }  
        ...
        pekerjaanpx.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgPasien")){
                    if(pekerjaanpx.getTable().getSelectedRow()!= -1){
                        Pekerjaan.setText(pekerjaanpx.getTable().getValueAt(pekerjaanpx.getTable().getSelectedRow(),1).toString());
                    }  
        ...
        pekerjaanortu.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
        ...
        pekerjaanpx.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-09-2023" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-09-2023" }));
        ...
        Kelurahan.setBounds(690, 222, 152, 23);
        ...
        BtnKelurahan.setBounds(845, 222, 28, 23);
        ...
        PekerjaanPj.setBounds(102, 252, 260, 23);
        ...
        jLabel27.setText("Alamat Domisili :");
        ...
        BtnKelurahanPj.setBounds(845, 312, 28, 23);
        ...
        KelurahanPj.setBounds(690, 312, 152, 23);
        ...
        BtnSuku2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSuku2.setMnemonic('1');
        BtnSuku2.setToolTipText("ALt+1");
        BtnSuku2.setName("BtnSuku2"); // NOI18N
        BtnSuku2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSuku2ActionPerformed(evt);
            }
        });
        BtnSuku2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnSuku2KeyPressed(evt);
            }
        });
        FormInput.add(BtnSuku2);
        BtnSuku2.setBounds(645, 130, 28, 23);
        ...
        FormInput.add(BtnSuku1);
        BtnSuku1.setBounds(364, 250, 28, 23);
        ...
        nmgolongantni.setBounds(110, 420, 250, 23);
        ...
        nmsatuantni.setBounds(110, 450, 250, 23);
        ...
        nmpangkattni.setBounds(110, 480, 250, 23);
        ...
        nmjabatantni.setBounds(110, 510, 250, 23);
        ...
        BtnGolonganPolri.setBounds(850, 420, 28, 23);
        ...
        BtnPangkatPolri.setBounds(850, 480, 28, 23);
        ...
        BtnPropinsi.setBounds(651, 192, 28, 23);
        ...
        Propinsi.setBounds(496, 192, 152, 23);
        ...
        PropinsiPj.setBounds(496, 282, 152, 23);
        ...
        btnPropinsiPj.setBounds(651, 282, 28, 23);
        ...
        FormInput.add(R9);
        R9.setBounds(610, 370, 100, 23);

        jLabel43.setText("Kewarganegaraan :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(400, 370, 95, 23);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Sequel.cariInteger("select COUNT(no_ktp) from pasien where no_ktp=?",TKtp.getText())>0){
            JOptionPane.showMessageDialog(TKtp,"Data KTP sudah terdaftar di sistem!"); 
        }else{ 
        if(TNo.getText().trim().equals("")){
        ...
        }else if(TNoPeserta.getText().trim().length()>13&&Kdpnj.getText().trim().equals("BPJ")){
            Valid.textKosong(TNoPeserta,"No Peserta BPJS maksimal 13 karakter");            
        }else if(TNoPeserta.getText().trim().length()<13&&Kdpnj.getText().trim().equals("BPJ")){
            Valid.textKosong(TNoPeserta,"No Peserta BPJS minimal 13 karakter");          
            ...
            if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",37,new String[]{
                    ...
                    kdsuku.getText(),kdbahasa.getText(),kdcacat.getText(),EMail.getText(),NIP.getText(),kdprop,PropinsiPj.getText(),kwn
                })==true){
...
private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNo.getText().trim().equals("")){
            ...
            if(Sequel.mengedittf("pasien","no_rkm_medis=?","no_rkm_medis=?,nm_pasien=?,no_ktp=?,jk=?,tmp_lahir=?,"+
                ...
                "cacat_fisik=?,email=?,nip=?,kd_prop=?,propinsipj=?,kewarganegaraan=?",38,
                new String[]{TNo.getText(),TNm.getText(),TKtp.getText(),CmbJk.getSelectedItem().toString().substring(0,1),TTmp.getText(),
                    ...
                    kdprop,PropinsiPj.getText(),kwn,Kd2.getText()
            })==true){
                if(chkTNI.isSelected()==true){
                ...
                if(tbPasien.getSelectedRow()>-1){
                    ...
                    tbPasien.setValueAt(kwn,tbPasien.getSelectedRow(), 34);
                    tbPasien.setValueAt(Kdpnj.getText(),tbPasien.getSelectedRow(), 35);
                    tbPasien.setValueAt(Alamat.getText(),tbPasien.getSelectedRow(), 36);
                    tbPasien.setValueAt(Kelurahan.getText(),tbPasien.getSelectedRow(), 37);
                    tbPasien.setValueAt(Kecamatan.getText(),tbPasien.getSelectedRow(), 38);
                    tbPasien.setValueAt(Kabupaten.getText(),tbPasien.getSelectedRow(), 39);
                    tbPasien.setValueAt(Propinsi.getText(),tbPasien.getSelectedRow(), 40);
                    tbPasien.setValueAt(AlamatPj.getText(),tbPasien.getSelectedRow(), 41);
                    tbPasien.setValueAt(KelurahanPj.getText(),tbPasien.getSelectedRow(), 42);
                    tbPasien.setValueAt(KecamatanPj.getText(),tbPasien.getSelectedRow(), 43);
                    tbPasien.setValueAt(KabupatenPj.getText(),tbPasien.getSelectedRow(), 44);
                    tbPasien.setValueAt(PropinsiPj.getText(),tbPasien.getSelectedRow(), 45);
                }
...
//                   "inner join penjab inner join propinsi on pasien.kd_prop=propinsi.kd_prop and pasien.kd_pj=penjab.kd_pj and pasien.kd_kel=kelurahan.kd_kel "+
//                   "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where pasien.no_rkm_medis='"+TNo.getText()+"' ",param);
            Valid.MyReportqry("rptBarcodeRM20.jasper","report","::[ Label Rekam Medis ]::",
                "select p.no_rkm_medis, p.nm_pasien,p.jk,p.tgl_lahir,p.umur,p2.png_jawab\n" +
                "from reg_periksa rp\n" +
                "inner join pasien p on p.no_rkm_medis=rp.no_rkm_medis\n" +
                "inner join penjab p2 on p2.kd_pj =rp.kd_pj \n" +
                "where p.no_rkm_medis='"+TNo.getText()+"' ",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void BtnSuku1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSuku1ActionPerformed
        akses.setform("DlgPasien");
        pekerjaanortu.isCek();
        pekerjaanortu.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        pekerjaanortu.setLocationRelativeTo(internalFrame1);
        pekerjaanortu.setVisible(true);
    ...
    private void BtnSuku2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSuku2ActionPerformed
        akses.setform("DlgPasien");
        pekerjaanpx.isCek();
        pekerjaanpx.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        pekerjaanpx.setLocationRelativeTo(internalFrame1);
        pekerjaanpx.setVisible(true);
    }//GEN-LAST:event_BtnSuku2ActionPerformed

    private void BtnSuku2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSuku2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSuku2KeyPressed
    ...
    private widget.Button BtnSuku2;
            ...
            if(cmbHlm.getSelectedItem().toString().equals("Semua")){
                 if(Carialamat.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                      ps=koneksi.prepareStatement("select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                           ...
                           "perusahaan_pasien.kode_perusahaan,perusahaan_pasien.nama_perusahaan,pasien.bahasa_pasien,"+
                           "bahasa_pasien.nama_bahasa,pasien.suku_bangsa,suku_bangsa.nama_suku_bangsa,pasien.nip,pasien.email,cacat_fisik.nama_cacat,pasien.cacat_fisik,pasien.kewarganegaraan,pasien.kd_pj from pasien "+
                           "inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec "+
                           "inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab inner join perusahaan_pasien on perusahaan_pasien.kode_perusahaan=pasien.perusahaan_pasien "+
                           "inner join cacat_fisik on pasien.cacat_fisik=cacat_fisik.id inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                           "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien inner join suku_bangsa on suku_bangsa.id=pasien.suku_bangsa "+
            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("nama_cacat"),rs.getString("kewarganegaraan"),rs.getString("kd_pj"),rs.getString("alamat"),rs.getString("nm_kel"),rs.getString("nm_kec"),
    ...
    private void getData() {
        if(tbPasien.getSelectedRow()!= -1){                
            try {                
                ...
                switch (tbPasien.getValueAt(tbPasien.getSelectedRow(),34).toString()) {
                    case "WNI":
                        R7.setSelected(true);
                        break;
                    case "WNA":
                ...
                Alamat.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),36).toString());
                Kelurahan.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),37).toString());
                Kecamatan.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),38).toString());
                Kabupaten.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),39).toString());
                Propinsi.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),40).toString());
                AlamatPj.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),41).toString());
                KelurahanPj.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),42).toString());
                KecamatanPj.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),43).toString());
                KabupatenPj.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),44).toString());
                PropinsiPj.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),45).toString());
