...
import rekammedis.RMCariPemeriksaanIGD;
...
public class DlgTagihanOperasi extends javax.swing.JDialog {
    ...
    private String[] kode_paket, nm_perawatan,kategori,kd_obat,nm_obat, satuan, kelas1;
    ...
    public DlgTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        Jaringan.setDocument(new batasInput((int)200).getKata(Jaringan));
        ...
        caripemeriksaan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(caripemeriksaan.getTable().getSelectedRow()!= -1){
                    Laporan.append(caripemeriksaan.getTable().getValueAt(caripemeriksaan.getTable().getSelectedRow(),2).toString()+", ");
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(89, 576));
        ...
        BtnDokter7.setBounds(830, 430, 28, 23);

        jLabel11.setText("Prosedur Tindakan :");
        ...
        Prosedur.setBounds(148, 520, 256, 23);
    ...
    private void tampil() {  
        ...
        try{
            ...
            pstindakan3=koneksi.prepareStatement("select kode_paket, nm_perawatan,kategori, operator1, operator2, operator3, "+
                   ...
                   "akomodasi+bagian_rs+omloop+omloop2+omloop3+omloop4+omloop5+sarpras+dokter_pjanak+dokter_umum) as jumlah "+
                   "from paket_operasi "+
                    "where paket_operasi.status='1' and kd_pj=? and (kelas=? or kelas='-') and kode_paket like ? or "+
                   "paket_operasi.status='1' and kd_pj=? and (kelas=? or kelas='-') and nm_perawatan like ? order by kelas desc ");
            pstindakan4=koneksi.prepareStatement("select kode_paket, nm_perawatan,kategori, operator1, operator2, operator3, "+
                   ...
                   "akomodasi+bagian_rs+omloop+omloop2+omloop3+omloop4+omloop5+sarpras+dokter_pjanak+dokter_umum) as jumlah "+
                   "from paket_operasi "+
                   "where status='1' and kelas=? and kode_paket like ? or "+
                   "status='1' and kelas=? and nm_perawatan like ? order by nm_perawatan ");
