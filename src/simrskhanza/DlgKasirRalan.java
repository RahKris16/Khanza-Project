...
import rekammedis.RMDataProtokol;
...
import rekammedis.RMRalanKFR;
import rekammedis.RMProgramTerapi;
...
import inventory.DlgPeresepanDokter_Ortho1;
import inventory.DlgPeresepanDokter_Ortho2;
import inventory.DlgPeresepanDokter_Ortho3;
import inventory.DlgPeresepanDokter_Ortho4;
import inventory.DlgPeresepanDokter_Ortho5;
import inventory.DlgPeresepanDokter_Interna1;
import inventory.DlgPeresepanDokter_Interna2;
import inventory.DlgPeresepanDokter_Interna3;
import inventory.DlgPeresepanDokter_Interna4;
import inventory.DlgPeresepanDokter_Interna5;
...
//            order="reg_periksa.no_rawat desc",
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "No.Telp Pasien","Catatan Pasien","Akun Piutang","Piutang"}){
    ...
    private void initComponents() {
        ...
        MnRehabMedis = new javax.swing.JMenu();
        MnRawatJalanKFR = new javax.swing.JMenuItem();
        MnProgramTerapi = new javax.swing.JMenuItem();
        MnKonfirmasiPT = new javax.swing.JMenuItem();
        ...
        MnObservasiHemodialisa = new javax.swing.JMenuItem();
        ...
        MnObatRalan1 = new javax.swing.JMenu();
        MnObatRalan2 = new javax.swing.JMenu();
        MnResepDOkter3 = new javax.swing.JMenuItem();
        MnResepDOkter6 = new javax.swing.JMenuItem();
        MnResepDOkter7 = new javax.swing.JMenuItem();
        MnResepDOkter8 = new javax.swing.JMenuItem();
        MnResepDOkter9 = new javax.swing.JMenuItem();
        MnObatRalan3 = new javax.swing.JMenu();
        MnResepDOkter4 = new javax.swing.JMenuItem();
        MnResepDOkter10 = new javax.swing.JMenuItem();
        MnResepDOkter11 = new javax.swing.JMenuItem();
        MnResepDOkter12 = new javax.swing.JMenuItem();
        MnResepDOkter13 = new javax.swing.JMenuItem();
        MnProtokol = new javax.swing.JMenuItem();
        ...
        MnProtokol1 = new javax.swing.JMenuItem();
        ...
        MnRehabMedis.setBackground(new java.awt.Color(255, 255, 254));
        MnRehabMedis.setForeground(new java.awt.Color(50, 50, 50));
        MnRehabMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRehabMedis.setText("Rehab Medis");
        MnRehabMedis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRehabMedis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRehabMedis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRehabMedis.setName("MnRehabMedis"); // NOI18N
        MnRehabMedis.setPreferredSize(new java.awt.Dimension(180, 26));

        MnRawatJalanKFR.setBackground(new java.awt.Color(255, 255, 254));
        MnRawatJalanKFR.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnRawatJalanKFR.setForeground(new java.awt.Color(50, 50, 50));
        MnRawatJalanKFR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnRawatJalanKFR.setText("Rawat Jalan KFR");
        MnRawatJalanKFR.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnRawatJalanKFR.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnRawatJalanKFR.setName("MnRawatJalanKFR"); // NOI18N
        MnRawatJalanKFR.setPreferredSize(new java.awt.Dimension(310, 26));
        MnRawatJalanKFR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnRawatJalanKFRActionPerformed(evt);
            }
        });
        MnRehabMedis.add(MnRawatJalanKFR);
        ...
        MnRehabMedis.add(MnProgramTerapi);

        MnKonfirmasiPT.setBackground(new java.awt.Color(255, 255, 254));
        MnKonfirmasiPT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKonfirmasiPT.setForeground(new java.awt.Color(50, 50, 50));
        MnKonfirmasiPT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnKonfirmasiPT.setText("Konfirmasi Program");
        MnKonfirmasiPT.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnKonfirmasiPT.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnKonfirmasiPT.setName("MnKonfirmasiPT"); // NOI18N
        MnKonfirmasiPT.setPreferredSize(new java.awt.Dimension(310, 26));
        MnKonfirmasiPT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKonfirmasiPTActionPerformed(evt);
            }
        });
        MnRehabMedis.add(MnKonfirmasiPT);

        MnRMRawatJalan.add(MnRehabMedis);
        ...
        MnObservasiHemodialisa.setBackground(new java.awt.Color(255, 255, 254));
        MnObservasiHemodialisa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnObservasiHemodialisa.setForeground(new java.awt.Color(50, 50, 50));
        MnObservasiHemodialisa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnObservasiHemodialisa.setText("Observasi Hemodialisa");
        MnObservasiHemodialisa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnObservasiHemodialisa.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnObservasiHemodialisa.setName("MnObservasiHemodialisa"); // NOI18N
        MnObservasiHemodialisa.setPreferredSize(new java.awt.Dimension(210, 26));
        MnObservasiHemodialisa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnObservasiHemodialisaActionPerformed(evt);
            }
        });
        MnRMCatatanMonitoring.add(MnObservasiHemodialisa);
        ...
        MnObatRalan1.setBackground(new java.awt.Color(255, 255, 254));
        MnObatRalan1.setForeground(new java.awt.Color(50, 50, 50));
        MnObatRalan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnObatRalan1.setText("Paket Obat");
        MnObatRalan1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnObatRalan1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnObatRalan1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnObatRalan1.setName("MnObatRalan1"); // NOI18N
        MnObatRalan1.setPreferredSize(new java.awt.Dimension(200, 26));

        MnObatRalan2.setBackground(new java.awt.Color(255, 255, 254));
        MnObatRalan2.setForeground(new java.awt.Color(50, 50, 50));
        MnObatRalan2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnObatRalan2.setText("Paket Orthopedi");
        MnObatRalan2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnObatRalan2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnObatRalan2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnObatRalan2.setName("MnObatRalan2"); // NOI18N
        MnObatRalan2.setPreferredSize(new java.awt.Dimension(200, 26));

        MnResepDOkter3.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter3.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter3.setText("Orthopedi 1");
        MnResepDOkter3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter3.setName("MnResepDOkter3"); // NOI18N
        MnResepDOkter3.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter3ActionPerformed(evt);
            }
        });
        MnObatRalan2.add(MnResepDOkter3);

        MnResepDOkter6.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter6.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter6.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter6.setText("Orthopedi 2");
        MnResepDOkter6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter6.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter6.setName("MnResepDOkter6"); // NOI18N
        MnResepDOkter6.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter6ActionPerformed(evt);
            }
        });
        MnObatRalan2.add(MnResepDOkter6);

        MnResepDOkter7.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter7.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter7.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter7.setText("Orthopedi 3");
        MnResepDOkter7.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter7.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter7.setName("MnResepDOkter7"); // NOI18N
        MnResepDOkter7.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter7ActionPerformed(evt);
            }
        });
        MnObatRalan2.add(MnResepDOkter7);

        MnResepDOkter8.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter8.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter8.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter8.setText("Orthopedi 4");
        MnResepDOkter8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter8.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter8.setName("MnResepDOkter8"); // NOI18N
        MnResepDOkter8.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter8ActionPerformed(evt);
            }
        });
        MnObatRalan2.add(MnResepDOkter8);

        MnResepDOkter9.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter9.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter9.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter9.setText("Orthopedi 5");
        MnResepDOkter9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter9.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter9.setName("MnResepDOkter9"); // NOI18N
        MnResepDOkter9.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter9ActionPerformed(evt);
            }
        });
        MnObatRalan2.add(MnResepDOkter9);

        MnObatRalan1.add(MnObatRalan2);

        MnObatRalan3.setBackground(new java.awt.Color(255, 255, 254));
        MnObatRalan3.setForeground(new java.awt.Color(50, 50, 50));
        MnObatRalan3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnObatRalan3.setText("Paket Interna");
        MnObatRalan3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnObatRalan3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnObatRalan3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnObatRalan3.setName("MnObatRalan3"); // NOI18N
        MnObatRalan3.setPreferredSize(new java.awt.Dimension(200, 26));

        MnResepDOkter4.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter4.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter4.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter4.setText("Interna 1");
        MnResepDOkter4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter4.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter4.setName("MnResepDOkter4"); // NOI18N
        MnResepDOkter4.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter4ActionPerformed(evt);
            }
        });
        MnObatRalan3.add(MnResepDOkter4);

        MnResepDOkter10.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter10.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter10.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter10.setText("Interna 2");
        MnResepDOkter10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter10.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter10.setName("MnResepDOkter10"); // NOI18N
        MnResepDOkter10.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter10ActionPerformed(evt);
            }
        });
        MnObatRalan3.add(MnResepDOkter10);

        MnResepDOkter11.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter11.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter11.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter11.setText("Interna 3");
        MnResepDOkter11.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter11.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter11.setName("MnResepDOkter11"); // NOI18N
        MnResepDOkter11.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter11ActionPerformed(evt);
            }
        });
        MnObatRalan3.add(MnResepDOkter11);

        MnResepDOkter12.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter12.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter12.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter12.setText("Interna 4");
        MnResepDOkter12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter12.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter12.setName("MnResepDOkter12"); // NOI18N
        MnResepDOkter12.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter12ActionPerformed(evt);
            }
        });
        MnObatRalan3.add(MnResepDOkter12);

        MnResepDOkter13.setBackground(new java.awt.Color(255, 255, 254));
        MnResepDOkter13.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnResepDOkter13.setForeground(new java.awt.Color(50, 50, 50));
        MnResepDOkter13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnResepDOkter13.setText("Interna 5");
        MnResepDOkter13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnResepDOkter13.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnResepDOkter13.setName("MnResepDOkter13"); // NOI18N
        MnResepDOkter13.setPreferredSize(new java.awt.Dimension(200, 26));
        MnResepDOkter13.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnResepDOkter13ActionPerformed(evt);
            }
        });
        MnObatRalan3.add(MnResepDOkter13);

        MnObatRalan1.add(MnObatRalan3);

        MnObatRalan.add(MnObatRalan1);

        jPopupMenu1.add(MnObatRalan);

        MnProtokol.setBackground(new java.awt.Color(255, 255, 254));
        MnProtokol.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnProtokol.setForeground(new java.awt.Color(50, 50, 50));
        MnProtokol.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnProtokol.setText("Protokol Terapi Obat Khusus");
        MnProtokol.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnProtokol.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnProtokol.setName("MnProtokol"); // NOI18N
        MnProtokol.setPreferredSize(new java.awt.Dimension(200, 26));
        MnProtokol.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnProtokolActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnProtokol);
        ...
        MnProtokol1.setBackground(new java.awt.Color(255, 255, 254));
        MnProtokol1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnProtokol1.setForeground(new java.awt.Color(50, 50, 50));
        MnProtokol1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnProtokol1.setText("Protokol Terapi Obat Khusus");
        MnProtokol1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnProtokol1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnProtokol1.setName("MnProtokol1"); // NOI18N
        MnProtokol1.setPreferredSize(new java.awt.Dimension(200, 26));
        MnProtokol1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnProtokol1ActionPerformed(evt);
            }
        });
        MnObat1.add(MnProtokol1);
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(tbKasirRalan.getSelectedRow()!= -1){
                        ...
                        Sequel.queryu("insert into antripoli values('"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString()+"','"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),18).toString()+"','1','"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),11).toString()+"','"+tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),14).toString()+"')");
                    }
                } 
            }                               
        }
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),10).toString().equals("Batal")){
                    ...
                    if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                        ...
                        kamarinap.isCek();
                        kamarinap.Pj(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),17).toString());
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void ppCatatanPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCatatanPasienBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                catatan.setNoRm(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),11).toString());
        ...
        if(TNoRw.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),17).toString().equals("BPJ")){
                        if(jmlparsial>0){
        ...
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    form.Pj(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),17).toString());
    ...
    private void MnProtokolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnProtokolActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            //TNoReg.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMDataProtokol protokol=new RMDataProtokol(null,false);
                protokol.isCek();
                protokol.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                protokol.setLocationRelativeTo(internalFrame1);
                protokol.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                protokol.tampil();
                protokol.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MnProtokolActionPerformed

    private void MnProtokol1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnProtokol1ActionPerformed
        if(tabModekasir2.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
            if(tbKasirRalan2.getSelectedRow()>-1){
                ...
                protokol.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                protokol.setLocationRelativeTo(internalFrame1);
                protokol.setNoRm2(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString(),DTPCari2.getDate());
                protokol.tampil();
                protokol.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MnProtokol1ActionPerformed
    ...
    private void ppResume1BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppResume1BtnPrintActionPerformed
        if(tabModekasir2.getRowCount()==0){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                ...
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
                resume.setNoRm(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString(),DTPCari2.getDate());
                resume.tampil();
                resume.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
    ...
    private void MnDoABtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDoABtnPrintActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                Valid.editTable(tabModekasir,"reg_periksa","no_rawat",TNoRw,"stts='Death on Arrival'");
                if(tbKasirRalan.getSelectedRow()>-1){
                    tabModekasir.setValueAt("Death on Arrival",tbKasirRalan.getSelectedRow(),10);
                }
            }
        }
    }//GEN-LAST:event_MnDoABtnPrintActionPerformed

    private void MnResepDOkter3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter3ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Ortho1 resep=new DlgPeresepanDokter_Ortho1(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter3ActionPerformed

    private void MnResepDOkter4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter4ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Interna1 resep=new DlgPeresepanDokter_Interna1(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter4ActionPerformed

    private void MnResepDOkter6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter6ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Ortho2 resep=new DlgPeresepanDokter_Ortho2(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter6ActionPerformed

    private void MnResepDOkter7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter7ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Ortho3 resep=new DlgPeresepanDokter_Ortho3(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter7ActionPerformed

    private void MnResepDOkter8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter8ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Ortho4 resep=new DlgPeresepanDokter_Ortho4(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter8ActionPerformed

    private void MnResepDOkter9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter9ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Ortho5 resep=new DlgPeresepanDokter_Ortho5(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter9ActionPerformed

    private void MnResepDOkter10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter10ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Interna2 resep=new DlgPeresepanDokter_Interna2(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter10ActionPerformed

    private void MnResepDOkter11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter11ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Interna3 resep=new DlgPeresepanDokter_Interna3(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter11ActionPerformed

    private void MnResepDOkter12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter12ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Interna4 resep=new DlgPeresepanDokter_Interna4(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter12ActionPerformed

    private void MnResepDOkter13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnResepDOkter13ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                    ...
                    if(jmlparsial>0){
                        DlgPeresepanDokter_Interna5 resep=new DlgPeresepanDokter_Interna5(null,false);
                        resep.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.setNoRm(TNoRw.getText(),new Date(),Jam.getText().substring(0,2),Jam.getText().substring(3,5),Jam.getText().substring(6,8),
                                tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
...
//                                    tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),0).toString(),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),1).toString(),"ralan");
    ...
    }//GEN-LAST:event_MnResepDOkter13ActionPerformed

    private void MnRawatJalanKFRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRawatJalanKFRActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
        }else if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMRalanKFR form=new RMRalanKFR(null,false);
                form.isCek();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
                form.setVisible(true);
                form.emptTeks();
                form.setNoRm(TNoRwCari.getText(),TNoRMCari.getText(),TPasienCari.getText(),DTPCari2.getDate());
                form.tampil();
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MnRawatJalanKFRActionPerformed
    ...
    private void MnProgramTerapiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnProgramTerapiActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMProgramTerapi form=new RMProgramTerapi(null,false);
                form.isCek();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
                form.setVisible(true);
    ...
    private void MnObservasiHemodialisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnObservasiHemodialisaActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else if(TNoRw.getText().trim().equals("")){
    ...
    }//GEN-LAST:event_MnObservasiHemodialisaActionPerformed
    ...
    private void MnKonfirmasiPTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKonfirmasiPTActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
        }else if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
    ...
    }//GEN-LAST:event_MnKonfirmasiPTActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnKonfirmasiPT;
    ...
    private javax.swing.JMenu MnObatRalan1;
    private javax.swing.JMenu MnObatRalan2;
    private javax.swing.JMenu MnObatRalan3;
    private javax.swing.JMenuItem MnObservasiHemodialisa;
    ...
    private javax.swing.JMenuItem MnProtokol;
    private javax.swing.JMenuItem MnProtokol1;
    ...
    private javax.swing.JMenuItem MnRawatJalanKFR;
    private javax.swing.JMenu MnRehabMedis;
    ...
    private javax.swing.JMenuItem MnResepDOkter10;
    private javax.swing.JMenuItem MnResepDOkter11;
    private javax.swing.JMenuItem MnResepDOkter12;
    private javax.swing.JMenuItem MnResepDOkter13;
    private javax.swing.JMenuItem MnResepDOkter3;
    private javax.swing.JMenuItem MnResepDOkter4;
    private javax.swing.JMenuItem MnResepDOkter6;
    private javax.swing.JMenuItem MnResepDOkter7;
    private javax.swing.JMenuItem MnResepDOkter8;
    private javax.swing.JMenuItem MnResepDOkter9;
    ...
    private void tampilkasir() {     
        ...
        try{   
            semua=caripenjab.equals("")&&CrPoli.getText().trim().equals("")&&CrPtg.getText().trim().equals("")&&cmbStatus.getSelectedItem().toString().equals("Semua")&&cmbStatusBayar.getSelectedItem().toString().equals("Semua")&&TCari.getText().trim().equals("");
//            modifikasi jkn
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') as tgl_registrasi,reg_periksa.jam_reg," +
                "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli," +
                "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur," +
...
//                "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli," +
//                "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur," +
//                "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp,cp.catatan,pp.status,dpp.nama_bayar " +
//                "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis " +
//                "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli " +
//                "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj " +
//                "LEFT join catatan_pasien cp on cp.no_rkm_medis =reg_periksa.no_rawat "+
//                "left join detail_piutang_pasien dpp on dpp.no_rawat=reg_periksa.no_rawat "+
//                "left join piutang_pasien pp on pp.no_rawat=reg_periksa.no_rawat where "+
...
//                "order by "+order);
            try{
                ...
                while(rskasir.next()){
                    tabModekasir.addRow(new String[] {
                        ...
                        rskasir.getString("kd_pj"),rskasir.getString("kd_poli"),rskasir.getString("no_tlp"),rskasir.getString("catatan"),
                        rskasir.getString("status"),rskasir.getString("nama_bayar")
                    });
                }                
            } catch(Exception e){
    ...
    private void tampilkasir2() {                   
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_rawat,DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') as tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,reg_periksa.kd_pj,pasien.no_tlp,cp.catatan "+
                ...
                "inner join poliklinik on rujukan_internal_poli.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj LEFT join catatan_pasien cp on cp.no_rkm_medis=reg_periksa.no_rawat "+
    ...
    private void getDatakasir() {
        ...
        }//else if(tbKasirRalan2.getSelectedRow()!= -1){
            //TNoRw2.setText(tbKasirRalan2.getValueAt(tbKasirRalan2.getSelectedRow(),10).toString());
            //Tanggal.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),12).toString());
            //Jam.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),13).toString());
            //TNoRwCari.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),11).toString());
            //TNoReg.setText(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),14).toString());
    ...
    public void isCek(){
        ...
        MnRiwayatPerawatanICareNoKartu.setEnabled(akses.getresume_pasien());
        MnRiwayatPerawatanICareNIK.setEnabled(akses.getresume_pasien());
