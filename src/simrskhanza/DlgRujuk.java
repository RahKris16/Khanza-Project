...
public final class DlgRujuk extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ket2 = new widget.TextBox();
        jLabel24 = new widget.Label();
        TTmpRujuk2 = new widget.TextBox();
        TNoRj3 = new widget.TextBox();
        TTmpRujuk3 = new widget.TextBox();
        TNoRj4 = new widget.TextBox();
        TNoRj5 = new widget.TextBox();
        TTmpRujuk4 = new widget.TextBox();
        ket3 = new widget.TextBox();
        jLabel25 = new widget.Label();
        ket4 = new widget.TextBox();
        ...
        FormInput.add(TNoRj);
        TNoRj.setBounds(93, 40, 100, 23);

        jLabel8.setText("Tanggal :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 130, 72, 23);
        ...
        TTmpRujuk.setBounds(93, 70, 100, 23);
        ...
        TDiagnosa.setBounds(80, 500, 282, 23);

        jLabel9.setText("Diagnosa :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(10, 500, 72, 23);
        ...
        TPasien.setBounds(358, 10, 380, 23);

        DTPRujuk.setForeground(new java.awt.Color(50, 70, 50));
        DTPRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-01-2024" }));
        ...
        DTPRujuk.setBounds(75, 130, 100, 23);
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(236, 10, 120, 23);

        jLabel5.setText("Dokter :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(10, 530, 72, 23);
        ...
        btnDokter.setBounds(360, 530, 28, 23);
        ...
        TDokter.setBounds(180, 530, 180, 23);

        jLabel13.setText(" Kategori Rujuk :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(420, 500, 90, 23);

        jLabel14.setText(" Ambulance :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(420, 530, 90, 23);

        jLabel15.setText("Tujuan :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(360, 40, 90, 23);
        ...
        FormInput.add(ket);
        ket.setBounds(452, 40, 285, 23);

        jLabel11.setText("Jam :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(190, 130, 40, 23);
        ...
        CmbJam.setBounds(240, 130, 62, 23);
        ...
        CmbMenit.setBounds(300, 130, 62, 23);
        ...
        ambulance.setBounds(520, 530, 170, 23);
        ...
        ChkJln.setBounds(430, 130, 23, 23);
        ...
        CmbDetik.setBounds(370, 130, 62, 23);
        ...
        ktrujuk.setBounds(520, 500, 170, 23);
        ...
        btnDiagnosa.setBounds(360, 500, 28, 23);
        ...
        TNoRj1.setBounds(195, 40, 182, 23);
        ...
        TNoRj2.setBounds(195, 70, 182, 23);

        jLabel16.setText("DPJP :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(360, 70, 90, 23);
        ...
        FormInput.add(ket1);
        ket1.setBounds(452, 70, 100, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("Jarak tempuh ke rumah sakit rujukan  :");
        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(10, 160, 230, 23);
        ...
        TTmpRujuk1.setBounds(240, 160, 60, 23);
        ...
        jLabel22.setBounds(310, 160, 30, 23);

        jLabel23.setText("Alasan merujuk :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(10, 190, 130, 23);

        ktrujuk1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Membutuhkan peralatan dan SDM yang lebih lengkap", "Membutuhkan perawatan intensif", "Permintaan pasien atau keluarga", "Ruangan rawat inap penuh", "Lain-lain" }));
        ...
        FormInput.add(ktrujuk1);
        ktrujuk1.setBounds(145, 190, 220, 23);

        ket2.setHighlighter(null);
        ket2.setName("ket2"); // NOI18N
        ket2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ket2KeyPressed(evt);
            }
        });
        FormInput.add(ket2);
        ket2.setBounds(370, 190, 305, 23);

        jLabel24.setText("Diagnosa medis :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(10, 220, 130, 23);

        TTmpRujuk2.setHighlighter(null);
        TTmpRujuk2.setName("TTmpRujuk2"); // NOI18N
        TTmpRujuk2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TTmpRujuk2KeyPressed(evt);
            }
        });
        FormInput.add(TTmpRujuk2);
        TTmpRujuk2.setBounds(145, 220, 450, 23);
        ...
        TNoRj3.setBounds(602, 220, 72, 23);

        TTmpRujuk3.setHighlighter(null);
        TTmpRujuk3.setName("TTmpRujuk3"); // NOI18N
        TTmpRujuk3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TTmpRujuk3KeyPressed(evt);
            }
        });
        FormInput.add(TTmpRujuk3);
        TTmpRujuk3.setBounds(145, 250, 450, 23);
        ...
        TNoRj4.setBounds(602, 250, 72, 23);
        ...
        TNoRj5.setBounds(602, 280, 72, 23);

        TTmpRujuk4.setHighlighter(null);
        TTmpRujuk4.setName("TTmpRujuk4"); // NOI18N
        TTmpRujuk4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TTmpRujuk4KeyPressed(evt);
            }
        });
        FormInput.add(TTmpRujuk4);
        TTmpRujuk4.setBounds(145, 280, 450, 23);

        ket3.setHighlighter(null);
        ket3.setName("ket3"); // NOI18N
        ket3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ket3KeyPressed(evt);
            }
        });
        FormInput.add(ket3);
        ket3.setBounds(554, 70, 182, 23);

        jLabel25.setText("Unit Penerima :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(0, 100, 90, 23);

        ket4.setHighlighter(null);
        ket4.setName("ket4"); // NOI18N
        ket4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ket4KeyPressed(evt);
            }
        });
        FormInput.add(ket4);
        ket4.setBounds(93, 100, 282, 23);
...
private void TDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TDokterKeyPressed
    ...
    private void ket2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ket2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ket2KeyPressed

    private void TTmpRujuk2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTmpRujuk2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TTmpRujuk2KeyPressed
    ...
    private void TTmpRujuk3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTmpRujuk3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TTmpRujuk3KeyPressed
    ...
    private void TTmpRujuk4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTmpRujuk4KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TTmpRujuk4KeyPressed

    private void ket3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ket3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ket3KeyPressed

    private void ket4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ket4KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ket4KeyPressed
    ...
    */
    ...
    private widget.TextBox TTmpRujuk2;
    private widget.TextBox TTmpRujuk3;
    private widget.TextBox TTmpRujuk4;
    ...
    private widget.TextBox ket2;
    private widget.TextBox ket3;
    private widget.TextBox ket4;
