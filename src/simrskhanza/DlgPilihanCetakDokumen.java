...
public final class DlgPilihanCetakDokumen extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        for(i=0;i<tbData.getRowCount();i++){ 
            if(tbData.getValueAt(i,0).toString().equals("true")){
                if(tbData.getValueAt(i,1).toString().equals("Antrian Poliklinik")){
                    ...
                    Valid.MyReportqry("rptKartuBerobat6.jasper","report","::[ Kartu Periksa Pasien ]::","select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                           ...
                           "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where pasien.no_rkm_medis='"+NoRm+"' ",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }else if(tbData.getValueAt(i,1).toString().equals("Label Rekam Medis")){
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();                 
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                ...
                "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab  where pasien.no_rkm_medis='"+NoRawat+"' ",param);
                    ...
                    Valid.MyReportqry("rptBarcodeRM13.jasper","report","::[ Label Rekam Medis ]::","select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                           ...
                           "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab  where pasien.no_rkm_medis='"+NoRm+"' ",param);
                    this.setCursor(Cursor.getDefaultCursor());
                }else if(tbData.getValueAt(i,1).toString().equals("Identitas Pasien")){
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();                 
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
    ...
    */
    ...
    public void tampil4() {
        try{         
            Valid.tabelKosong(TabMode);
            TabMode.addRow(new Object[]{false,"Identitas Pasien"});//0,0
            TabMode.addRow(new Object[]{false,"Label Rekam Medis"});//1,0
            TabMode.addRow(new Object[]{false,"Antrian Poliklinik"});//2,0
        }catch(Exception e){
            System.out.println("Notifikasi : "+e);
        }
    ...
    public void setNoRm2(String NoRawat) {
            this.NoRawat=NoRawat;
    }
