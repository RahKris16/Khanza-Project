 ...
 * @author perpustakaan
 */
public class DlgInputPulangIGD extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgInputPulangIGD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pasien Pulang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel8.setBounds(0, 40, 65, 23);

        DTPTgl.setForeground(new java.awt.Color(50, 70, 50));
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-02-2024" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            try{
                Sequel.menyimpan("pulang_igd","?,?,?","No.Rawat",3,
                new String[]{TRawat.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()});
            }catch (Exception ex) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgInputPulangIGD dialog = new DlgInputPulangIGD(new javax.swing.JFrame(), true);
    ...
    public void setNoRm4(String norm, String norw, String npasien) {
        TNoRM.setText(norm);
        TRawat.setText(norw);
        TPasien.setText(npasien);    
    }
