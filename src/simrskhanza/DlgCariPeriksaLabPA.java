   ...
   if(tabMode.getRowCount()!=0){
                        ...
                        try {
                            ...
                            while(rs2.next()){
                                ps3=koneksi.prepareStatement(
                                    "select diagnosa_klinik, makroskopik, mikroskopik, kesimpulan, kesan, nomer_pa from detail_periksa_labpa "+
                                ...
                                try {
                                    ...
                                    while(rs3.next()){
                                        Sequel.menyimpan("temporary_lab","'0','"+rs2.getString("nm_perawatan").replaceAll("'","")+"','"+rs3.getString("diagnosa_klinik").replaceAll("'","")+"','"+rs3.getString("makroskopik").replaceAll("'","")
                                                +"','"+rs3.getString("mikroskopik").replaceAll("'","")+"','"+rs3.getString("kesimpulan").replaceAll("'","")+"','"+rs3.getString("kesan").replaceAll("'","")+"','"+rs3.getString("nomer_pa").replaceAll("'","")+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Data User"); 
                                    }
                                } catch (Exception e) {
    ...
    private void MnUbah1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUbah1ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            DlgUbahNilaiLabPA ubah=new DlgUbahNilaiLabPA(null,false);
            ubah.isCek();
