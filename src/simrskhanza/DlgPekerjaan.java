...
public class DlgPekerjaan extends javax.swing.JDialog {
    ...
    public DlgPekerjaan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"ID","Pekerjaan"}){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            if(Sequel.meghapustf("pekerjaan","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString())==true){
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from pekerjaan where pekerjaan like ? ");
            try {
