...
public class DlgCatatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TPasien.setBounds(318, 10, 370, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.menyimpan3("catatan_pasien","?,?",2,new String[]{TNoRw.getText(),TCatatan.getText()},"no_rkm_medis=?","catatan=?",2,new String[]{TCatatan.getText(),TNoRw.getText()});
            BtnKeluarActionPerformed(evt);        
        }  
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
       Sequel.meghapus2("catatan_pasien","no_rkm_medis",TNoRw.getText());
       BtnKeluarActionPerformed(evt);       
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    public void setNoRm(String norm) {
        TNoRw.setText(norm);  
        isPsien();   
        Sequel.cariIsi("select catatan_pasien.catatan from catatan_pasien where catatan_pasien.no_rkm_medis=?",TCatatan,TNoRw.getText());       
    }
