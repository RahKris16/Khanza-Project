 ...
 * @author dosen
 */
public final class DlgUbahNilaiLabPA extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgUbahNilaiLabPA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Pemeriksaan","Makroskopik","Mikroskopik","Kesimpulan","Kesan","Kode Periksa"};
    ...
    private void initComponents() {
        ...
        NoPA.setPreferredSize(new java.awt.Dimension(290, 23));
        panelGlass11.add(NoPA);
        NoPA.setBounds(745, 10, 170, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        for(i=0;i<tbPemeriksaan.getRowCount();i++){ 
            Sequel.mengedit("detail_periksa_labpa","no_rawat=? and kd_jenis_prw=? and tgl_periksa=? and jam=?","makroskopik=?,mikroskopik=?,kesimpulan=?,kesan=?,tgl_periksa=?,jam=?,nomer_pa=?",11,new String[]{
                tbPemeriksaan.getValueAt(i,1).toString(),tbPemeriksaan.getValueAt(i,2).toString(),tbPemeriksaan.getValueAt(i,3).toString(),tbPemeriksaan.getValueAt(i,4).toString(),Valid.SetTgl(Tanggal.getSelectedItem()+""),
                CmbJam.getSelectedItem()+":"+CmbMenit.getSelectedItem()+":"+CmbDetik.getSelectedItem(),NoPA.getText(),TNoRw.getText(),tbPemeriksaan.getValueAt(i,5).toString(),tanggal,jam
            });
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgUbahNilaiLabPA dialog = new DlgUbahNilaiLabPA(new javax.swing.JFrame(), true);
    ...
    public void setNoRm(String norwt,String tanggal,String jam) {        
        try {
            ...
            Sequel.cariIsi("select detail_periksa_labpa.nomer_pa from detail_periksa_labpa where detail_periksa_labpa.no_rawat=? ",NoPA,TNoRw.getText());
            this.tanggal=tanggal;
            this.jam=jam;
            ps=koneksi.prepareStatement(
                    "select detail_periksa_labpa.kd_jenis_prw, jns_perawatan_lab.nm_perawatan, detail_periksa_labpa.makroskopik, detail_periksa_labpa.mikroskopik, detail_periksa_labpa.kesimpulan, detail_periksa_labpa.kesan "+
                    "from detail_periksa_labpa inner join jns_perawatan_lab on detail_periksa_labpa.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                    "where detail_periksa_labpa.no_rawat=? and detail_periksa_labpa.tgl_periksa=? and detail_periksa_labpa.jam=?");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                         "   "+rs.getString("nm_perawatan"),rs.getString("makroskopik"),rs.getString("mikroskopik"),
                        rs.getString("kesimpulan"),rs.getString("kesan"),rs.getString("kd_jenis_prw")
                    });
                } 
            } catch (Exception e) {
